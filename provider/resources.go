...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"databricks_entitlements":       {Tok: tfbridge.MakeResource(mainPkg, mainMod, "Entitlements")},
			...
			"databricks_mws_permission_assignment":   {Tok: tfbridge.MakeResource(mainPkg, mainMod, "MwsPermissionAssignment")},
			...
			"databricks_permission_assignment": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "PermissionAssignment"),
				Docs: &tfbridge.DocInfo{
					Markdown: []byte(" "),
				},
			},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"databricks_job":                     {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getJob")},
			...
			"databricks_share":                   {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getShare")},
			"databricks_shares":                  {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getShares")},
			...
			"databricks_mws_workspaces":          {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getMwsWorkspaces")},
		},
