...
type Repo struct {
	...
	ProviderConfig RepoProviderConfigOutput    `pulumi:"providerConfig"`
...
func (o RepoOutput) ProviderConfig() RepoProviderConfigOutput {
	return o.ApplyT(func(v *Repo) RepoProviderConfigOutput { return v.ProviderConfig }).(RepoProviderConfigOutput)
}
