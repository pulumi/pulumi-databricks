...
// Workspace ID of the resource
func (o DatabaseInstanceOutput) WorkspaceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DatabaseInstance) pulumi.StringPtrOutput { return v.WorkspaceId }).(pulumi.StringPtrOutput)
}
