...
func GetInstanceProfilesOutput(ctx *pulumi.Context, args GetInstanceProfilesOutputArgs, opts ...pulumi.InvokeOption) GetInstanceProfilesResultOutput {
	...
	return ctx.InvokeOutput("databricks:index/getInstanceProfiles:getInstanceProfiles", args, GetInstanceProfilesResultOutput{}, options).(GetInstanceProfilesResultOutput)
}
