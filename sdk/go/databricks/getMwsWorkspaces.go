...
func (o LookupMwsWorkspacesResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupMwsWorkspacesResult] {
	return pulumix.Output[LookupMwsWorkspacesResult]{
