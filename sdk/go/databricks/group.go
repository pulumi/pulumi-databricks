...
//
// > **Note** Entitlements, like, `allowClusterCreate`, `allowInstancePoolCreate`, `databricksSqlAccess`, `workspaceAccess` applicable only for workspace-level groups.  Use Entitlements resource to assign entitlements inside a workspace to account-level groups.
//
