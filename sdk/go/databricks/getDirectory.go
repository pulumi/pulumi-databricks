...
//			_, err := databricks.GetDirectory(ctx, &databricks.LookupDirectoryArgs{
//				Path: "/Production",
//			}, nil)
//			if err != nil {
//				return err
...
func LookupDirectoryOutput(ctx *pulumi.Context, args LookupDirectoryOutputArgs, opts ...pulumi.InvokeOption) LookupDirectoryResultOutput {
	...
	return ctx.InvokeOutput("databricks:index/getDirectory:getDirectory", args, LookupDirectoryResultOutput{}, options).(LookupDirectoryResultOutput)
}
