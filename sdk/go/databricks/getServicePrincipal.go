...
//				return err
//			}
//			spn, err := databricks.GetServicePrincipal(ctx, &databricks.LookupServicePrincipalArgs{
...
//				GroupId:  pulumi.String(pulumi.String(admins.Id)),
//				MemberId: pulumi.String(pulumi.String(spn.Id)),
//			})
//			if err != nil {
//				return err
//			}
