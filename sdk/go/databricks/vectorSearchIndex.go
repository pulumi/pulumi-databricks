...
func (o VectorSearchIndexOutput) IndexSubtype() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VectorSearchIndex) pulumi.StringPtrOutput { return v.IndexSubtype }).(pulumi.StringPtrOutput)
}
