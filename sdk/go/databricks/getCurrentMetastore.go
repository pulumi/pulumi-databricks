...
//
// > **Note** If you have a fully automated setup with workspaces created by MwsWorkspaces or azurerm_databricks_workspace, please make sure to add dependsOn attribute to prevent *authentication is not configured for provider* errors.
//
// ## Example Usage
//
