...
func (o GetCatalogsResultOutput) ProviderConfig() GetCatalogsProviderConfigOutput {
	return o.ApplyT(func(v GetCatalogsResult) GetCatalogsProviderConfig { return v.ProviderConfig }).(GetCatalogsProviderConfigOutput)
}
