...
export function getAppSpace(args: GetAppSpaceArgs, opts?: pulumi.InvokeOptions): Promise<GetAppSpaceResult> {
    ...
    return pulumi.runtime.invoke("databricks:index/getAppSpace:getAppSpace", {
        "name": args.name,
 ...
 */
export interface GetAppSpaceArgs {
    /**
     ...
     */
    providerConfig?: inputs.GetAppSpaceProviderConfig;
}
...
export interface GetAppSpaceResult {
    ...
    readonly providerConfig?: outputs.GetAppSpaceProviderConfig;
    /**
     ...
     */
    readonly resources: outputs.GetAppSpaceResource[];
    /**
     ...
     */
    readonly status: outputs.GetAppSpaceStatus;
    /**
...
export function getAppSpaceOutput(args: GetAppSpaceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppSpaceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("databricks:index/getAppSpace:getAppSpace", {
        "name": args.name,
        "providerConfig": args.providerConfig,
    }, opts);
}
 ...
 * A collection of arguments for invoking getAppSpace.
 */
export interface GetAppSpaceOutputArgs {
    /**
     * The name of the app space. The name must contain only lowercase alphanumeric characters and hyphens.
     * It must be unique within the workspace
     */
