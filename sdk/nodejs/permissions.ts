...
export class Permissions extends pulumi.CustomResource {
    ...
    declare public readonly accessControls: pulumi.Output<outputs.PermissionsAccessControl[]>;
    declare public readonly alertV2Id: pulumi.Output<string | undefined>;
    ...
    declare public readonly servingEndpointId: pulumi.Output<string | undefined>;
    declare public readonly sqlAlertId: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: PermissionsArgs | PermissionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["accessControls"] = state?.accessControls;
            resourceInputs["alertV2Id"] = state?.alertV2Id;
            ...
            resourceInputs["sqlAlertId"] = state?.sqlAlertId;
            ...
            if (args?.accessControls === undefined && !opts.urn) {
                throw new Error("Missing required property 'accessControls'");
            }
            resourceInputs["accessControls"] = args?.accessControls;
            resourceInputs["alertV2Id"] = args?.alertV2Id;
            ...
            resourceInputs["servingEndpointId"] = args?.servingEndpointId;
            resourceInputs["sqlAlertId"] = args?.sqlAlertId;
