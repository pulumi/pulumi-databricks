 ...
 */
export class AppSpace extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppSpaceState, opts?: pulumi.CustomResourceOptions): AppSpace {
        return new AppSpace(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'databricks:index/appSpace:AppSpace';

    /**
     * Returns true if the given object is an instance of AppSpace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppSpace {
     ...
     */
    declare public readonly resources: pulumi.Output<outputs.AppSpaceResource[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<outputs.AppSpaceStatus>;
    /**
    ...
    constructor(name: string, argsOrState?: AppSpaceArgs | AppSpaceState, opts?: pulumi.CustomResourceOptions) {
