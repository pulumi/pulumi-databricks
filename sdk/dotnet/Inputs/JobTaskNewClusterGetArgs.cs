...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class JobTaskNewClusterGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.JobTaskNewClusterDriverNodeTypeFlexibilityGetArgs>? DriverNodeTypeFlexibility { get; set; }
        ...
        [Input("libraries")]
        private InputList<Inputs.JobTaskNewClusterLibraryGetArgs>? _libraries;

        /// <summary>
        /// (List) An optional list of libraries to be installed on the cluster that will execute the job. See library Configuration Block below.
        /// </summary>
        public InputList<Inputs.JobTaskNewClusterLibraryGetArgs> Libraries
        {
            get => _libraries ?? (_libraries = new InputList<Inputs.JobTaskNewClusterLibraryGetArgs>());
        ...
        public Input<Inputs.JobTaskNewClusterProviderConfigGetArgs>? ProviderConfig { get; set; }
        ...
        public Input<Inputs.JobTaskNewClusterWorkerNodeTypeFlexibilityGetArgs>? WorkerNodeTypeFlexibility { get; set; }
