...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class PostgresProjectSpecGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("customTags")]
        private InputList<Inputs.PostgresProjectSpecCustomTagGetArgs>? _customTags;

        /// <summary>
        /// (list of ProjectCustomTag) - The effective custom tags associated with the project
        /// </summary>
        public InputList<Inputs.PostgresProjectSpecCustomTagGetArgs> CustomTags
        {
            get => _customTags ?? (_customTags = new InputList<Inputs.PostgresProjectSpecCustomTagGetArgs>());
