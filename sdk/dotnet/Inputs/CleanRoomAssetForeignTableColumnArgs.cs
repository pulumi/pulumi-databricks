...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class CleanRoomAssetForeignTableColumnArgs : global::Pulumi.ResourceArgs
    {
        [Input("comment")]
        public Input<string>? Comment { get; set; }

        [Input("mask")]
        public Input<Inputs.CleanRoomAssetForeignTableColumnMaskArgs>? Mask { get; set; }
        ...
        public CleanRoomAssetForeignTableColumnArgs()
        {
        }
        public static new CleanRoomAssetForeignTableColumnArgs Empty => new CleanRoomAssetForeignTableColumnArgs();
    }
}
