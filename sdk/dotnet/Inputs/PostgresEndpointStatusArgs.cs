...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class PostgresEndpointStatusArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("group")]
        public Input<Inputs.PostgresEndpointStatusGroupArgs>? Group { get; set; }

        /// <summary>
        /// (EndpointHosts) - Contains host information for connecting to the endpoint
        /// </summary>
        [Input("hosts")]
        public Input<Inputs.PostgresEndpointStatusHostsArgs>? Hosts { get; set; }
        ...
        /// </summary>
        [Input("settings")]
        public Input<Inputs.PostgresEndpointStatusSettingsArgs>? Settings { get; set; }
        ...
        public PostgresEndpointStatusArgs()
        {
        }
        public static new PostgresEndpointStatusArgs Empty => new PostgresEndpointStatusArgs();
    }
}
