...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class AiSearchIndexDeltaSyncIndexSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.AiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumnArgs>? _embeddingSourceColumns;
        public InputList<Inputs.AiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumnArgs> EmbeddingSourceColumns
        {
            get => _embeddingSourceColumns ?? (_embeddingSourceColumns = new InputList<Inputs.AiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumnArgs>());
            set => _embeddingSourceColumns = value;
        }

        [Input("embeddingVectorColumns")]
        private InputList<Inputs.AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumnArgs>? _embeddingVectorColumns;
        public InputList<Inputs.AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumnArgs> EmbeddingVectorColumns
        {
            get => _embeddingVectorColumns ?? (_embeddingVectorColumns = new InputList<Inputs.AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumnArgs>());
        ...
        public AiSearchIndexDeltaSyncIndexSpecArgs()
        {
        }
        public static new AiSearchIndexDeltaSyncIndexSpecArgs Empty => new AiSearchIndexDeltaSyncIndexSpecArgs();
    }
}
