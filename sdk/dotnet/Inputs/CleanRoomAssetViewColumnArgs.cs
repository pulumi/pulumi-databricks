...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class CleanRoomAssetViewColumnArgs : global::Pulumi.ResourceArgs
    {
        [Input("comment")]
        public Input<string>? Comment { get; set; }

        [Input("mask")]
        public Input<Inputs.CleanRoomAssetViewColumnMaskArgs>? Mask { get; set; }
        ...
        public CleanRoomAssetViewColumnArgs()
        {
        }
        public static new CleanRoomAssetViewColumnArgs Empty => new CleanRoomAssetViewColumnArgs();
    }
}
