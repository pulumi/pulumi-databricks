...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class CleanRoomAssetViewColumnGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("comment")]
        public Input<string>? Comment { get; set; }

        [Input("mask")]
        public Input<Inputs.CleanRoomAssetViewColumnMaskGetArgs>? Mask { get; set; }
        ...
        public CleanRoomAssetViewColumnGetArgs()
        {
        }
        public static new CleanRoomAssetViewColumnGetArgs Empty => new CleanRoomAssetViewColumnGetArgs();
    }
}
