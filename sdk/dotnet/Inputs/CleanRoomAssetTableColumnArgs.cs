...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class CleanRoomAssetTableColumnArgs : global::Pulumi.ResourceArgs
    {
        [Input("comment")]
        public Input<string>? Comment { get; set; }

        [Input("mask")]
        public Input<Inputs.CleanRoomAssetTableColumnMaskArgs>? Mask { get; set; }
        ...
        public CleanRoomAssetTableColumnArgs()
        {
        }
        public static new CleanRoomAssetTableColumnArgs Empty => new CleanRoomAssetTableColumnArgs();
    }
}
