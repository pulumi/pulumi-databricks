...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class GetJobJobSettingsSettingsTaskNewClusterArgs : global::Pulumi.InvokeArgs
    {
        [Input("applyPolicyDefaultValues")]
        public bool? ApplyPolicyDefaultValues { get; set; }

        [Input("autoscale")]
        public Inputs.GetJobJobSettingsSettingsTaskNewClusterAutoscaleArgs? Autoscale { get; set; }

        [Input("autoterminationMinutes")]
        public int? AutoterminationMinutes { get; set; }

        [Input("awsAttributes")]
        public Inputs.GetJobJobSettingsSettingsTaskNewClusterAwsAttributesArgs? AwsAttributes { get; set; }

        [Input("azureAttributes")]
        public Inputs.GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs? AzureAttributes { get; set; }

        [Input("clusterId")]
        public string? ClusterId { get; set; }

        [Input("clusterLogConf")]
        public Inputs.GetJobJobSettingsSettingsTaskNewClusterClusterLogConfArgs? ClusterLogConf { get; set; }

        [Input("clusterMountInfos")]
        private List<Inputs.GetJobJobSettingsSettingsTaskNewClusterClusterMountInfoArgs>? _clusterMountInfos;
        public List<Inputs.GetJobJobSettingsSettingsTaskNewClusterClusterMountInfoArgs> ClusterMountInfos
        {
            get => _clusterMountInfos ?? (_clusterMountInfos = new List<Inputs.GetJobJobSettingsSettingsTaskNewClusterClusterMountInfoArgs>());
        ...
        [Input("dockerImage")]
        public Inputs.GetJobJobSettingsSettingsTaskNewClusterDockerImageArgs? DockerImage { get; set; }
        ...
        [Input("gcpAttributes")]
        public Inputs.GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs? GcpAttributes { get; set; }

        [Input("idempotencyToken")]
        public string? IdempotencyToken { get; set; }

        [Input("initScripts")]
        private List<Inputs.GetJobJobSettingsSettingsTaskNewClusterInitScriptArgs>? _initScripts;
        public List<Inputs.GetJobJobSettingsSettingsTaskNewClusterInitScriptArgs> InitScripts
        {
            get => _initScripts ?? (_initScripts = new List<Inputs.GetJobJobSettingsSettingsTaskNewClusterInitScriptArgs>());
        ...
        [Input("workloadType")]
        public Inputs.GetJobJobSettingsSettingsTaskNewClusterWorkloadTypeArgs? WorkloadType { get; set; }

        public GetJobJobSettingsSettingsTaskNewClusterArgs()
        {
        }
        public static new GetJobJobSettingsSettingsTaskNewClusterArgs Empty => new GetJobJobSettingsSettingsTaskNewClusterArgs();
    }
}
