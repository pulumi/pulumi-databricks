...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class GetJobJobSettingsSettingsJobClusterNewClusterInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("applyPolicyDefaultValues")]
        public Input<bool>? ApplyPolicyDefaultValues { get; set; }

        [Input("autoscale")]
        public Input<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterAutoscaleInputArgs>? Autoscale { get; set; }

        [Input("autoterminationMinutes")]
        public Input<int>? AutoterminationMinutes { get; set; }

        [Input("awsAttributes")]
        public Input<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterAwsAttributesInputArgs>? AwsAttributes { get; set; }

        [Input("azureAttributes")]
        public Input<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesInputArgs>? AzureAttributes { get; set; }
        ...
        [Input("dockerImage")]
        public Input<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterDockerImageInputArgs>? DockerImage { get; set; }
        ...
        [Input("gcpAttributes")]
        public Input<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesInputArgs>? GcpAttributes { get; set; }

        [Input("idempotencyToken")]
        public Input<string>? IdempotencyToken { get; set; }

        [Input("initScripts")]
        private InputList<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterInitScriptInputArgs>? _initScripts;
        public InputList<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterInitScriptInputArgs> InitScripts
        {
            get => _initScripts ?? (_initScripts = new InputList<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterInitScriptInputArgs>());
        ...
        [Input("workloadType")]
        public Input<Inputs.GetJobJobSettingsSettingsJobClusterNewClusterWorkloadTypeInputArgs>? WorkloadType { get; set; }

        public GetJobJobSettingsSettingsJobClusterNewClusterInputArgs()
        {
        }
        public static new GetJobJobSettingsSettingsJobClusterNewClusterInputArgs Empty => new GetJobJobSettingsSettingsJobClusterNewClusterInputArgs();
    }
}
