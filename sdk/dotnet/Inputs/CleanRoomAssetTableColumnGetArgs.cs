...
namespace Pulumi.Databricks.Inputs
{
    ...
    public sealed class CleanRoomAssetTableColumnGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("comment")]
        public Input<string>? Comment { get; set; }

        [Input("mask")]
        public Input<Inputs.CleanRoomAssetTableColumnMaskGetArgs>? Mask { get; set; }
        ...
        public CleanRoomAssetTableColumnGetArgs()
        {
        }
        public static new CleanRoomAssetTableColumnGetArgs Empty => new CleanRoomAssetTableColumnGetArgs();
    }
}
