...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetPostgresDataApiStatusResult
    {
        /// <summary>
        /// (list of string) - Schemas available in the database (for reference when configuring db_schemas)
        /// </summary>
        public readonly ImmutableArray<string> AvailableSchemas;
        /// <summary>
        ...
        [OutputConstructor]
        private GetPostgresDataApiStatusResult(
            ImmutableArray<string> availableSchemas,
