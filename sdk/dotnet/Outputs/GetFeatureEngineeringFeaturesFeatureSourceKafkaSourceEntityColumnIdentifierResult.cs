...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetFeatureEngineeringFeaturesFeatureSourceKafkaSourceEntityColumnIdentifierResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetFeatureEngineeringFeaturesFeatureSourceKafkaSourceEntityColumnIdentifierResult(string variantExprPath)
        {
