...
namespace Pulumi.Databricks.Outputs
{
    ...
    public sealed class GetAiGatewayModelProviderServicesModelProviderServiceConfigGeminiEnterpriseResult
    {
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServicesModelProviderServiceConfigGeminiEnterpriseResult(Outputs.GetAiGatewayModelProviderServicesModelProviderServiceConfigGeminiEnterpriseDirectResult? direct)
        {
            Direct = direct;
        }
    }
