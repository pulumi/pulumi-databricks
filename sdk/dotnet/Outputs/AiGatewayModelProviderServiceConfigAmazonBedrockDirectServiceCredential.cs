...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigAmazonBedrockDirectServiceCredential
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigAmazonBedrockDirectServiceCredential(string name)
        {
            Name = name;
        }
    }
