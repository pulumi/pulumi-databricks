...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetFeatureEngineeringKafkaConfigsKafkaConfigIngestionConfigBackfillSourceResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetFeatureEngineeringKafkaConfigsKafkaConfigIngestionConfigBackfillSourceDeltaTableSourceResult? DeltaTableSource;

        [OutputConstructor]
        private GetFeatureEngineeringKafkaConfigsKafkaConfigIngestionConfigBackfillSourceResult(
            string? deltaTableName,

            Outputs.GetFeatureEngineeringKafkaConfigsKafkaConfigIngestionConfigBackfillSourceDeltaTableSourceResult? deltaTableSource)
        {
