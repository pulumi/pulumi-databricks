...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServiceConfigGeminiEnterpriseDirectApiKeyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServiceConfigGeminiEnterpriseDirectApiKeyResult(string plaintext)
        {
            Plaintext = plaintext;
        }
    }
