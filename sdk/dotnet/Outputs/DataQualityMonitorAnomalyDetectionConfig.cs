...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class DataQualityMonitorAnomalyDetectionConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DataQualityMonitorAnomalyDetectionConfig(ImmutableArray<string> excludedTableFullNames)
        {
