...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigMicrosoftFoundryDirectServiceCredential
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigMicrosoftFoundryDirectServiceCredential(string name)
        {
            Name = name;
        }
    }
