...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigAmazonBedrockDirectAwsSecretAccessKey
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigAmazonBedrockDirectAwsSecretAccessKey(string? plaintext)
        {
            Plaintext = plaintext;
        }
    }
