...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigOpenaiDirectApiKey
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigOpenaiDirectApiKey(string? plaintext)
        {
            Plaintext = plaintext;
        }
    }
