...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigAzureOpenaiDirectServiceCredential
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigAzureOpenaiDirectServiceCredential(string name)
        {
            Name = name;
        }
    }
