...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigCustomDirectApiKey
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigCustomDirectApiKey(string? plaintext)
        {
            Plaintext = plaintext;
        }
    }
