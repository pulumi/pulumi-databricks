...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelServiceConfigRoutingDestinationExternalModelConfigResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetAiGatewayModelServiceConfigRoutingDestinationExternalModelConfigTargetResult Target;

        [OutputConstructor]
        private GetAiGatewayModelServiceConfigRoutingDestinationExternalModelConfigResult(
            string modelProviderService,

            Outputs.GetAiGatewayModelServiceConfigRoutingDestinationExternalModelConfigTargetResult target)
        {
