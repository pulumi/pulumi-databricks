...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServiceConfigAzureOpenaiDirectClientSecretResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServiceConfigAzureOpenaiDirectClientSecretResult(string plaintext)
        {
            Plaintext = plaintext;
        }
    }
