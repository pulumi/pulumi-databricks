...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetPolicyInfosPolicyColumnMaskResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPolicyInfosPolicyColumnMaskUsingResult> Usings;

        [OutputConstructor]
        private GetPolicyInfosPolicyColumnMaskResult(
            string functionName,

            string onColumn,

            ImmutableArray<Outputs.GetPolicyInfosPolicyColumnMaskUsingResult> usings)
        {
