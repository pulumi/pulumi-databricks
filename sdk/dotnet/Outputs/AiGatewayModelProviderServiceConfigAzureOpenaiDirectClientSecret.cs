...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigAzureOpenaiDirectClientSecret
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigAzureOpenaiDirectClientSecret(string? plaintext)
        {
            Plaintext = plaintext;
        }
    }
