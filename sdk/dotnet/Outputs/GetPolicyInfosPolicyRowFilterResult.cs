...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetPolicyInfosPolicyRowFilterResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPolicyInfosPolicyRowFilterUsingResult> Usings;

        [OutputConstructor]
        private GetPolicyInfosPolicyRowFilterResult(
            string functionName,

            ImmutableArray<Outputs.GetPolicyInfosPolicyRowFilterUsingResult> usings)
        {
