...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfig
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.AiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfigTarget Target;

        [OutputConstructor]
        private AiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfig(
            string modelProviderService,

            Outputs.AiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfigTarget target)
        {
