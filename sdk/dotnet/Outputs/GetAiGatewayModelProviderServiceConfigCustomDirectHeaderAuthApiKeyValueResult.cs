...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServiceConfigCustomDirectHeaderAuthApiKeyValueResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServiceConfigCustomDirectHeaderAuthApiKeyValueResult(string plaintext)
        {
            Plaintext = plaintext;
        }
    }
