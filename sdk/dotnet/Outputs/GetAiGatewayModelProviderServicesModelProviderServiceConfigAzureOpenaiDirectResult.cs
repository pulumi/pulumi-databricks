...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServicesModelProviderServiceConfigAzureOpenaiDirectResult
    {
        /// <summary>
        /// (ModelProviderServiceConfigProviderSecret) - OpenAI API key. Required when creating the service. Supply the value in
        /// `api_key.plaintext`
        /// </summary>
        public readonly Outputs.GetAiGatewayModelProviderServicesModelProviderServiceConfigAzureOpenaiDirectApiKeyResult? ApiKey;
        /// <summary>
        ...
        private GetAiGatewayModelProviderServicesModelProviderServiceConfigAzureOpenaiDirectResult(
            Outputs.GetAiGatewayModelProviderServicesModelProviderServiceConfigAzureOpenaiDirectApiKeyResult? apiKey,
