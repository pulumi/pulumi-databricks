...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServicesModelProviderServiceConfigAmazonBedrockDirectServiceCredentialResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServicesModelProviderServiceConfigAmazonBedrockDirectServiceCredentialResult(string name)
        {
            Name = name;
        }
    }
