...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServiceConfigOpenaiDirectApiKeyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServiceConfigOpenaiDirectApiKeyResult(string plaintext)
        {
            Plaintext = plaintext;
        }
    }
