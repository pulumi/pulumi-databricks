...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class FeatureEngineeringFeatureSourceKafkaSourceTimeseriesColumnIdentifier
    {
        /// <summary>
        ...
        [OutputConstructor]
        private FeatureEngineeringFeatureSourceKafkaSourceTimeseriesColumnIdentifier(string variantExprPath)
        {
