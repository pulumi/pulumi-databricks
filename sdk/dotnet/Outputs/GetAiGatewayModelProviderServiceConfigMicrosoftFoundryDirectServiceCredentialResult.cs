...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServiceConfigMicrosoftFoundryDirectServiceCredentialResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServiceConfigMicrosoftFoundryDirectServiceCredentialResult(string name)
        {
            Name = name;
        }
    }
