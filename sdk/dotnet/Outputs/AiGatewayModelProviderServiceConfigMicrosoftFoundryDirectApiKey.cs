...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigMicrosoftFoundryDirectApiKey
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigMicrosoftFoundryDirectApiKey(string? plaintext)
        {
            Plaintext = plaintext;
        }
    }
