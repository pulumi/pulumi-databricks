...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetFeatureEngineeringFeaturesFeatureSourceLatenessResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetFeatureEngineeringFeaturesFeatureSourceLatenessResult(string? settlingDelay)
        {
