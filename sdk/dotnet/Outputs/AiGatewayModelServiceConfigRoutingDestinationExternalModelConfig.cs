...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelServiceConfigRoutingDestinationExternalModelConfig
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.AiGatewayModelServiceConfigRoutingDestinationExternalModelConfigTarget Target;

        [OutputConstructor]
        private AiGatewayModelServiceConfigRoutingDestinationExternalModelConfig(
            string modelProviderService,

            Outputs.AiGatewayModelServiceConfigRoutingDestinationExternalModelConfigTarget target)
        {
