...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfigResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetAiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfigTargetResult Target;

        [OutputConstructor]
        private GetAiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfigResult(
            string modelProviderService,

            Outputs.GetAiGatewayModelServiceConfigRoutingFallbackDestinationExternalModelConfigTargetResult target)
        {
