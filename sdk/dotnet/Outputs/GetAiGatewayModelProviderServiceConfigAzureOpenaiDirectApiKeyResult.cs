...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServiceConfigAzureOpenaiDirectApiKeyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServiceConfigAzureOpenaiDirectApiKeyResult(string plaintext)
        {
            Plaintext = plaintext;
        }
    }
