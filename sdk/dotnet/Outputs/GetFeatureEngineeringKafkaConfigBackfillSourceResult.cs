...
namespace Pulumi.Databricks.Outputs
{
    ...
    public sealed class GetFeatureEngineeringKafkaConfigBackfillSourceResult
    {
        ...
        [OutputConstructor]
        private GetFeatureEngineeringKafkaConfigBackfillSourceResult(
            string? deltaTableName,

            Outputs.GetFeatureEngineeringKafkaConfigBackfillSourceDeltaTableSourceResult? deltaTableSource)
        {
