...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelServicesModelServiceConfigRoutingDestinationExternalModelConfigResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetAiGatewayModelServicesModelServiceConfigRoutingDestinationExternalModelConfigTargetResult Target;

        [OutputConstructor]
        private GetAiGatewayModelServicesModelServiceConfigRoutingDestinationExternalModelConfigResult(
            string modelProviderService,

            Outputs.GetAiGatewayModelServicesModelServiceConfigRoutingDestinationExternalModelConfigTargetResult target)
        {
