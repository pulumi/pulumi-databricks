...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServiceConfigAmazonBedrockDirectServiceCredentialResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServiceConfigAmazonBedrockDirectServiceCredentialResult(string name)
        {
            Name = name;
        }
    }
