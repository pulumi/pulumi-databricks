...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetPolicyInfosPolicyRowFilterUsingResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetPolicyInfosPolicyRowFilterUsingFunctionArgExpressionResult? FunctionArgExpression;

        [OutputConstructor]
        private GetPolicyInfosPolicyRowFilterUsingResult(
            string? alias,

            string? constant,

            Outputs.GetPolicyInfosPolicyRowFilterUsingFunctionArgExpressionResult? functionArgExpression)
        {
            Alias = alias;
            Constant = constant;
