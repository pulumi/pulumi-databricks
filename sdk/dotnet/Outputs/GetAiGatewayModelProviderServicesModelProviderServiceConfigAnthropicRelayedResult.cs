...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetAiGatewayModelProviderServicesModelProviderServiceConfigAnthropicRelayedResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAiGatewayModelProviderServicesModelProviderServiceConfigAnthropicRelayedResult(string? planType)
        {
            PlanType = planType;
        }
    }
