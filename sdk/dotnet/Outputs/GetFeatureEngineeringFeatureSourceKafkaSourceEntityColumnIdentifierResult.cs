...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class GetFeatureEngineeringFeatureSourceKafkaSourceEntityColumnIdentifierResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetFeatureEngineeringFeatureSourceKafkaSourceEntityColumnIdentifierResult(string variantExprPath)
        {
