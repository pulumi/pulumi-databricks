...
namespace Pulumi.Databricks.Outputs
{
    ...
    [OutputType]
    public sealed class AiGatewayModelProviderServiceConfigAzureOpenaiDirectApiKey
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiGatewayModelProviderServiceConfigAzureOpenaiDirectApiKey(string? plaintext)
        {
            Plaintext = plaintext;
        }
    }
