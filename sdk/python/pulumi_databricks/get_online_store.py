...
class GetOnlineStoreResult:
    ...
    def read_replica_count(self) -> Optional[builtins.int]:
        """
...
def get_online_store(capacity: Optional[builtins.str] = None,
                     ...
                     read_replica_count: Optional[builtins.int] = None,
    ...
    :param builtins.int read_replica_count: (integer) - The number of read replicas for the online store. Defaults to 0
    """
    __args__ = dict()
...
def get_online_store_output(capacity: Optional[pulumi.Input[builtins.str]] = None,
                            name: Optional[pulumi.Input[builtins.str]] = None,
                            read_replica_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
