...
class GlobalInitScriptArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: (bool, optional default: `false`) specifies if the script is enabled for execution, or not
        :param pulumi.Input[str] name: (string, required) - the name of the script.  It should be unique
        :param pulumi.Input[int] position: (integer, optional default: `null`) - the position of a global init script, where `0` represents the first global init script to run, `1` is the second global init script to run, and so on. When omitted, the script gets the last position.
