...
class AppSpaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AppSpaceProviderConfigArgs'] provider_config: Configure the provider for management through account provider.
        :param pulumi.Input[Sequence[pulumi.Input['AppSpaceResourceArgs']]] resources: Resources for the app space. Resources configured at the space level are available to all apps in the space
...
class _AppSpaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AppSpaceStatusArgs'] status: (SpaceStatus) - The status of the app space
...
@pulumi.type_token("databricks:index/appSpace:AppSpace")
class AppSpace(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AppSpaceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(AppSpace, __self__).__init__(
    ...
    @_builtins.property
    @pulumi.getter
    def resources(self) -> pulumi.Output[Optional[Sequence['outputs.AppSpaceResource']]]:
        """
        Resources for the app space. Resources configured at the space level are available to all apps in the space
        """
        return pulumi.get(self, "resources")
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output['outputs.AppSpaceStatus']:
        """
        (SpaceStatus) - The status of the app space
        """
        return pulumi.get(self, "status")
