...
def get_aws_unity_catalog_policy(aws_account_id: Optional[_builtins.str] = None,
    ...
    this_get_aws_unity_catalog_assume_role_policy = databricks.get_aws_unity_catalog_assume_role_policy(aws_account_id=aws_account_id,
        role_name=f"{prefix}-uc-access",
        external_id="12345")
    unity_metastore = aws.IamPolicy("unity_metastore",
        name=f{prefix}-unity-catalog-metastore-access-iam-policy,
        policy=this.json)
    metastore_data_access = aws.IamRole("metastore_data_access",
        name=f{prefix}-uc-access,
        assume_role_policy=this_get_aws_unity_catalog_assume_role_policy.json)
    metastore_data_access_iam_role_policy_attachment = aws.IamRolePolicyAttachment("metastore_data_access",
