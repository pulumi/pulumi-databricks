...
class GetSqlWarehousesResult:
    ...
    def warehouse_name_contains(self) -> Optional[builtins.str]:
...
def get_sql_warehouses(ids: Optional[Sequence[builtins.str]] = None,
                       warehouse_name_contains: Optional[builtins.str] = None,
    ...
    * SqlPermissions to manage data object access control lists in Databricks workspaces for things like tables, views, databases, and [more](https://docs.databricks.com/security/access-control/table-acls/object-privileges.html).
    ...
    :param Sequence[builtins.str] ids: list of SqlEndpoint ids
    :param builtins.str warehouse_name_contains: Only return SqlEndpoint ids that match the given name string.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_sql_warehouses_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                              warehouse_name_contains: Optional[pulumi.Input[Optional[builtins.str]]] = None,
