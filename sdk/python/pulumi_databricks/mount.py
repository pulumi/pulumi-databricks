...
class MountArgs:
    def __init__(__self__, *,
                 ...
                 extra_configs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    def extra_configs(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "extra_configs")

    @extra_configs.setter
    def extra_configs(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _MountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source: (String) HDFS-compatible url
        """
        if abfs is not None:
            pulumi.set(__self__, "abfs", abfs)
        if adl is not None:
...
class Mount(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="extraConfigs")
    def extra_configs(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        return pulumi.get(self, "extra_configs")
