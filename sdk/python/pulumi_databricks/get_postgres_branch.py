...
class GetPostgresBranchResult:
    ...
    """
    def __init__(__self__, branch_id=None, create_time=None, name=None, parent=None, provider_config=None, spec=None, status=None, uid=None, update_time=None):
    ...
    def provider_config(self) -> Optional['outputs.GetPostgresBranchProviderConfigResult']:
