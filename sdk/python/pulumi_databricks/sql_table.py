...
class SqlTableArgs:
    def __init__(__self__, *,
                 ...
                 cluster_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 partitions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] options: Map of user defined table options. Change forces creation of a new resource.
        :param pulumi.Input[builtins.str] owner: User name/group name/sp application_id of the table owner.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] partitions: a subset of columns to partition the table by. Change forces the creation of a new resource. Conflicts with `cluster_keys`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A map of table properties.
        :param pulumi.Input[builtins.str] storage_credential_name: For EXTERNAL Tables only: the name of storage credential to use. Change forces the creation of a new resource.
        :param pulumi.Input[builtins.str] storage_location: URL of storage location for Table data (required for EXTERNAL Tables). Not supported for `VIEW` or `MANAGED` table_type.
        :param pulumi.Input[builtins.str] view_definition: SQL text defining the view (for `table_type == "VIEW"`). Not supported for `MANAGED` or `EXTERNAL` table_type.
        :param pulumi.Input[builtins.str] warehouse_id: All table CRUD operations must be executed on a running cluster or SQL warehouse. If a `warehouse_id` is specified, that SQL warehouse will be used to execute SQL commands to manage this table. Conflicts with `cluster_id`.
        """
    ...
    @cluster_keys.setter
    def cluster_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @partitions.setter
    def partitions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class SqlTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            table_type: Optional[pulumi.Input[builtins.str]] = None,
            view_definition: Optional[pulumi.Input[builtins.str]] = None,
            warehouse_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlTable':
        """
    ...
    @property
    @pulumi.getter(name="dataSourceFormat")
    def data_source_format(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        External tables are supported in multiple data source formats. The string constants identifying these formats are `DELTA`, `CSV`, `JSON`, `AVRO`, `PARQUET`, `ORC`, and `TEXT`. Change forces the creation of a new resource. Not supported for `MANAGED` tables or `VIEW`.
        """
        return pulumi.get(self, "data_source_format")
    ...
    @property
    @pulumi.getter(name="effectiveProperties")
    def effective_properties(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        return pulumi.get(self, "effective_properties")
