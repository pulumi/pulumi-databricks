...
class DirectoryArgs:
    def __init__(__self__, *,
                 ...
                 delete_recursive: Optional[pulumi.Input[builtins.bool]] = None,
                 object_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Directory resource.
        :param pulumi.Input[builtins.str] path: The absolute path of the directory, beginning with "/", e.g. "/Demo".
        :param pulumi.Input[builtins.bool] delete_recursive: Whether or not to trigger a recursive delete of this directory and its resources when deleting this on Pulumi. Defaults to `false`
        :param pulumi.Input[builtins.int] object_id: Unique identifier for a DIRECTORY
        """
    ...
    def delete_recursive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_recursive(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Directory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            object_id: Optional[pulumi.Input[builtins.int]] = None,
            path: Optional[pulumi.Input[builtins.str]] = None,
            workspace_path: Optional[pulumi.Input[builtins.str]] = None) -> 'Directory':
        """
    ...
    @property
    @pulumi.getter(name="deleteRecursive")
    def delete_recursive(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not to trigger a recursive delete of this directory and its resources when deleting this on Pulumi. Defaults to `false`
        """
        return pulumi.get(self, "delete_recursive")
