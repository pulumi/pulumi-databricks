...
class MetastoreDataAccessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_default: whether to set this credential as the default for the metastore. In practice, this should always be true.
        """
...
class MetastoreDataAccess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner: Optional[pulumi.Input[builtins.str]] = None,
            read_only: Optional[pulumi.Input[builtins.bool]] = None,
            skip_validation: Optional[pulumi.Input[builtins.bool]] = None) -> 'MetastoreDataAccess':
        """
