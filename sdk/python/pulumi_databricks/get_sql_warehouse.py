...
class GetSqlWarehouseResult:
    ...
    def auto_stop_mins(self) -> builtins.int:
        """
    ...
    def enable_photon(self) -> builtins.bool:
        """
    ...
    def enable_serverless_compute(self) -> builtins.bool:
        """
    ...
    def max_num_clusters(self) -> builtins.int:
        """
    ...
    def min_num_clusters(self) -> builtins.int:
        """
    ...
    def num_active_sessions(self) -> builtins.int:
        """
    ...
    def num_clusters(self) -> builtins.int:
        """
        The current number of clusters used by the endpoint.
        """
...
def get_sql_warehouse(auto_stop_mins: Optional[builtins.int] = None,
                      channel: Optional[Union['GetSqlWarehouseChannelArgs', 'GetSqlWarehouseChannelArgsDict']] = None,
                      cluster_size: Optional[builtins.str] = None,
                      creator_name: Optional[builtins.str] = None,
                      data_source_id: Optional[builtins.str] = None,
                      enable_photon: Optional[builtins.bool] = None,
                      enable_serverless_compute: Optional[builtins.bool] = None,
                      ...
                      max_num_clusters: Optional[builtins.int] = None,
                      min_num_clusters: Optional[builtins.int] = None,
                      name: Optional[builtins.str] = None,
                      num_active_sessions: Optional[builtins.int] = None,
                      num_clusters: Optional[builtins.int] = None,
                      odbc_params: Optional[Union['GetSqlWarehouseOdbcParamsArgs', 'GetSqlWarehouseOdbcParamsArgsDict']] = None,
                      spot_instance_policy: Optional[builtins.str] = None,
    ...
    * SqlPermissions to manage data object access control lists in Databricks workspaces for things like tables, views, databases, and [more](https://docs.databricks.com/security/access-control/table-acls/object-privileges.html).
    ...
    :param builtins.str cluster_size: The size of the clusters allocated to the warehouse: "2X-Small", "X-Small", "Small", "Medium", "Large", "X-Large", "2X-Large", "3X-Large", "4X-Large".
    :param builtins.str creator_name: The username of the user who created the endpoint.
    :param builtins.str data_source_id: ID of the data source for this warehouse. This is used to bind an Databricks SQL query to an warehouse.
    :param builtins.bool enable_photon: Whether [Photon](https://databricks.com/product/delta-engine) is enabled.
    :param builtins.bool enable_serverless_compute: Whether this SQL warehouse is a serverless SQL warehouse.
    :param Union['GetSqlWarehouseHealthArgs', 'GetSqlWarehouseHealthArgsDict'] health: Health status of the endpoint.
    :param builtins.str id: The ID of the SQL warehouse.
    :param builtins.str jdbc_url: JDBC connection string.
    :param builtins.int max_num_clusters: Maximum number of clusters available when a SQL warehouse is running.
    :param builtins.int min_num_clusters: Minimum number of clusters available when a SQL warehouse is running.
    :param builtins.str name: Name of the SQL warehouse to search (case-sensitive).
    :param builtins.int num_active_sessions: The current number of clusters used by the endpoint.
    :param builtins.int num_clusters: The current number of clusters used by the endpoint.
...
def get_sql_warehouse_output(auto_stop_mins: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             channel: Optional[pulumi.Input[Optional[Union['GetSqlWarehouseChannelArgs', 'GetSqlWarehouseChannelArgsDict']]]] = None,
                             cluster_size: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             creator_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             data_source_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             enable_photon: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                             enable_serverless_compute: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                             health: Optional[pulumi.Input[Optional[Union['GetSqlWarehouseHealthArgs', 'GetSqlWarehouseHealthArgsDict']]]] = None,
                             id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             instance_profile_arn: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             jdbc_url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             max_num_clusters: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             min_num_clusters: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             num_active_sessions: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             num_clusters: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             odbc_params: Optional[pulumi.Input[Optional[Union['GetSqlWarehouseOdbcParamsArgs', 'GetSqlWarehouseOdbcParamsArgsDict']]]] = None,
                             spot_instance_policy: Optional[pulumi.Input[Optional[builtins.str]]] = None,
