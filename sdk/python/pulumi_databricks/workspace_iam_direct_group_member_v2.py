...
__all__ = ['WorkspaceIamDirectGroupMemberV2Args', 'WorkspaceIamDirectGroupMemberV2']

@pulumi.input_type
class WorkspaceIamDirectGroupMemberV2Args:
    def __init__(__self__, *,
                 principal_id: pulumi.Input[_builtins.str],
                 group_id: pulumi.Input[Optional[_builtins.int]] = None,
                 provider_config: pulumi.Input[Optional['WorkspaceIamDirectGroupMemberV2ProviderConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['WorkspaceIamDirectGroupMemberV2ProviderConfigArgs'] provider_config: Configure the provider for management through account provider.
        """
    ...
    def provider_config(self) -> pulumi.Input[Optional['WorkspaceIamDirectGroupMemberV2ProviderConfigArgs']]:
        """
    ...
    def provider_config(self, value: pulumi.Input[Optional['WorkspaceIamDirectGroupMemberV2ProviderConfigArgs']]):
        pulumi.set(self, "provider_config", value)


@pulumi.input_type
class _WorkspaceIamDirectGroupMemberV2State:
    def __init__(__self__, *,
...
@pulumi.type_token("databricks:index/workspaceIamDirectGroupMemberV2:WorkspaceIamDirectGroupMemberV2")
class WorkspaceIamDirectGroupMemberV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkspaceIamDirectGroupMemberV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkspaceIamDirectGroupMemberV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkspaceIamDirectGroupMemberV2Args.__new__(WorkspaceIamDirectGroupMemberV2Args)
        ...
        super(WorkspaceIamDirectGroupMemberV2, __self__).__init__(
            'databricks:index/workspaceIamDirectGroupMemberV2:WorkspaceIamDirectGroupMemberV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _WorkspaceIamDirectGroupMemberV2State.__new__(_WorkspaceIamDirectGroupMemberV2State)
        ...
        __props__.__dict__["provider_config"] = provider_config
        return WorkspaceIamDirectGroupMemberV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="providerConfig")
    def provider_config(self) -> pulumi.Output['outputs.WorkspaceIamDirectGroupMemberV2ProviderConfig']:
        """
        Configure the provider for management through account provider.
        """
        return pulumi.get(self, "provider_config")
