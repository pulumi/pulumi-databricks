...
__all__ = [
    'GetWorkspaceIamExternalUserV2Result',
    'AwaitableGetWorkspaceIamExternalUserV2Result',
    'get_workspace_iam_external_user_v2',
    'get_workspace_iam_external_user_v2_output',
]

@pulumi.output_type
class GetWorkspaceIamExternalUserV2Result:
    """
    A collection of values returned by getWorkspaceIamExternalUserV2.
    """
    def __init__(__self__, account_id=None, account_user_status=None, display_name=None, external_user_id=None, full_name=None, internal_id=None, name=None, provider_config=None, username=None):
    ...
    def full_name(self) -> 'outputs.GetWorkspaceIamExternalUserV2FullNameResult':
        """
    ...
    def provider_config(self) -> Optional['outputs.GetWorkspaceIamExternalUserV2ProviderConfigResult']:
...
class AwaitableGetWorkspaceIamExternalUserV2Result(GetWorkspaceIamExternalUserV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWorkspaceIamExternalUserV2Result(
...
def get_workspace_iam_external_user_v2(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('databricks:index/getWorkspaceIamExternalUserV2:getWorkspaceIamExternalUserV2', __args__, opts=opts, typ=GetWorkspaceIamExternalUserV2Result).value

    return AwaitableGetWorkspaceIamExternalUserV2Result(
...
def get_workspace_iam_external_user_v2_output(name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('databricks:index/getWorkspaceIamExternalUserV2:getWorkspaceIamExternalUserV2', __args__, opts=opts, typ=GetWorkspaceIamExternalUserV2Result)
    return __ret__.apply(lambda __response__: GetWorkspaceIamExternalUserV2Result(
