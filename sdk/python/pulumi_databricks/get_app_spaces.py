...
__all__ = [
    'GetAppSpacesResult',
    'AwaitableGetAppSpacesResult',
    'get_app_spaces',
    'get_app_spaces_output',
]

@pulumi.output_type
class GetAppSpacesResult:
    """
    ...
    def provider_config(self) -> Optional['outputs.GetAppSpacesProviderConfigResult']:
        return pulumi.get(self, "provider_config")

    @_builtins.property
    @pulumi.getter
    def spaces(self) -> Sequence['outputs.GetAppSpacesSpaceResult']:
        return pulumi.get(self, "spaces")


class AwaitableGetAppSpacesResult(GetAppSpacesResult):
...
def get_app_spaces_output(page_size: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                          provider_config: Optional[pulumi.Input[Optional[Union['GetAppSpacesProviderConfigArgs', 'GetAppSpacesProviderConfigArgsDict']]]] = None,
