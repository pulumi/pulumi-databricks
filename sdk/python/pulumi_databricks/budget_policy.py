...
class BudgetPolicyArgs:
    def __init__(__self__, *,
                 binding_workspace_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 custom_tags: pulumi.Input[Optional[Sequence[pulumi.Input['BudgetPolicyCustomTagArgs']]]] = None,
    ...
    def binding_workspace_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]:
        """
    ...
    def binding_workspace_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]):
        pulumi.set(self, "binding_workspace_ids", value)

    @_builtins.property
    @pulumi.getter(name="customTags")
    def custom_tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BudgetPolicyCustomTagArgs']]]]:
        """
    ...
    @custom_tags.setter
    def custom_tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BudgetPolicyCustomTagArgs']]]]):
...
class BudgetPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 binding_workspace_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 custom_tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BudgetPolicyCustomTagArgs', 'BudgetPolicyCustomTagArgsDict', 'outputs.BudgetPolicyCustomTag']]]]] = None,
                 policy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] binding_workspace_ids: List of workspaces that this budget policy will be exclusively bound to.
               An empty binding implies that this budget policy is open to any workspace in the account
        :param pulumi.Input[Sequence[pulumi.Input[Union['BudgetPolicyCustomTagArgs', 'BudgetPolicyCustomTagArgsDict', 'outputs.BudgetPolicyCustomTag']]]] custom_tags: A list of tags defined by the customer. At most 20 entries are allowed per policy
        :param pulumi.Input[_builtins.str] policy_id: (string) - The Id of the policy. This field is generated by Databricks and globally unique
        :param pulumi.Input[_builtins.str] policy_name: The name of the policy.
               - Must be unique among active policies.
               - Can contain only characters from the ISO 8859-1 (latin1) set.
    ...
    def get(resource_name: str,
            ...
            custom_tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BudgetPolicyCustomTagArgs', 'BudgetPolicyCustomTagArgsDict', 'outputs.BudgetPolicyCustomTag']]]]] = None,
            policy_id: pulumi.Input[Optional[_builtins.str]] = None,
            policy_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'BudgetPolicy':
        """
