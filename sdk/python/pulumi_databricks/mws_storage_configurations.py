...
class MwsStorageConfigurationsArgs:
    def __init__(__self__, *,
                 ...
                 storage_configuration_name: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] bucket_name: name of AWS S3 bucket
        :param pulumi.Input[builtins.str] storage_configuration_name: name under which this storage configuration is stored
        """
    ...
    def storage_configuration_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_configuration_name(self, value: pulumi.Input[builtins.str]):
...
class _MwsStorageConfigurationsState:
    def __init__(__self__, *,
                 ...
                 storage_configuration_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering MwsStorageConfigurations resources.
        :param pulumi.Input[builtins.str] account_id: Account Id that could be found in the top right corner of [Accounts Console](https://accounts.cloud.databricks.com/)
        :param pulumi.Input[builtins.str] bucket_name: name of AWS S3 bucket
        :param pulumi.Input[builtins.str] storage_configuration_id: (String) id of storage config to be used for `databricks_mws_workspace` resource.
        :param pulumi.Input[builtins.str] storage_configuration_name: name under which this storage configuration is stored
        """
    ...
    @property
    @pulumi.getter(name="storageConfigurationName")
    def storage_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        name under which this storage configuration is stored
        """
        return pulumi.get(self, "storage_configuration_name")
    ...
    @storage_configuration_name.setter
    def storage_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_configuration_name", value)
...
class MwsStorageConfigurations(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            creation_time: Optional[pulumi.Input[builtins.int]] = None,
            storage_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_configuration_name: Optional[pulumi.Input[builtins.str]] = None) -> 'MwsStorageConfigurations':
        """
    ...
    @property
    @pulumi.getter(name="storageConfigurationName")
    def storage_configuration_name(self) -> pulumi.Output[builtins.str]:
        """
        name under which this storage configuration is stored
        """
        return pulumi.get(self, "storage_configuration_name")
