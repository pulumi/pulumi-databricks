...
__all__ = [
    'GetDisasterRecoveryFailoverGroupsResult',
    'AwaitableGetDisasterRecoveryFailoverGroupsResult',
    'get_disaster_recovery_failover_groups',
    'get_disaster_recovery_failover_groups_output',
]

@pulumi.output_type
class GetDisasterRecoveryFailoverGroupsResult:
    """
...
class AwaitableGetDisasterRecoveryFailoverGroupsResult(GetDisasterRecoveryFailoverGroupsResult):
...
def get_disaster_recovery_failover_groups(page_size: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('databricks:index/getDisasterRecoveryFailoverGroups:getDisasterRecoveryFailoverGroups', __args__, opts=opts, typ=GetDisasterRecoveryFailoverGroupsResult).value
