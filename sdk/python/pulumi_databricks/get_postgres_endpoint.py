...
def get_postgres_endpoint(name: Optional[_builtins.str] = None,
                          provider_config: Optional[Union['GetPostgresEndpointProviderConfigArgs', 'GetPostgresEndpointProviderConfigArgsDict', 'outputs.GetPostgresEndpointProviderConfigResult']] = None,
    ...
    :param _builtins.str name: Output only. The full resource path of the endpoint.
           Format: projects/{project_id}/branches/{branch_id}/endpoints/{endpoint_id}
    :param Union['GetPostgresEndpointProviderConfigArgs', 'GetPostgresEndpointProviderConfigArgsDict', 'outputs.GetPostgresEndpointProviderConfigResult'] provider_config: Configure the provider for management through account provider.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_postgres_endpoint_output(name: pulumi.Input[Optional[_builtins.str]] = None,
                                 provider_config: pulumi.Input[Optional[Optional[Union['GetPostgresEndpointProviderConfigArgs', 'GetPostgresEndpointProviderConfigArgsDict', 'outputs.GetPostgresEndpointProviderConfigResult']]]] = None,
