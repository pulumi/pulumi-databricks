...
class _SystemSchemaState:
    def __init__(__self__, *,
                 auto_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] full_name: the full name of the system schema, in form of `system.<schema>`.
        :param pulumi.Input[builtins.str] schema: name of the system schema.
        :param pulumi.Input[builtins.str] state: The current state of enablement for the system schema.
        """
    ...
    def auto_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "auto_enabled")

    @auto_enabled.setter
    def auto_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SystemSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metastore_id: Optional[pulumi.Input[builtins.str]] = None,
            schema: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'SystemSchema':
        """
    ...
    @property
    @pulumi.getter(name="autoEnabled")
    def auto_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "auto_enabled")
