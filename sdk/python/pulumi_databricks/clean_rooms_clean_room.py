...
class CleanRoomsCleanRoomArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the clean room.
        ...
        :param pulumi.Input[builtins.str] owner: This is Databricks username of the owner of the local clean room securable for permission management
...
class _CleanRoomsCleanRoomState:
    def __init__(__self__, *,
                 access_restricted: Optional[pulumi.Input[builtins.str]] = None,
                 comment: Optional[pulumi.Input[builtins.str]] = None,
                 created_at: Optional[pulumi.Input[builtins.int]] = None,
                 local_collaborator_alias: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_restricted: (string) - Whether clean room access is restricted due to [CSP](https://docs.databricks.com/en/security/privacy/security-profile.html). Possible values are: `CSP_MISMATCH`, `NO_RESTRICTION`
        :param pulumi.Input[builtins.int] created_at: (integer) - When the clean room was created, in epoch milliseconds
        :param pulumi.Input[builtins.str] local_collaborator_alias: (string) - The alias of the collaborator tied to the local clean room
        :param pulumi.Input[builtins.str] name: The name of the clean room.
               It should follow [UC securable naming requirements](https://docs.databricks.com/en/data-governance/unity-catalog/index.html#securable-object-naming-requirements)
        ...
        :param pulumi.Input[builtins.int] updated_at: (integer) - When the clean room was last updated, in epoch milliseconds
        """
    ...
    def access_restricted(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_restricted(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def local_collaborator_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def local_collaborator_alias(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CleanRoomsCleanRoom(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remote_detailed_info: Optional[pulumi.Input[Union['CleanRoomsCleanRoomRemoteDetailedInfoArgs', 'CleanRoomsCleanRoomRemoteDetailedInfoArgsDict']]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.int]] = None) -> 'CleanRoomsCleanRoom':
        """
    ...
    @property
    @pulumi.getter(name="accessRestricted")
    def access_restricted(self) -> pulumi.Output[builtins.str]:
        """
        (string) - Whether clean room access is restricted due to [CSP](https://docs.databricks.com/en/security/privacy/security-profile.html). Possible values are: `CSP_MISMATCH`, `NO_RESTRICTION`
        """
        return pulumi.get(self, "access_restricted")
    ...
    @property
    @pulumi.getter(name="localCollaboratorAlias")
    def local_collaborator_alias(self) -> pulumi.Output[builtins.str]:
        """
        (string) - The alias of the collaborator tied to the local clean room
        """
        return pulumi.get(self, "local_collaborator_alias")
