...
class IpAccessListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: A string list of IP addresses and CIDR ranges.
        :param pulumi.Input[builtins.str] label: This is the display name for the given IP ACL List.
        :param pulumi.Input[builtins.str] list_type: Can only be "ALLOW" or "BLOCK".
        :param pulumi.Input[builtins.bool] enabled: Boolean `true` or `false` indicating whether this list should be active.  Defaults to `true`
        """
...
class IpAccessList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            label: Optional[pulumi.Input[builtins.str]] = None,
            list_type: Optional[pulumi.Input[builtins.str]] = None) -> 'IpAccessList':
        """
