...
class GetClusterPolicyResult:
    ...
    def provider_config(self) -> 'outputs.GetClusterPolicyProviderConfigResult':
...
def get_cluster_policy_output(definition: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              ...
                              max_clusters_per_user: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
