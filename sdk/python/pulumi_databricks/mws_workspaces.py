...
class MwsWorkspacesArgs:
    def __init__(__self__, *,
        ...
        if gke_config is not None:
            warnings.warn("""gke_config is deprecated and will be removed in a future release. For more information, review the documentation at https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/guides/gcp-workspace#creating-a-databricks-workspace""", DeprecationWarning)
            pulumi.log.warn("""gke_config is deprecated: gke_config is deprecated and will be removed in a future release. For more information, review the documentation at https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/guides/gcp-workspace#creating-a-databricks-workspace""")
        if gke_config is not None:
    ...
    @_utilities.deprecated("""gke_config is deprecated and will be removed in a future release. For more information, review the documentation at https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/guides/gcp-workspace#creating-a-databricks-workspace""")
