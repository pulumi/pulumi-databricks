...
class StorageCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] force_destroy: Delete storage credential regardless of its dependencies.
        :param pulumi.Input[builtins.bool] force_update: Update storage credential regardless of its dependents.
        :param pulumi.Input[builtins.str] isolation_mode: Whether the storage credential is accessible from all workspaces or a specific set of workspaces. Can be `ISOLATION_MODE_ISOLATED` or `ISOLATION_MODE_OPEN`. Setting the credential to `ISOLATION_MODE_ISOLATED` will automatically allow access from the current workspace.
               
               `aws_iam_role` optional configuration block for credential details for AWS:
        :param pulumi.Input[builtins.str] metastore_id: Unique identifier of the parent Metastore. If set for workspace-level, it must match the ID of the metastore assigned to the worspace. When changing the metastore assigned to a workspace, this field becomes required.
        :param pulumi.Input[builtins.str] name: Name of Storage Credentials, which must be unique within the databricks_metastore. Change forces creation of a new resource.
        :param pulumi.Input[builtins.str] owner: Username/groupname/sp application_id of the storage credential owner.
        :param pulumi.Input[builtins.bool] read_only: Indicates whether the storage credential is only usable for read operations.
        :param pulumi.Input[builtins.bool] skip_validation: Suppress validation errors if any & force save the storage credential.
        """
...
class _StorageCredentialState:
    def __init__(__self__, *,
                 ...
                 read_only: Optional[pulumi.Input[builtins.bool]] = None,
                 skip_validation: Optional[pulumi.Input[builtins.bool]] = None,
                 storage_credential_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] read_only: Indicates whether the storage credential is only usable for read operations.
        :param pulumi.Input[builtins.bool] skip_validation: Suppress validation errors if any & force save the storage credential.
        :param pulumi.Input[builtins.str] storage_credential_id: Unique ID of storage credential.
        """
        if aws_iam_role is not None:
            pulumi.set(__self__, "aws_iam_role", aws_iam_role)
        if azure_managed_identity is not None:
    ...
    def storage_credential_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_credential_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_credential_id", value)


@pulumi.type_token("databricks:index/storageCredential:StorageCredential")
class StorageCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            read_only: Optional[pulumi.Input[builtins.bool]] = None,
            skip_validation: Optional[pulumi.Input[builtins.bool]] = None,
            storage_credential_id: Optional[pulumi.Input[builtins.str]] = None) -> 'StorageCredential':
        """
    ...
    @property
    @pulumi.getter(name="storageCredentialId")
    def storage_credential_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique ID of storage credential.
        """
        return pulumi.get(self, "storage_credential_id")
