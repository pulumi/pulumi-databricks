...
__all__ = ['WorkspaceIamWorkspaceAssignmentV2Args', 'WorkspaceIamWorkspaceAssignmentV2']

@pulumi.input_type
class WorkspaceIamWorkspaceAssignmentV2Args:
    def __init__(__self__, *,
                 principal_id: pulumi.Input[_builtins.str],
                 entitlements: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 provider_config: pulumi.Input[Optional['WorkspaceIamWorkspaceAssignmentV2ProviderConfigArgs']] = None,
        ...
        :param pulumi.Input['WorkspaceIamWorkspaceAssignmentV2ProviderConfigArgs'] provider_config: Configure the provider for management through account provider.
    ...
    def provider_config(self) -> pulumi.Input[Optional['WorkspaceIamWorkspaceAssignmentV2ProviderConfigArgs']]:
        """
    ...
    def provider_config(self, value: pulumi.Input[Optional['WorkspaceIamWorkspaceAssignmentV2ProviderConfigArgs']]):
...
@pulumi.input_type
class _WorkspaceIamWorkspaceAssignmentV2State:
    def __init__(__self__, *,
...
@pulumi.type_token("databricks:index/workspaceIamWorkspaceAssignmentV2:WorkspaceIamWorkspaceAssignmentV2")
class WorkspaceIamWorkspaceAssignmentV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkspaceIamWorkspaceAssignmentV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkspaceIamWorkspaceAssignmentV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkspaceIamWorkspaceAssignmentV2Args.__new__(WorkspaceIamWorkspaceAssignmentV2Args)
        ...
        super(WorkspaceIamWorkspaceAssignmentV2, __self__).__init__(
            'databricks:index/workspaceIamWorkspaceAssignmentV2:WorkspaceIamWorkspaceAssignmentV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _WorkspaceIamWorkspaceAssignmentV2State.__new__(_WorkspaceIamWorkspaceAssignmentV2State)
        ...
        __props__.__dict__["provider_config"] = provider_config
        __props__.__dict__["workspace_id"] = workspace_id
        return WorkspaceIamWorkspaceAssignmentV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="providerConfig")
    def provider_config(self) -> pulumi.Output['outputs.WorkspaceIamWorkspaceAssignmentV2ProviderConfig']:
        """
        Configure the provider for management through account provider.
        """
        return pulumi.get(self, "provider_config")
