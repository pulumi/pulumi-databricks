...
class MetastoreAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 default_catalog_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MetastoreAssignment resource.
        :param pulumi.Input[builtins.str] metastore_id: Unique identifier of the parent Metastore
        :param pulumi.Input[builtins.str] workspace_id: id of the workspace for the assignment
        :param pulumi.Input[builtins.str] default_catalog_name: Default catalog used for this assignment. Please use DefaultNamespaceSetting instead.
        """
    ...
    def default_catalog_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_catalog_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MetastoreAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            default_catalog_name: Optional[pulumi.Input[builtins.str]] = None,
            metastore_id: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MetastoreAssignment':
        """
    ...
    @pulumi.getter(name="defaultCatalogName")
    @_utilities.deprecated("""Use DefaultNamespaceSetting resource instead""")
    def default_catalog_name(self) -> pulumi.Output[builtins.str]:
        """
        Default catalog used for this assignment. Please use DefaultNamespaceSetting instead.
        """
        return pulumi.get(self, "default_catalog_name")
