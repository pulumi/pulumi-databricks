...
class CustomAppIntegrationArgs:
    def __init__(__self__, *,
                 ...
                 user_authorized_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        The set of arguments for constructing a CustomAppIntegration resource.
        :param pulumi.Input[str] client_id: OAuth client-id generated by Databricks
        :param pulumi.Input[str] client_secret: OAuth client-secret generated by the Databricks if this is a confidential OAuth app.
        :param pulumi.Input[bool] confidential: Indicates whether an OAuth client secret is required to authenticate this client. Default to `false`. Change requires a new resource.
        :param pulumi.Input[str] integration_id: Unique integration id for the custom OAuth app.
        :param pulumi.Input[str] name: Name of the custom OAuth app. Change requires a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] redirect_urls: List of OAuth redirect urls.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] scopes: OAuth scopes granted to the application. Supported scopes: `all-apis`, `sql`, `offline_access`, `openid`, `profile`, `email`.
        """
    ...
    def user_authorized_scopes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        return pulumi.get(self, "user_authorized_scopes")

    @user_authorized_scopes.setter
    def user_authorized_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class CustomAppIntegration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            token_access_policy: Optional[pulumi.Input[Union['CustomAppIntegrationTokenAccessPolicyArgs', 'CustomAppIntegrationTokenAccessPolicyArgsDict']]] = None,
            user_authorized_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'CustomAppIntegration':
        """
    ...
    @property
    @pulumi.getter(name="userAuthorizedScopes")
    def user_authorized_scopes(self) -> pulumi.Output[Optional[Sequence[str]]]:
        return pulumi.get(self, "user_authorized_scopes")
