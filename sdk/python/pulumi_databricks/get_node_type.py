...
def get_node_type_output(arm: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                         category: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         fleet: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                         gb_per_core: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                         graviton: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                         id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         is_io_cache_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                         local_disk: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                         local_disk_min_size: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                         min_cores: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                         min_gpus: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
