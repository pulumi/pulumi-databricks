...
__all__ = ['AiGatewayMcpServiceArgs', 'AiGatewayMcpService']

@pulumi.input_type
class AiGatewayMcpServiceArgs:
    def __init__(__self__, *,
                 mcp_service_id: pulumi.Input[_builtins.str],
    ...
    @mcp_service_id.setter
    def mcp_service_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "mcp_service_id", value)
    ...
    def provider_config(self) -> pulumi.Input[Optional['AiGatewayMcpServiceProviderConfigArgs']]:
        """
    ...
    def provider_config(self, value: pulumi.Input[Optional['AiGatewayMcpServiceProviderConfigArgs']]):
...
class _AiGatewayMcpServiceState:
    ...
    @mcp_service_id.setter
    def mcp_service_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "mcp_service_id", value)
...
@pulumi.type_token("databricks:index/aiGatewayMcpService:AiGatewayMcpService")
class AiGatewayMcpService(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param AiGatewayMcpServiceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AiGatewayMcpServiceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AiGatewayMcpServiceArgs.__new__(AiGatewayMcpServiceArgs)
        ...
        super(AiGatewayMcpService, __self__).__init__(
            'databricks:index/aiGatewayMcpService:AiGatewayMcpService',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter(name="providerConfig")
    def provider_config(self) -> pulumi.Output['outputs.AiGatewayMcpServiceProviderConfig']:
        """
        Configure the provider for management through account provider.
        """
        return pulumi.get(self, "provider_config")
