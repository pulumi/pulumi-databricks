...
public final class MlflowModelTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MlflowModelTagArgs(MlflowModelTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(MlflowModelTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MlflowModelTagArgs();
        }

        public Builder(MlflowModelTagArgs defaults) {
