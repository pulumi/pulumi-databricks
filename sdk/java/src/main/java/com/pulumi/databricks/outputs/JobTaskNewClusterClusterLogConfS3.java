...
@CustomType
public final class JobTaskNewClusterClusterLogConfS3 {
    ...
    private JobTaskNewClusterClusterLogConfS3() {}
    ...
    public static Builder builder(JobTaskNewClusterClusterLogConfS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(JobTaskNewClusterClusterLogConfS3 defaults) {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobTaskNewClusterClusterLogConfS3", "destination");
            }
        ...
        public JobTaskNewClusterClusterLogConfS3 build() {
            final var _resultValue = new JobTaskNewClusterClusterLogConfS3();
