...
public final class GetFunctionsFunctionReturnParamParameterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFunctionsFunctionReturnParamParameterArgs Empty = new GetFunctionsFunctionReturnParamParameterArgs();
    ...
    private GetFunctionsFunctionReturnParamParameterArgs(GetFunctionsFunctionReturnParamParameterArgs $) {
    ...
    public static Builder builder(GetFunctionsFunctionReturnParamParameterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFunctionsFunctionReturnParamParameterArgs();
        }

        public Builder(GetFunctionsFunctionReturnParamParameterArgs defaults) {
            $ = new GetFunctionsFunctionReturnParamParameterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFunctionsFunctionReturnParamParameterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionReturnParamParameterArgs", "name");
            }
            if ($.position == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionReturnParamParameterArgs", "position");
            }
            if ($.typeName == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionReturnParamParameterArgs", "typeName");
            }
            if ($.typeText == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionReturnParamParameterArgs", "typeText");
            }
            return $;
        }
    }
