...
import com.pulumi.databricks.outputs.ModelServingProvisionedThroughputAiGatewayGuardrailsOutputPii;
...
@CustomType
public final class ModelServingProvisionedThroughputAiGatewayGuardrailsOutput {
    /**
     ...
     * 
     */
    private @Nullable ModelServingProvisionedThroughputAiGatewayGuardrailsOutputPii pii;
    /**
    ...
    private ModelServingProvisionedThroughputAiGatewayGuardrailsOutput() {}
    /**
     * @return List of invalid keywords. AI guardrail uses keyword or string matching to decide if the keyword exists in the request or response content.
     * 
     */
     ...
     * 
     */
    public Optional<ModelServingProvisionedThroughputAiGatewayGuardrailsOutputPii> pii() {
    ...
    public static Builder builder(ModelServingProvisionedThroughputAiGatewayGuardrailsOutput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> validTopics;
        public Builder() {}
        public Builder(ModelServingProvisionedThroughputAiGatewayGuardrailsOutput defaults) {
        ...
        @CustomType.Setter
        public Builder pii(@Nullable ModelServingProvisionedThroughputAiGatewayGuardrailsOutputPii pii) {
        ...
        public ModelServingProvisionedThroughputAiGatewayGuardrailsOutput build() {
            final var _resultValue = new ModelServingProvisionedThroughputAiGatewayGuardrailsOutput();
