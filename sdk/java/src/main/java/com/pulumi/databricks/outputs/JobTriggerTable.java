...
@CustomType
public final class JobTriggerTable {
    ...
    public static Builder builder(JobTriggerTable defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer waitAfterLastChangeSeconds;
        public Builder() {}
        public Builder(JobTriggerTable defaults) {
        ...
        public JobTriggerTable build() {
            final var _resultValue = new JobTriggerTable();
