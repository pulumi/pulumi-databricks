...
public final class GetClusterClusterInfoInitScriptS3Args extends com.pulumi.resources.ResourceArgs {

    public static final GetClusterClusterInfoInitScriptS3Args Empty = new GetClusterClusterInfoInitScriptS3Args();
    ...
    private GetClusterClusterInfoInitScriptS3Args() {}

    private GetClusterClusterInfoInitScriptS3Args(GetClusterClusterInfoInitScriptS3Args $) {
    ...
    public static Builder builder(GetClusterClusterInfoInitScriptS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClusterClusterInfoInitScriptS3Args();
        }

        public Builder(GetClusterClusterInfoInitScriptS3Args defaults) {
            $ = new GetClusterClusterInfoInitScriptS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public GetClusterClusterInfoInitScriptS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("GetClusterClusterInfoInitScriptS3Args", "destination");
            }
            return $;
        }
    }
