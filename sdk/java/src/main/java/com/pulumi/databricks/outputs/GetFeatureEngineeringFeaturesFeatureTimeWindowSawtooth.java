...
@CustomType
public final class GetFeatureEngineeringFeaturesFeatureTimeWindowSawtooth {
    /**
    ...
    private GetFeatureEngineeringFeaturesFeatureTimeWindowSawtooth() {}
    /**
     * @return (string) - The delay applied to the end of the window (must be non-negative).
     * For example, delay=1d shifts the window end 1 day before the evaluation time
     * 
    ...
    public static Builder builder(GetFeatureEngineeringFeaturesFeatureTimeWindowSawtooth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String windowDuration;
        public Builder() {}
        public Builder(GetFeatureEngineeringFeaturesFeatureTimeWindowSawtooth defaults) {
        ...
        public GetFeatureEngineeringFeaturesFeatureTimeWindowSawtooth build() {
            final var _resultValue = new GetFeatureEngineeringFeaturesFeatureTimeWindowSawtooth();
