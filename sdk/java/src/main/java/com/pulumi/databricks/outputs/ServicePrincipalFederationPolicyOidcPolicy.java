...
@CustomType
public final class ServicePrincipalFederationPolicyOidcPolicy {
    /**
    ...
    private ServicePrincipalFederationPolicyOidcPolicy() {}
    /**
     * @return The allowed token audiences, as specified in the &#39;aud&#39; claim of federated tokens.
     * The audience identifier is intended to represent the recipient of the token.
     * Can be any non-empty string value. As long as the audience in the token matches
    ...
    public static Builder builder(ServicePrincipalFederationPolicyOidcPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subjectClaim;
        public Builder() {}
        public Builder(ServicePrincipalFederationPolicyOidcPolicy defaults) {
        ...
        public ServicePrincipalFederationPolicyOidcPolicy build() {
            final var _resultValue = new ServicePrincipalFederationPolicyOidcPolicy();
