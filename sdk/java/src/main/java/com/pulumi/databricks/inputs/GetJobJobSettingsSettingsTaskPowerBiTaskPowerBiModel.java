...
public final class GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel extends com.pulumi.resources.InvokeArgs {

    public static final GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel Empty = new GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel();
    ...
    private GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel() {}

    private GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel(GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel();
        }

        public Builder(GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel defaults) {
            $ = new GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsTaskPowerBiTaskPowerBiModel build() {
            return $;
        }
    }
