...
@CustomType
public final class GetClusterClusterInfoAzureAttributesLogAnalyticsInfo {
    ...
    public static final class Builder {
        ...
        public GetClusterClusterInfoAzureAttributesLogAnalyticsInfo build() {
            final var _resultValue = new GetClusterClusterInfoAzureAttributesLogAnalyticsInfo();
