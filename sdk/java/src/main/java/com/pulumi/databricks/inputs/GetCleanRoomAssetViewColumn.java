...
import com.pulumi.databricks.inputs.GetCleanRoomAssetViewColumnMask;
...
public final class GetCleanRoomAssetViewColumn extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetViewColumn Empty = new GetCleanRoomAssetViewColumn();
     ...
     */
    @Import(name="mask")
    private @Nullable GetCleanRoomAssetViewColumnMask mask;

    /**
     * @return (ColumnMask)
     * 
     */
    public Optional<GetCleanRoomAssetViewColumnMask> mask() {
    ...
    private GetCleanRoomAssetViewColumn() {}

    private GetCleanRoomAssetViewColumn(GetCleanRoomAssetViewColumn $) {
    ...
    public static Builder builder(GetCleanRoomAssetViewColumn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetViewColumn();
        }

        public Builder(GetCleanRoomAssetViewColumn defaults) {
            $ = new GetCleanRoomAssetViewColumn(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder mask(@Nullable GetCleanRoomAssetViewColumnMask mask) {
            $.mask = mask;
            return this;
        }
        ...
        public GetCleanRoomAssetViewColumn build() {
            return $;
        }
    }
