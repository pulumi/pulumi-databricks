...
@CustomType
public final class GetFeatureEngineeringFeatureTimeWindowRolling {
    /**
    ...
    private GetFeatureEngineeringFeatureTimeWindowRolling() {}
    /**
     * @return (string) - The delay applied to the end of the rolling window (must be non-negative).
     * For example, delay=1d shifts the window end 1 day before the evaluation time
     * 
    ...
    public static Builder builder(GetFeatureEngineeringFeatureTimeWindowRolling defaults) {
    ...
    public static final class Builder {
        ...
        private String windowDuration;
        public Builder() {}
        public Builder(GetFeatureEngineeringFeatureTimeWindowRolling defaults) {
        ...
        public Builder windowDuration(String windowDuration) {
            if (windowDuration == null) {
              throw new MissingRequiredPropertyException("GetFeatureEngineeringFeatureTimeWindowRolling", "windowDuration");
            }
            this.windowDuration = windowDuration;
            return this;
        }
        public GetFeatureEngineeringFeatureTimeWindowRolling build() {
            final var _resultValue = new GetFeatureEngineeringFeatureTimeWindowRolling();
