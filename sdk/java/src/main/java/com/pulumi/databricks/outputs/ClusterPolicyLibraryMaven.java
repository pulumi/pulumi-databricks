...
@CustomType
public final class ClusterPolicyLibraryMaven {
    private String coordinates;
    private @Nullable List<String> exclusions;
    private @Nullable String repo;

    private ClusterPolicyLibraryMaven() {}
    ...
    public static Builder builder(ClusterPolicyLibraryMaven defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(ClusterPolicyLibraryMaven defaults) {
        ...
        public Builder coordinates(String coordinates) {
            if (coordinates == null) {
              throw new MissingRequiredPropertyException("ClusterPolicyLibraryMaven", "coordinates");
            }
        ...
        public ClusterPolicyLibraryMaven build() {
            final var _resultValue = new ClusterPolicyLibraryMaven();
