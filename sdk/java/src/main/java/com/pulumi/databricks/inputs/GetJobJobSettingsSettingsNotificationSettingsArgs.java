...
public final class GetJobJobSettingsSettingsNotificationSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsNotificationSettingsArgs Empty = new GetJobJobSettingsSettingsNotificationSettingsArgs();
    ...
    private GetJobJobSettingsSettingsNotificationSettingsArgs() {}

    private GetJobJobSettingsSettingsNotificationSettingsArgs(GetJobJobSettingsSettingsNotificationSettingsArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsNotificationSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsNotificationSettingsArgs();
        }

        public Builder(GetJobJobSettingsSettingsNotificationSettingsArgs defaults) {
            $ = new GetJobJobSettingsSettingsNotificationSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsNotificationSettingsArgs build() {
            return $;
        }
    }
