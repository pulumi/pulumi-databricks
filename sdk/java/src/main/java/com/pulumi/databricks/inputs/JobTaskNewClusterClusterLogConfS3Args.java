...
public final class JobTaskNewClusterClusterLogConfS3Args extends com.pulumi.resources.ResourceArgs {

    public static final JobTaskNewClusterClusterLogConfS3Args Empty = new JobTaskNewClusterClusterLogConfS3Args();
    ...
    private JobTaskNewClusterClusterLogConfS3Args() {}

    private JobTaskNewClusterClusterLogConfS3Args(JobTaskNewClusterClusterLogConfS3Args $) {
    ...
    public static Builder builder(JobTaskNewClusterClusterLogConfS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskNewClusterClusterLogConfS3Args();
        }

        public Builder(JobTaskNewClusterClusterLogConfS3Args defaults) {
            $ = new JobTaskNewClusterClusterLogConfS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskNewClusterClusterLogConfS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("JobTaskNewClusterClusterLogConfS3Args", "destination");
            }
            return $;
        }
    }
