...
public final class AlertV2EvaluationThresholdColumn {
    ...
    public static Builder builder(AlertV2EvaluationThresholdColumn defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(AlertV2EvaluationThresholdColumn defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("AlertV2EvaluationThresholdColumn", "name");
            }
            this.name = name;
            return this;
        }
        public AlertV2EvaluationThresholdColumn build() {
            final var _resultValue = new AlertV2EvaluationThresholdColumn();
