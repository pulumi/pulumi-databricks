...
import com.pulumi.databricks.outputs.GetPolicyInfoDeny;
import com.pulumi.databricks.outputs.GetPolicyInfoGrant;
...
public final class GetPolicyInfoResult {
     ...
     * 
     */
    private GetPolicyInfoDeny deny;
    /**
     ...
     * 
     */
    private GetPolicyInfoGrant grant;
    /**
     ...
     * 
     */
    public GetPolicyInfoGrant grant() {
        return this.grant;
    }
    /**
     * @return (string) - Unique identifier of the policy. This field is output only and is generated by the system
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder deny(GetPolicyInfoDeny deny) {
            if (deny == null) {
              throw new MissingRequiredPropertyException("GetPolicyInfoResult", "deny");
            }
            this.deny = deny;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder grant(GetPolicyInfoGrant grant) {
            if (grant == null) {
              throw new MissingRequiredPropertyException("GetPolicyInfoResult", "grant");
            }
            this.grant = grant;
            return this;
        }
