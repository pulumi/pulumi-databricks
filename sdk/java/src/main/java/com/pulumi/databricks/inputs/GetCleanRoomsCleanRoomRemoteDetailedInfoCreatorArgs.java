...
public final class GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs Empty = new GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs();
    ...
    private GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs() {}

    private GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs(GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs $) {
    ...
    public static Builder builder(GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs();
        }

        public Builder(GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs defaults) {
            $ = new GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs build() {
            if ($.collaboratorAlias == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs", "collaboratorAlias");
            }
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs", "displayName");
            }
            if ($.organizationName == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomRemoteDetailedInfoCreatorArgs", "organizationName");
            }
            return $;
        }
    }
