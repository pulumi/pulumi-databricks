...
import com.pulumi.databricks.outputs.GetAiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumn;
import com.pulumi.databricks.outputs.GetAiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn;
...
@CustomType
public final class GetAiSearchIndexDeltaSyncIndexSpec {
    /**
     ...
     * 
     */
    private @Nullable List<GetAiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumn> embeddingSourceColumns;
    /**
     * @return (list of EmbeddingVectorColumn) - The columns that contain the embedding vectors
     * 
     */
    private @Nullable List<GetAiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn> embeddingVectorColumns;
    /**
    ...
    private GetAiSearchIndexDeltaSyncIndexSpec() {}
    /**
     * @return (list of string) - [Optional] Select the columns to sync with the index. If left blank, all columns
     * from the source table are synced. The primary key column and embedding source or
     * vector column are always synced
     ...
     * 
     */
    public List<GetAiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumn> embeddingSourceColumns() {
     ...
     * 
     */
    public List<GetAiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn> embeddingVectorColumns() {
    ...
    public static Builder builder(GetAiSearchIndexDeltaSyncIndexSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceTable;
        public Builder() {}
        public Builder(GetAiSearchIndexDeltaSyncIndexSpec defaults) {
        ...
        @CustomType.Setter
        public Builder embeddingSourceColumns(@Nullable List<GetAiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumn> embeddingSourceColumns) {

            this.embeddingSourceColumns = embeddingSourceColumns;
            return this;
        }
        public Builder embeddingSourceColumns(GetAiSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumn... embeddingSourceColumns) {
            return embeddingSourceColumns(List.of(embeddingSourceColumns));
        }
        @CustomType.Setter
        public Builder embeddingVectorColumns(@Nullable List<GetAiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn> embeddingVectorColumns) {

            this.embeddingVectorColumns = embeddingVectorColumns;
            return this;
        }
        public Builder embeddingVectorColumns(GetAiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn... embeddingVectorColumns) {
        ...
        public Builder pipelineId(String pipelineId) {
            if (pipelineId == null) {
              throw new MissingRequiredPropertyException("GetAiSearchIndexDeltaSyncIndexSpec", "pipelineId");
            }
        ...
        public Builder pipelineType(String pipelineType) {
            if (pipelineType == null) {
              throw new MissingRequiredPropertyException("GetAiSearchIndexDeltaSyncIndexSpec", "pipelineType");
            }
        ...
        public GetAiSearchIndexDeltaSyncIndexSpec build() {
            final var _resultValue = new GetAiSearchIndexDeltaSyncIndexSpec();
