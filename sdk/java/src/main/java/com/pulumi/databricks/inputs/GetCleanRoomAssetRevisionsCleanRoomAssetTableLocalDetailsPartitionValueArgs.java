...
public final class GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs Empty = new GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs();
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs() {}

    private GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs(GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs $) {
        this.name = $.name;
        this.op = $.op;
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs();
        }

        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs defaults) {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValueArgs build() {
            return $;
        }
    }
