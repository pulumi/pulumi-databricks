...
public final class GetQualityMonitorV2AnomalyDetectionConfig {
    ...
    public static Builder builder(GetQualityMonitorV2AnomalyDetectionConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder lastRunId(String lastRunId) {
            if (lastRunId == null) {
              throw new MissingRequiredPropertyException("GetQualityMonitorV2AnomalyDetectionConfig", "lastRunId");
            }
        ...
        public Builder latestRunStatus(String latestRunStatus) {
            if (latestRunStatus == null) {
              throw new MissingRequiredPropertyException("GetQualityMonitorV2AnomalyDetectionConfig", "latestRunStatus");
            }
