...
public final class GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs Empty = new GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs();
    ...
    private GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs() {}

    private GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs(GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs();
        }

        public Builder(GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs defaults) {
            $ = new GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsJobClusterNewClusterAzureAttributesArgs build() {
            return $;
        }
    }
