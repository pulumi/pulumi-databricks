    ...
    public static final class Builder {
        ...
        public LakehouseMonitorScheduleArgs build() {
            if ($.quartzCronExpression == null) {
                throw new MissingRequiredPropertyException("LakehouseMonitorScheduleArgs", "quartzCronExpression");
            }
            if ($.timezoneId == null) {
                throw new MissingRequiredPropertyException("LakehouseMonitorScheduleArgs", "timezoneId");
            }
            return $;
        }
    }
