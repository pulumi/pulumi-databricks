...
public final class GetClusterClusterInfoSpecAwsAttributes extends com.pulumi.resources.InvokeArgs {

    public static final GetClusterClusterInfoSpecAwsAttributes Empty = new GetClusterClusterInfoSpecAwsAttributes();
    ...
    private GetClusterClusterInfoSpecAwsAttributes() {}

    private GetClusterClusterInfoSpecAwsAttributes(GetClusterClusterInfoSpecAwsAttributes $) {
    ...
    public static Builder builder(GetClusterClusterInfoSpecAwsAttributes defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClusterClusterInfoSpecAwsAttributes();
        }

        public Builder(GetClusterClusterInfoSpecAwsAttributes defaults) {
            $ = new GetClusterClusterInfoSpecAwsAttributes(Objects.requireNonNull(defaults));
        }
        ...
        public GetClusterClusterInfoSpecAwsAttributes build() {
            return $;
        }
    }
