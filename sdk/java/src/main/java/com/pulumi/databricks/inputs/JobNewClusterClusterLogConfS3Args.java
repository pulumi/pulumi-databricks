...
public final class JobNewClusterClusterLogConfS3Args extends com.pulumi.resources.ResourceArgs {

    public static final JobNewClusterClusterLogConfS3Args Empty = new JobNewClusterClusterLogConfS3Args();
    ...
    private JobNewClusterClusterLogConfS3Args() {}

    private JobNewClusterClusterLogConfS3Args(JobNewClusterClusterLogConfS3Args $) {
    ...
    public static Builder builder(JobNewClusterClusterLogConfS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobNewClusterClusterLogConfS3Args();
        }

        public Builder(JobNewClusterClusterLogConfS3Args defaults) {
            $ = new JobNewClusterClusterLogConfS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public JobNewClusterClusterLogConfS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("JobNewClusterClusterLogConfS3Args", "destination");
            }
            return $;
        }
    }
