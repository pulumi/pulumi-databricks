...
@CustomType
public final class GetPostgresSyncedTableStatusOngoingSyncProgress {
    /**
    ...
    private GetPostgresSyncedTableStatusOngoingSyncProgress() {}
    /**
     * @return (number) - The estimated time remaining to complete this update in seconds
     * 
     */
    ...
    public static Builder builder(GetPostgresSyncedTableStatusOngoingSyncProgress defaults) {
    ...
    public static final class Builder {
        ...
        private Integer totalRowCount;
        public Builder() {}
        public Builder(GetPostgresSyncedTableStatusOngoingSyncProgress defaults) {
        ...
        public Builder estimatedCompletionTimeSeconds(Double estimatedCompletionTimeSeconds) {
            if (estimatedCompletionTimeSeconds == null) {
              throw new MissingRequiredPropertyException("GetPostgresSyncedTableStatusOngoingSyncProgress", "estimatedCompletionTimeSeconds");
            }
        ...
        public Builder latestVersionCurrentlyProcessing(Integer latestVersionCurrentlyProcessing) {
            if (latestVersionCurrentlyProcessing == null) {
              throw new MissingRequiredPropertyException("GetPostgresSyncedTableStatusOngoingSyncProgress", "latestVersionCurrentlyProcessing");
            }
        ...
        public Builder syncProgressCompletion(Double syncProgressCompletion) {
            if (syncProgressCompletion == null) {
              throw new MissingRequiredPropertyException("GetPostgresSyncedTableStatusOngoingSyncProgress", "syncProgressCompletion");
            }
        ...
        public Builder syncedRowCount(Integer syncedRowCount) {
            if (syncedRowCount == null) {
              throw new MissingRequiredPropertyException("GetPostgresSyncedTableStatusOngoingSyncProgress", "syncedRowCount");
            }
        ...
        public Builder totalRowCount(Integer totalRowCount) {
            if (totalRowCount == null) {
              throw new MissingRequiredPropertyException("GetPostgresSyncedTableStatusOngoingSyncProgress", "totalRowCount");
            }
            this.totalRowCount = totalRowCount;
            return this;
        }
        public GetPostgresSyncedTableStatusOngoingSyncProgress build() {
            final var _resultValue = new GetPostgresSyncedTableStatusOngoingSyncProgress();
