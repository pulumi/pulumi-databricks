...
public final class JobJobClusterNewClusterClusterLogConfS3 {
    ...
    public static final class Builder {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobJobClusterNewClusterClusterLogConfS3", "destination");
            }
        ...
        public JobJobClusterNewClusterClusterLogConfS3 build() {
            final var _resultValue = new JobJobClusterNewClusterClusterLogConfS3();
