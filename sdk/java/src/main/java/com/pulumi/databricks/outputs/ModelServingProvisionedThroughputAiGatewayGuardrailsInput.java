...
import com.pulumi.databricks.outputs.ModelServingProvisionedThroughputAiGatewayGuardrailsInputPii;
...
@CustomType
public final class ModelServingProvisionedThroughputAiGatewayGuardrailsInput {
    /**
     ...
     * 
     */
    private @Nullable ModelServingProvisionedThroughputAiGatewayGuardrailsInputPii pii;
    /**
    ...
    private ModelServingProvisionedThroughputAiGatewayGuardrailsInput() {}
    /**
     * @return List of invalid keywords. AI guardrail uses keyword or string matching to decide if the keyword exists in the request or response content.
     * 
     */
     ...
     * 
     */
    public Optional<ModelServingProvisionedThroughputAiGatewayGuardrailsInputPii> pii() {
    ...
    public static Builder builder(ModelServingProvisionedThroughputAiGatewayGuardrailsInput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> validTopics;
        public Builder() {}
        public Builder(ModelServingProvisionedThroughputAiGatewayGuardrailsInput defaults) {
        ...
        @CustomType.Setter
        public Builder pii(@Nullable ModelServingProvisionedThroughputAiGatewayGuardrailsInputPii pii) {
        ...
        public ModelServingProvisionedThroughputAiGatewayGuardrailsInput build() {
            final var _resultValue = new ModelServingProvisionedThroughputAiGatewayGuardrailsInput();
