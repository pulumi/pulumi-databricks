...
public final class JobTaskForEachTaskTaskSparkPythonTaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTaskForEachTaskTaskSparkPythonTaskArgs Empty = new JobTaskForEachTaskTaskSparkPythonTaskArgs();
    ...
    private JobTaskForEachTaskTaskSparkPythonTaskArgs() {}

    private JobTaskForEachTaskTaskSparkPythonTaskArgs(JobTaskForEachTaskTaskSparkPythonTaskArgs $) {
    ...
    public static Builder builder(JobTaskForEachTaskTaskSparkPythonTaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskForEachTaskTaskSparkPythonTaskArgs();
        }

        public Builder(JobTaskForEachTaskTaskSparkPythonTaskArgs defaults) {
            $ = new JobTaskForEachTaskTaskSparkPythonTaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskForEachTaskTaskSparkPythonTaskArgs build() {
            if ($.pythonFile == null) {
                throw new MissingRequiredPropertyException("JobTaskForEachTaskTaskSparkPythonTaskArgs", "pythonFile");
            }
            return $;
        }
    }
