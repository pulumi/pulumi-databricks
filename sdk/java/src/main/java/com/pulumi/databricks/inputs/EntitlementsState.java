...
public final class EntitlementsState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param databricksSqlAccess This is a field to allow the principal to have access to [Databricks SQL](https://databricks.com/product/databricks-sql)  UI, [Databricks One](https://docs.databricks.com/aws/en/workspace/databricks-one#who-can-access-databricks-one) and through databricks_sql_endpoint.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param workspaceAccess This is a field to allow the principal to have access to a Databricks Workspace UI and [Databricks One](https://docs.databricks.com/aws/en/workspace/databricks-one#who-can-access-databricks-one).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param workspaceConsume This is a field to allow the principal to have access only to [Databricks One](https://docs.databricks.com/aws/en/workspace/databricks-one#who-can-access-databricks-one).  Couldn&#39;t be used with `workspaceAccess` or `databricksSqlAccess`.
         * 
         * @return builder
         * 
         */
