...
public final class AiGatewayMcpServiceConfigRateLimitArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AiGatewayMcpServiceConfigRateLimitArgs() {}

    private AiGatewayMcpServiceConfigRateLimitArgs(AiGatewayMcpServiceConfigRateLimitArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AiGatewayMcpServiceConfigRateLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AiGatewayMcpServiceConfigRateLimitArgs();
        }

        public Builder(AiGatewayMcpServiceConfigRateLimitArgs defaults) {
            $ = new AiGatewayMcpServiceConfigRateLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AiGatewayMcpServiceConfigRateLimitArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("AiGatewayMcpServiceConfigRateLimitArgs", "key");
            }
            if ($.renewalPeriod == null) {
                throw new MissingRequiredPropertyException("AiGatewayMcpServiceConfigRateLimitArgs", "renewalPeriod");
            }
            return $;
        }
    }
