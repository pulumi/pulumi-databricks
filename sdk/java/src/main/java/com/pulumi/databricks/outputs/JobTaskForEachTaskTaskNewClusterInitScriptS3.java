...
@CustomType
public final class JobTaskForEachTaskTaskNewClusterInitScriptS3 {
    ...
    private JobTaskForEachTaskTaskNewClusterInitScriptS3() {}
    ...
    public static Builder builder(JobTaskForEachTaskTaskNewClusterInitScriptS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(JobTaskForEachTaskTaskNewClusterInitScriptS3 defaults) {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobTaskForEachTaskTaskNewClusterInitScriptS3", "destination");
            }
        ...
        public JobTaskForEachTaskTaskNewClusterInitScriptS3 build() {
            final var _resultValue = new JobTaskForEachTaskTaskNewClusterInitScriptS3();
