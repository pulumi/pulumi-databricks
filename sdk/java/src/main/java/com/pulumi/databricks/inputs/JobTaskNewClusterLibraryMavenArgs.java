...
public final class JobTaskNewClusterLibraryMavenArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTaskNewClusterLibraryMavenArgs Empty = new JobTaskNewClusterLibraryMavenArgs();
    ...
    private JobTaskNewClusterLibraryMavenArgs(JobTaskNewClusterLibraryMavenArgs $) {
    ...
    public static Builder builder(JobTaskNewClusterLibraryMavenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskNewClusterLibraryMavenArgs();
        }

        public Builder(JobTaskNewClusterLibraryMavenArgs defaults) {
            $ = new JobTaskNewClusterLibraryMavenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskNewClusterLibraryMavenArgs build() {
            if ($.coordinates == null) {
                throw new MissingRequiredPropertyException("JobTaskNewClusterLibraryMavenArgs", "coordinates");
            }
            return $;
        }
    }
