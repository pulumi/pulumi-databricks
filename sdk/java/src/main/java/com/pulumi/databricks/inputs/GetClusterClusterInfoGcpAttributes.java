...
public final class GetClusterClusterInfoGcpAttributes extends com.pulumi.resources.InvokeArgs {

    public static final GetClusterClusterInfoGcpAttributes Empty = new GetClusterClusterInfoGcpAttributes();
    ...
    private GetClusterClusterInfoGcpAttributes() {}
    ...
    public static Builder builder(GetClusterClusterInfoGcpAttributes defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClusterClusterInfoGcpAttributes();
        }

        public Builder(GetClusterClusterInfoGcpAttributes defaults) {
            $ = new GetClusterClusterInfoGcpAttributes(Objects.requireNonNull(defaults));
        }
        ...
        public GetClusterClusterInfoGcpAttributes build() {
            return $;
        }
    }
