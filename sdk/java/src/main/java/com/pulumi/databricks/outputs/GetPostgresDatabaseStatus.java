...
public final class GetPostgresDatabaseStatus {
    ...
    public static Builder builder(GetPostgresDatabaseStatus defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String role;
        public Builder() {}
        public Builder(GetPostgresDatabaseStatus defaults) {
        ...
        public Builder databaseId(String databaseId) {
            if (databaseId == null) {
              throw new MissingRequiredPropertyException("GetPostgresDatabaseStatus", "databaseId");
            }
        ...
        public GetPostgresDatabaseStatus build() {
            final var _resultValue = new GetPostgresDatabaseStatus();
