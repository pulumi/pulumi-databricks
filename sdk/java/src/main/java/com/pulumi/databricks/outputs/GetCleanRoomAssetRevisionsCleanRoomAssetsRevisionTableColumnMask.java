...
@CustomType
public final class GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionTableColumnMask {
    /**
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionTableColumnMask() {}
    /**
     * @return (string) - The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionTableColumnMask defaults) {
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionTableColumnMask build() {
            final var _resultValue = new GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionTableColumnMask();
