...
public final class WorkspaceBindingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(WorkspaceBindingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceBindingArgs();
        }

        public Builder(WorkspaceBindingArgs defaults) {
            $ = new WorkspaceBindingArgs(Objects.requireNonNull(defaults));
        }
