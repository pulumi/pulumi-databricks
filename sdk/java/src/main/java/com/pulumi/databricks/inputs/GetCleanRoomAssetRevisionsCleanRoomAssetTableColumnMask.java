...
public final class GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask Empty = new GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask();
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask() {}

    private GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask(GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask $) {
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask();
        }

        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask defaults) {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask build() {
            return $;
        }
    }
