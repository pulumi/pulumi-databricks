...
public class OnlineTable extends com.pulumi.resources.CustomResource {
     ...
     */
    public OnlineTable(String name) {
     ...
     */
    public OnlineTable(String name, @Nullable OnlineTableArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OnlineTable(String name, @Nullable OnlineTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/onlineTable:OnlineTable", name, args == null ? OnlineTableArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OnlineTable(String name, Output<String> id, @Nullable OnlineTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/onlineTable:OnlineTable", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static OnlineTable get(String name, Output<String> id, @Nullable OnlineTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
