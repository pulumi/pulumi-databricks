...
public final class GetAccountNetworkPolicyIngressDryRunPrivateAccessAllowRuleOriginEndpoints {
    ...
    public static Builder builder(GetAccountNetworkPolicyIngressDryRunPrivateAccessAllowRuleOriginEndpoints defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> endpointIds;
        public Builder() {}
        public Builder(GetAccountNetworkPolicyIngressDryRunPrivateAccessAllowRuleOriginEndpoints defaults) {
        ...
        public GetAccountNetworkPolicyIngressDryRunPrivateAccessAllowRuleOriginEndpoints build() {
            final var _resultValue = new GetAccountNetworkPolicyIngressDryRunPrivateAccessAllowRuleOriginEndpoints();
