...
public final class AppSpaceResourceUcSecurableArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppSpaceResourceUcSecurableArgs Empty = new AppSpaceResourceUcSecurableArgs();
    ...
    private AppSpaceResourceUcSecurableArgs() {}

    private AppSpaceResourceUcSecurableArgs(AppSpaceResourceUcSecurableArgs $) {
    ...
    public static Builder builder(AppSpaceResourceUcSecurableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSpaceResourceUcSecurableArgs();
        }

        public Builder(AppSpaceResourceUcSecurableArgs defaults) {
            $ = new AppSpaceResourceUcSecurableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppSpaceResourceUcSecurableArgs build() {
            if ($.permission == null) {
                throw new MissingRequiredPropertyException("AppSpaceResourceUcSecurableArgs", "permission");
            }
            if ($.securableFullName == null) {
                throw new MissingRequiredPropertyException("AppSpaceResourceUcSecurableArgs", "securableFullName");
            }
            if ($.securableType == null) {
                throw new MissingRequiredPropertyException("AppSpaceResourceUcSecurableArgs", "securableType");
            }
            return $;
        }
    }
