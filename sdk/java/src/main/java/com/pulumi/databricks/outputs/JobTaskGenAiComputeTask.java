...
import com.pulumi.databricks.outputs.JobTaskGenAiComputeTaskCompute;
...
public final class JobTaskGenAiComputeTask {
    ...
    public static Builder builder(JobTaskGenAiComputeTask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String yamlParametersFilePath;
        public Builder() {}
        public Builder(JobTaskGenAiComputeTask defaults) {
        ...
        @CustomType.Setter
        public Builder compute(@Nullable JobTaskGenAiComputeTaskCompute compute) {
        ...
        public Builder dlRuntimeImage(String dlRuntimeImage) {
            if (dlRuntimeImage == null) {
              throw new MissingRequiredPropertyException("JobTaskGenAiComputeTask", "dlRuntimeImage");
            }
        ...
        public JobTaskGenAiComputeTask build() {
            final var _resultValue = new JobTaskGenAiComputeTask();
