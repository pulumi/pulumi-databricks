...
@CustomType
public final class JobTaskForEachTaskTaskNewClusterClusterLogConfS3 {
    ...
    private JobTaskForEachTaskTaskNewClusterClusterLogConfS3() {}
    ...
    public static Builder builder(JobTaskForEachTaskTaskNewClusterClusterLogConfS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(JobTaskForEachTaskTaskNewClusterClusterLogConfS3 defaults) {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobTaskForEachTaskTaskNewClusterClusterLogConfS3", "destination");
            }
        ...
        public JobTaskForEachTaskTaskNewClusterClusterLogConfS3 build() {
            final var _resultValue = new JobTaskForEachTaskTaskNewClusterClusterLogConfS3();
