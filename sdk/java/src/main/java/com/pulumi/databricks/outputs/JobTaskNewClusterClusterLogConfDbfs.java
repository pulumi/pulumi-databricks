...
public final class JobTaskNewClusterClusterLogConfDbfs {
    ...
    public static final class Builder {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobTaskNewClusterClusterLogConfDbfs", "destination");
            }
            this.destination = destination;
            return this;
        }
        public JobTaskNewClusterClusterLogConfDbfs build() {
            final var _resultValue = new JobTaskNewClusterClusterLogConfDbfs();
