...
public final class AiGatewayModelProviderServiceConfigTarget {
    ...
    public static Builder builder(AiGatewayModelProviderServiceConfigTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> nativeApiTypes;
        public Builder() {}
        public Builder(AiGatewayModelProviderServiceConfigTarget defaults) {
        ...
        public Builder model(String model) {
            if (model == null) {
              throw new MissingRequiredPropertyException("AiGatewayModelProviderServiceConfigTarget", "model");
            }
            this.model = model;
            return this;
        }
        ...
        public AiGatewayModelProviderServiceConfigTarget build() {
            final var _resultValue = new AiGatewayModelProviderServiceConfigTarget();
