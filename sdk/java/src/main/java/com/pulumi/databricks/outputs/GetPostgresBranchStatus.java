...
public final class GetPostgresBranchStatus {
    ...
    public static Builder builder(GetPostgresBranchStatus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder branchId(String branchId) {
            if (branchId == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "branchId");
            }
        ...
        public Builder currentState(String currentState) {
            if (currentState == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "currentState");
            }
        ...
        public Builder expireTime(String expireTime) {
            if (expireTime == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "expireTime");
            }
        ...
        public Builder isProtected(Boolean isProtected) {
            if (isProtected == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "isProtected");
            }
        ...
        public Builder logicalSizeBytes(Integer logicalSizeBytes) {
            if (logicalSizeBytes == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "logicalSizeBytes");
            }
        ...
        public Builder sourceBranch(String sourceBranch) {
            if (sourceBranch == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "sourceBranch");
            }
        ...
        public Builder sourceBranchLsn(String sourceBranchLsn) {
            if (sourceBranchLsn == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "sourceBranchLsn");
            }
        ...
        public Builder sourceBranchTime(String sourceBranchTime) {
            if (sourceBranchTime == null) {
              throw new MissingRequiredPropertyException("GetPostgresBranchStatus", "sourceBranchTime");
            }
        ...
        public GetPostgresBranchStatus build() {
            final var _resultValue = new GetPostgresBranchStatus();
