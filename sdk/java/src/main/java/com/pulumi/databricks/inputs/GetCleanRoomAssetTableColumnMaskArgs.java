...
public final class GetCleanRoomAssetTableColumnMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCleanRoomAssetTableColumnMaskArgs Empty = new GetCleanRoomAssetTableColumnMaskArgs();
    ...
    private GetCleanRoomAssetTableColumnMaskArgs() {}

    private GetCleanRoomAssetTableColumnMaskArgs(GetCleanRoomAssetTableColumnMaskArgs $) {
    ...
    public static Builder builder(GetCleanRoomAssetTableColumnMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetTableColumnMaskArgs();
        }

        public Builder(GetCleanRoomAssetTableColumnMaskArgs defaults) {
            $ = new GetCleanRoomAssetTableColumnMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetTableColumnMaskArgs build() {
            return $;
        }
    }
