...
public final class JobJobClusterNewClusterClusterLogConfS3Args extends com.pulumi.resources.ResourceArgs {

    public static final JobJobClusterNewClusterClusterLogConfS3Args Empty = new JobJobClusterNewClusterClusterLogConfS3Args();
    ...
    private JobJobClusterNewClusterClusterLogConfS3Args() {}

    private JobJobClusterNewClusterClusterLogConfS3Args(JobJobClusterNewClusterClusterLogConfS3Args $) {
    ...
    public static Builder builder(JobJobClusterNewClusterClusterLogConfS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobJobClusterNewClusterClusterLogConfS3Args();
        }

        public Builder(JobJobClusterNewClusterClusterLogConfS3Args defaults) {
            $ = new JobJobClusterNewClusterClusterLogConfS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public JobJobClusterNewClusterClusterLogConfS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("JobJobClusterNewClusterClusterLogConfS3Args", "destination");
            }
            return $;
        }
    }
