...
@CustomType
public final class CleanRoomAssetTableColumnMask {
    /**
    ...
    private CleanRoomAssetTableColumnMask() {}
    /**
     * @return The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(CleanRoomAssetTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(CleanRoomAssetTableColumnMask defaults) {
        ...
        public CleanRoomAssetTableColumnMask build() {
            final var _resultValue = new CleanRoomAssetTableColumnMask();
