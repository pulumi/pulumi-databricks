...
@CustomType
public final class ExternalLocationEffectiveFileEventQueueProvidedAqs {
    ...
    public static Builder builder(ExternalLocationEffectiveFileEventQueueProvidedAqs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subscriptionId;
        public Builder() {}
        public Builder(ExternalLocationEffectiveFileEventQueueProvidedAqs defaults) {
        ...
        public ExternalLocationEffectiveFileEventQueueProvidedAqs build() {
            final var _resultValue = new ExternalLocationEffectiveFileEventQueueProvidedAqs();
