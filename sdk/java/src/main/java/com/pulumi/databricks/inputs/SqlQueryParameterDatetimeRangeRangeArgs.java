...
public final class SqlQueryParameterDatetimeRangeRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SqlQueryParameterDatetimeRangeRangeArgs build() {
            if ($.end == null) {
                throw new MissingRequiredPropertyException("SqlQueryParameterDatetimeRangeRangeArgs", "end");
            }
            if ($.start == null) {
                throw new MissingRequiredPropertyException("SqlQueryParameterDatetimeRangeRangeArgs", "start");
            }
            return $;
        }
    }
