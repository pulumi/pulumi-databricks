...
public final class DatabaseSyncedDatabaseTableSpecTypeOverrideArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseSyncedDatabaseTableSpecTypeOverrideArgs Empty = new DatabaseSyncedDatabaseTableSpecTypeOverrideArgs();
    ...
    private DatabaseSyncedDatabaseTableSpecTypeOverrideArgs() {}

    private DatabaseSyncedDatabaseTableSpecTypeOverrideArgs(DatabaseSyncedDatabaseTableSpecTypeOverrideArgs $) {
    ...
    public static Builder builder(DatabaseSyncedDatabaseTableSpecTypeOverrideArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseSyncedDatabaseTableSpecTypeOverrideArgs();
        }

        public Builder(DatabaseSyncedDatabaseTableSpecTypeOverrideArgs defaults) {
            $ = new DatabaseSyncedDatabaseTableSpecTypeOverrideArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseSyncedDatabaseTableSpecTypeOverrideArgs build() {
            if ($.columnName == null) {
                throw new MissingRequiredPropertyException("DatabaseSyncedDatabaseTableSpecTypeOverrideArgs", "columnName");
            }
            if ($.pgType == null) {
                throw new MissingRequiredPropertyException("DatabaseSyncedDatabaseTableSpecTypeOverrideArgs", "pgType");
            }
            return $;
        }
    }
