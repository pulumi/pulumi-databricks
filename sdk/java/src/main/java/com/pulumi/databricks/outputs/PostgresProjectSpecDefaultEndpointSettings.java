...
public final class PostgresProjectSpecDefaultEndpointSettings {
    ...
    public static Builder builder(PostgresProjectSpecDefaultEndpointSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suspendTimeoutDuration;
        public Builder() {}
        public Builder(PostgresProjectSpecDefaultEndpointSettings defaults) {
        ...
        public PostgresProjectSpecDefaultEndpointSettings build() {
