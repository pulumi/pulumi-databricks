...
public final class GetAiGatewayModelProviderServicesModelProviderServiceConfigMicrosoftFoundryDirectApiKey {
    ...
    public static Builder builder(GetAiGatewayModelProviderServicesModelProviderServiceConfigMicrosoftFoundryDirectApiKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder plaintext(String plaintext) {
            if (plaintext == null) {
              throw new MissingRequiredPropertyException("GetAiGatewayModelProviderServicesModelProviderServiceConfigMicrosoftFoundryDirectApiKey", "plaintext");
            }
