...
public final class GetJobJobSettingsSettingsTaskNewClusterAwsAttributes extends com.pulumi.resources.InvokeArgs {

    public static final GetJobJobSettingsSettingsTaskNewClusterAwsAttributes Empty = new GetJobJobSettingsSettingsTaskNewClusterAwsAttributes();
    ...
    private GetJobJobSettingsSettingsTaskNewClusterAwsAttributes() {}

    private GetJobJobSettingsSettingsTaskNewClusterAwsAttributes(GetJobJobSettingsSettingsTaskNewClusterAwsAttributes $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsTaskNewClusterAwsAttributes defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskNewClusterAwsAttributes();
        }

        public Builder(GetJobJobSettingsSettingsTaskNewClusterAwsAttributes defaults) {
            $ = new GetJobJobSettingsSettingsTaskNewClusterAwsAttributes(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsTaskNewClusterAwsAttributes build() {
            return $;
        }
    }
