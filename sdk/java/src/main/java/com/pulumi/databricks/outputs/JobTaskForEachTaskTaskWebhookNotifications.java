...
@CustomType
public final class JobTaskForEachTaskTaskWebhookNotifications {
    /**
     ...
     * 
     */
    public List<JobTaskForEachTaskTaskWebhookNotificationsOnDurationWarningThresholdExceeded> onDurationWarningThresholdExceededs() {
     ...
     * 
     */
    public List<JobTaskForEachTaskTaskWebhookNotificationsOnSuccess> onSuccesses() {
    ...
    public static Builder builder(JobTaskForEachTaskTaskWebhookNotifications defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder onDurationWarningThresholdExceededs(@Nullable List<JobTaskForEachTaskTaskWebhookNotificationsOnDurationWarningThresholdExceeded> onDurationWarningThresholdExceededs) {

            this.onDurationWarningThresholdExceededs = onDurationWarningThresholdExceededs;
            return this;
        }
        public Builder onDurationWarningThresholdExceededs(JobTaskForEachTaskTaskWebhookNotificationsOnDurationWarningThresholdExceeded... onDurationWarningThresholdExceededs) {
            return onDurationWarningThresholdExceededs(List.of(onDurationWarningThresholdExceededs));
        }
        @CustomType.Setter
        public Builder onFailures(@Nullable List<JobTaskForEachTaskTaskWebhookNotificationsOnFailure> onFailures) {
        ...
        public Builder onStarts(JobTaskForEachTaskTaskWebhookNotificationsOnStart... onStarts) {
        ...
        public Builder onSuccesses(JobTaskForEachTaskTaskWebhookNotificationsOnSuccess... onSuccesses) {
            return onSuccesses(List.of(onSuccesses));
        }
        public JobTaskForEachTaskTaskWebhookNotifications build() {
