...
@CustomType
public final class JobNewClusterLibraryMaven {
    ...
    public static Builder builder(JobNewClusterLibraryMaven defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(JobNewClusterLibraryMaven defaults) {
        ...
        public Builder coordinates(String coordinates) {
            if (coordinates == null) {
              throw new MissingRequiredPropertyException("JobNewClusterLibraryMaven", "coordinates");
            }
        ...
        public JobNewClusterLibraryMaven build() {
            final var _resultValue = new JobNewClusterLibraryMaven();
