...
public final class InstancePoolPreloadedDockerImageBasicAuth {
    ...
    public static final class Builder {
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("InstancePoolPreloadedDockerImageBasicAuth", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("InstancePoolPreloadedDockerImageBasicAuth", "username");
            }
