...
import com.pulumi.databricks.AppSpaceArgs;
import com.pulumi.databricks.Utilities;
import com.pulumi.databricks.inputs.AppSpaceState;
import com.pulumi.databricks.outputs.AppSpaceProviderConfig;
import com.pulumi.databricks.outputs.AppSpaceResource;
import com.pulumi.databricks.outputs.AppSpaceStatus;
...
public class AppSpace extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="resources", refs={List.class,AppSpaceResource.class}, tree="[0,1]")
    private Output</* @Nullable */ List<AppSpaceResource>> resources;

    /**
     * @return Resources for the app space. Resources configured at the space level are available to all apps in the space
     * 
     */
    public Output<Optional<List<AppSpaceResource>>> resources() {
     ...
     * 
     */
    @Export(name="status", refs={AppSpaceStatus.class}, tree="[0]")
    private Output<AppSpaceStatus> status;

    /**
     * @return (SpaceStatus) - The status of the app space
     * 
     */
    public Output<AppSpaceStatus> status() {
        return this.status;
    }
    /**
     ...
     */
    public AppSpace(java.lang.String name) {
        this(name, AppSpaceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AppSpace(java.lang.String name, @Nullable AppSpaceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AppSpace(java.lang.String name, @Nullable AppSpaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/appSpace:AppSpace", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AppSpace(java.lang.String name, Output<java.lang.String> id, @Nullable AppSpaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/appSpace:AppSpace", name, state, makeResourceOptions(options, id), false);
    }

    private static AppSpaceArgs makeArgs(@Nullable AppSpaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AppSpaceArgs.Empty : args;
    }
     ...
     */
    public static AppSpace get(java.lang.String name, Output<java.lang.String> id, @Nullable AppSpaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
