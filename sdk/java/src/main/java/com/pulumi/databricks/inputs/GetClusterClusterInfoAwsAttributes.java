...
public final class GetClusterClusterInfoAwsAttributes extends com.pulumi.resources.InvokeArgs {

    public static final GetClusterClusterInfoAwsAttributes Empty = new GetClusterClusterInfoAwsAttributes();
    ...
    private GetClusterClusterInfoAwsAttributes() {}
    ...
    public static Builder builder(GetClusterClusterInfoAwsAttributes defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClusterClusterInfoAwsAttributes();
        }

        public Builder(GetClusterClusterInfoAwsAttributes defaults) {
            $ = new GetClusterClusterInfoAwsAttributes(Objects.requireNonNull(defaults));
        }
        ...
        public GetClusterClusterInfoAwsAttributes build() {
            return $;
        }
    }
