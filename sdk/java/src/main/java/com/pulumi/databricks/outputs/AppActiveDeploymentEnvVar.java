...
@CustomType
public final class AppActiveDeploymentEnvVar {
    /**
    ...
    private AppActiveDeploymentEnvVar() {}
    /**
     * @return The name of the app. The name must contain only lowercase alphanumeric characters and hyphens. It must be unique within the workspace.
     * 
     */
    ...
    public static Builder builder(AppActiveDeploymentEnvVar defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String valueFrom;
        public Builder() {}
        public Builder(AppActiveDeploymentEnvVar defaults) {
        ...
        public AppActiveDeploymentEnvVar build() {
            final var _resultValue = new AppActiveDeploymentEnvVar();
