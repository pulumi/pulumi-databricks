...
public final class AppDefaultGitSourceGitRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppDefaultGitSourceGitRepositoryArgs Empty = new AppDefaultGitSourceGitRepositoryArgs();
    ...
    private AppDefaultGitSourceGitRepositoryArgs() {}

    private AppDefaultGitSourceGitRepositoryArgs(AppDefaultGitSourceGitRepositoryArgs $) {
    ...
    public static Builder builder(AppDefaultGitSourceGitRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppDefaultGitSourceGitRepositoryArgs();
        }

        public Builder(AppDefaultGitSourceGitRepositoryArgs defaults) {
            $ = new AppDefaultGitSourceGitRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppDefaultGitSourceGitRepositoryArgs build() {
            if ($.provider == null) {
                throw new MissingRequiredPropertyException("AppDefaultGitSourceGitRepositoryArgs", "provider");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("AppDefaultGitSourceGitRepositoryArgs", "url");
            }
            return $;
        }
    }
