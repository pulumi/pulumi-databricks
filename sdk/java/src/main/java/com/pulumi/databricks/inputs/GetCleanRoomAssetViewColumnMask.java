...
public final class GetCleanRoomAssetViewColumnMask extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetViewColumnMask Empty = new GetCleanRoomAssetViewColumnMask();
    ...
    private GetCleanRoomAssetViewColumnMask() {}

    private GetCleanRoomAssetViewColumnMask(GetCleanRoomAssetViewColumnMask $) {
    ...
    public static Builder builder(GetCleanRoomAssetViewColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetViewColumnMask();
        }

        public Builder(GetCleanRoomAssetViewColumnMask defaults) {
            $ = new GetCleanRoomAssetViewColumnMask(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetViewColumnMask build() {
            return $;
        }
    }
