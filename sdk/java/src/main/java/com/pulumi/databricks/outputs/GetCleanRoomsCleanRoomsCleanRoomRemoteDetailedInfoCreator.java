...
@CustomType
public final class GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator {
    /**
    ...
    private GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator() {}
    /**
     * @return (string) - Collaborator alias specified by the clean room creator. It is unique across all collaborators of this clean room, and used to derive
     * multiple values internally such as catalog alias and clean room name for single metastore clean rooms.
     * It should follow [UC securable naming requirements](https://docs.databricks.com/en/data-governance/unity-catalog/index.html#securable-object-naming-requirements)
    ...
    public static Builder builder(GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator defaults) {
    ...
    public static final class Builder {
        ...
        private String organizationName;
        public Builder() {}
        public Builder(GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator defaults) {
        ...
        public Builder collaboratorAlias(String collaboratorAlias) {
            if (collaboratorAlias == null) {
              throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator", "collaboratorAlias");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator", "displayName");
            }
        ...
        public Builder inviteRecipientWorkspaceId(Integer inviteRecipientWorkspaceId) {
            if (inviteRecipientWorkspaceId == null) {
              throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator", "inviteRecipientWorkspaceId");
            }
        ...
        public Builder organizationName(String organizationName) {
            if (organizationName == null) {
              throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator", "organizationName");
            }
            this.organizationName = organizationName;
            return this;
        }
        public GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator build() {
            final var _resultValue = new GetCleanRoomsCleanRoomsCleanRoomRemoteDetailedInfoCreator();
