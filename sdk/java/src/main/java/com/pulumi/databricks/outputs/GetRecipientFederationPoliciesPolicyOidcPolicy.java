...
@CustomType
public final class GetRecipientFederationPoliciesPolicyOidcPolicy {
    /**
    ...
    private GetRecipientFederationPoliciesPolicyOidcPolicy() {}
    /**
     * @return (list of string) - The allowed token audiences, as specified in the &#39;aud&#39; claim of federated tokens.
     * The audience identifier is intended to represent the recipient of the token.
     * Can be any non-empty string value. As long as the audience in the token matches at least one audience in the policy,
    ...
    public static Builder builder(GetRecipientFederationPoliciesPolicyOidcPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private String subjectClaim;
        public Builder() {}
        public Builder(GetRecipientFederationPoliciesPolicyOidcPolicy defaults) {
        ...
        public Builder issuer(String issuer) {
            if (issuer == null) {
              throw new MissingRequiredPropertyException("GetRecipientFederationPoliciesPolicyOidcPolicy", "issuer");
            }
            this.issuer = issuer;
            return this;
        }
        ...
        public Builder subject(String subject) {
            if (subject == null) {
              throw new MissingRequiredPropertyException("GetRecipientFederationPoliciesPolicyOidcPolicy", "subject");
            }
        ...
        public Builder subjectClaim(String subjectClaim) {
            if (subjectClaim == null) {
              throw new MissingRequiredPropertyException("GetRecipientFederationPoliciesPolicyOidcPolicy", "subjectClaim");
            }
            this.subjectClaim = subjectClaim;
            return this;
        }
        public GetRecipientFederationPoliciesPolicyOidcPolicy build() {
            final var _resultValue = new GetRecipientFederationPoliciesPolicyOidcPolicy();
