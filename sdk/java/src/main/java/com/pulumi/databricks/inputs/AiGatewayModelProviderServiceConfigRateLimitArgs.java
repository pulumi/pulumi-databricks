...
public final class AiGatewayModelProviderServiceConfigRateLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final AiGatewayModelProviderServiceConfigRateLimitArgs Empty = new AiGatewayModelProviderServiceConfigRateLimitArgs();
    ...
    private AiGatewayModelProviderServiceConfigRateLimitArgs() {}

    private AiGatewayModelProviderServiceConfigRateLimitArgs(AiGatewayModelProviderServiceConfigRateLimitArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AiGatewayModelProviderServiceConfigRateLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AiGatewayModelProviderServiceConfigRateLimitArgs();
        }

        public Builder(AiGatewayModelProviderServiceConfigRateLimitArgs defaults) {
            $ = new AiGatewayModelProviderServiceConfigRateLimitArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AiGatewayModelProviderServiceConfigRateLimitArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("AiGatewayModelProviderServiceConfigRateLimitArgs", "key");
            }
            if ($.renewalPeriod == null) {
                throw new MissingRequiredPropertyException("AiGatewayModelProviderServiceConfigRateLimitArgs", "renewalPeriod");
            }
            return $;
        }
    }
