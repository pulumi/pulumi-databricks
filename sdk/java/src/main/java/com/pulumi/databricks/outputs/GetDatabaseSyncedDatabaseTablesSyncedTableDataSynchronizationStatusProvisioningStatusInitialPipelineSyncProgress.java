...
@CustomType
public final class GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress {
    /**
    ...
    private GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress() {}
    /**
     * @return (number) - The estimated time remaining to complete this update in seconds
     * 
     */
    ...
    public static Builder builder(GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress defaults) {
    ...
    public static final class Builder {
        ...
        private Integer totalRowCount;
        public Builder() {}
        public Builder(GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress defaults) {
        ...
        public Builder estimatedCompletionTimeSeconds(Double estimatedCompletionTimeSeconds) {
            if (estimatedCompletionTimeSeconds == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress", "estimatedCompletionTimeSeconds");
            }
        ...
        public Builder latestVersionCurrentlyProcessing(Integer latestVersionCurrentlyProcessing) {
            if (latestVersionCurrentlyProcessing == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress", "latestVersionCurrentlyProcessing");
            }
        ...
        public Builder provisioningPhase(String provisioningPhase) {
            if (provisioningPhase == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress", "provisioningPhase");
            }
        ...
        public Builder syncProgressCompletion(Double syncProgressCompletion) {
            if (syncProgressCompletion == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress", "syncProgressCompletion");
            }
        ...
        public Builder syncedRowCount(Integer syncedRowCount) {
            if (syncedRowCount == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress", "syncedRowCount");
            }
        ...
        public Builder totalRowCount(Integer totalRowCount) {
            if (totalRowCount == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress", "totalRowCount");
            }
            this.totalRowCount = totalRowCount;
            return this;
        }
        public GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress build() {
            final var _resultValue = new GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusProvisioningStatusInitialPipelineSyncProgress();
