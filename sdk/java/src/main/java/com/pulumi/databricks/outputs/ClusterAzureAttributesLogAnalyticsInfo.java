...
@CustomType
public final class ClusterAzureAttributesLogAnalyticsInfo {
    private @Nullable String logAnalyticsPrimaryKey;
    private @Nullable String logAnalyticsWorkspaceId;

    private ClusterAzureAttributesLogAnalyticsInfo() {}
    ...
    public static Builder builder(ClusterAzureAttributesLogAnalyticsInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String logAnalyticsWorkspaceId;
        public Builder() {}
        public Builder(ClusterAzureAttributesLogAnalyticsInfo defaults) {
        ...
        public ClusterAzureAttributesLogAnalyticsInfo build() {
            final var _resultValue = new ClusterAzureAttributesLogAnalyticsInfo();
