...
public final class GetCleanRoomsCleanRoomRemoteDetailedInfoCreator extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomsCleanRoomRemoteDetailedInfoCreator Empty = new GetCleanRoomsCleanRoomRemoteDetailedInfoCreator();
    ...
    private GetCleanRoomsCleanRoomRemoteDetailedInfoCreator() {}

    private GetCleanRoomsCleanRoomRemoteDetailedInfoCreator(GetCleanRoomsCleanRoomRemoteDetailedInfoCreator $) {
    ...
    public static Builder builder(GetCleanRoomsCleanRoomRemoteDetailedInfoCreator defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomsCleanRoomRemoteDetailedInfoCreator();
        }

        public Builder(GetCleanRoomsCleanRoomRemoteDetailedInfoCreator defaults) {
            $ = new GetCleanRoomsCleanRoomRemoteDetailedInfoCreator(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomsCleanRoomRemoteDetailedInfoCreator build() {
            if ($.collaboratorAlias == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomRemoteDetailedInfoCreator", "collaboratorAlias");
            }
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomRemoteDetailedInfoCreator", "displayName");
            }
            if ($.inviteRecipientWorkspaceId == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomRemoteDetailedInfoCreator", "inviteRecipientWorkspaceId");
            }
            if ($.organizationName == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomsCleanRoomRemoteDetailedInfoCreator", "organizationName");
            }
            return $;
        }
    }
