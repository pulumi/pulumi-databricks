...
public final class GetCleanRoomAssetForeignTableColumnMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCleanRoomAssetForeignTableColumnMaskArgs Empty = new GetCleanRoomAssetForeignTableColumnMaskArgs();
    ...
    private GetCleanRoomAssetForeignTableColumnMaskArgs() {}

    private GetCleanRoomAssetForeignTableColumnMaskArgs(GetCleanRoomAssetForeignTableColumnMaskArgs $) {
    ...
    public static Builder builder(GetCleanRoomAssetForeignTableColumnMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetForeignTableColumnMaskArgs();
        }

        public Builder(GetCleanRoomAssetForeignTableColumnMaskArgs defaults) {
            $ = new GetCleanRoomAssetForeignTableColumnMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetForeignTableColumnMaskArgs build() {
            return $;
        }
    }
