...
@CustomType
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskSparkSubmitTask {
    ...
    public static final class Builder {
        ...
        public GetJobJobSettingsSettingsTaskForEachTaskTaskSparkSubmitTask build() {
            final var _resultValue = new GetJobJobSettingsSettingsTaskForEachTaskTaskSparkSubmitTask();
