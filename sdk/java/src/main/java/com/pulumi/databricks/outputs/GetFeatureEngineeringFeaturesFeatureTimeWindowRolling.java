...
public final class GetFeatureEngineeringFeaturesFeatureTimeWindowRolling {
    ...
    public static Builder builder(GetFeatureEngineeringFeaturesFeatureTimeWindowRolling defaults) {
    ...
    public static final class Builder {
        ...
        public GetFeatureEngineeringFeaturesFeatureTimeWindowRolling build() {
            final var _resultValue = new GetFeatureEngineeringFeaturesFeatureTimeWindowRolling();
