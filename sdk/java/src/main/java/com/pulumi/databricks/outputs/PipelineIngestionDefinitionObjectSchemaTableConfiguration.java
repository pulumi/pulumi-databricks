...
import com.pulumi.databricks.outputs.PipelineIngestionDefinitionObjectSchemaTableConfigurationAutoFullRefreshPolicy;
import com.pulumi.databricks.outputs.PipelineIngestionDefinitionObjectSchemaTableConfigurationQueryBasedConnectorConfig;
import com.pulumi.databricks.outputs.PipelineIngestionDefinitionObjectSchemaTableConfigurationWorkdayReportParameters;
...
public final class PipelineIngestionDefinitionObjectSchemaTableConfiguration {
    private @Nullable PipelineIngestionDefinitionObjectSchemaTableConfigurationAutoFullRefreshPolicy autoFullRefreshPolicy;
    ...
    private @Nullable PipelineIngestionDefinitionObjectSchemaTableConfigurationQueryBasedConnectorConfig queryBasedConnectorConfig;
    ...
    public Optional<PipelineIngestionDefinitionObjectSchemaTableConfigurationAutoFullRefreshPolicy> autoFullRefreshPolicy() {
    ...
    public Optional<PipelineIngestionDefinitionObjectSchemaTableConfigurationQueryBasedConnectorConfig> queryBasedConnectorConfig() {
    ...
    public Optional<PipelineIngestionDefinitionObjectSchemaTableConfigurationWorkdayReportParameters> workdayReportParameters() {
    ...
    public static Builder builder(PipelineIngestionDefinitionObjectSchemaTableConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder autoFullRefreshPolicy(@Nullable PipelineIngestionDefinitionObjectSchemaTableConfigurationAutoFullRefreshPolicy autoFullRefreshPolicy) {
        ...
        @CustomType.Setter
        public Builder queryBasedConnectorConfig(@Nullable PipelineIngestionDefinitionObjectSchemaTableConfigurationQueryBasedConnectorConfig queryBasedConnectorConfig) {
        ...
        @CustomType.Setter
        public Builder workdayReportParameters(@Nullable PipelineIngestionDefinitionObjectSchemaTableConfigurationWorkdayReportParameters workdayReportParameters) {
