...
public class GroupInstanceProfile extends com.pulumi.resources.CustomResource {
     ...
     */
    public GroupInstanceProfile(String name) {
     ...
     */
    public GroupInstanceProfile(String name, GroupInstanceProfileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/groupInstanceProfile:GroupInstanceProfile", name, args == null ? GroupInstanceProfileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GroupInstanceProfile(String name, Output<String> id, @Nullable GroupInstanceProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/groupInstanceProfile:GroupInstanceProfile", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static GroupInstanceProfile get(String name, Output<String> id, @Nullable GroupInstanceProfileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
