...
@CustomType
public final class GetPostgresProjectSpecDefaultEndpointSettings {
    /**
    ...
    private GetPostgresProjectSpecDefaultEndpointSettings() {}
    /**
     * @return (number) - The maximum number of Compute Units
     * 
     */
    ...
    public static Builder builder(GetPostgresProjectSpecDefaultEndpointSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suspendTimeoutDuration;
        public Builder() {}
        public Builder(GetPostgresProjectSpecDefaultEndpointSettings defaults) {
        ...
        public GetPostgresProjectSpecDefaultEndpointSettings build() {
            final var _resultValue = new GetPostgresProjectSpecDefaultEndpointSettings();
