...
import com.pulumi.databricks.outputs.GetAppAppGitSourceGitRepository;
...
@CustomType
public final class GetAppAppGitSource {
    /**
     ...
     * 
     */
    private GetAppAppGitSourceGitRepository gitRepository;
     ...
     * 
     */
    public GetAppAppGitSourceGitRepository gitRepository() {
    ...
    public static Builder builder(GetAppAppGitSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tag;
        public Builder() {}
        public Builder(GetAppAppGitSource defaults) {
        ...
        @CustomType.Setter
        public Builder gitRepository(GetAppAppGitSourceGitRepository gitRepository) {
            if (gitRepository == null) {
              throw new MissingRequiredPropertyException("GetAppAppGitSource", "gitRepository");
            }
        ...
        public Builder resolvedCommit(String resolvedCommit) {
            if (resolvedCommit == null) {
              throw new MissingRequiredPropertyException("GetAppAppGitSource", "resolvedCommit");
            }
        ...
        public GetAppAppGitSource build() {
            final var _resultValue = new GetAppAppGitSource();
