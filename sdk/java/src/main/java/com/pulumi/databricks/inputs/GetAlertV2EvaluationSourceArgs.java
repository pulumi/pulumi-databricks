...
public final class GetAlertV2EvaluationSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAlertV2EvaluationSourceArgs Empty = new GetAlertV2EvaluationSourceArgs();
    ...
    private GetAlertV2EvaluationSourceArgs() {}

    private GetAlertV2EvaluationSourceArgs(GetAlertV2EvaluationSourceArgs $) {
    ...
    public static Builder builder(GetAlertV2EvaluationSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAlertV2EvaluationSourceArgs();
        }

        public Builder(GetAlertV2EvaluationSourceArgs defaults) {
            $ = new GetAlertV2EvaluationSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAlertV2EvaluationSourceArgs build() {
            return $;
        }
    }
