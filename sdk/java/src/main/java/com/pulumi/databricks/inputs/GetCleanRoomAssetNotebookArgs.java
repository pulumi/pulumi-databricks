...
import com.pulumi.databricks.inputs.GetCleanRoomAssetNotebookReviewArgs;
...
public final class GetCleanRoomAssetNotebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCleanRoomAssetNotebookArgs Empty = new GetCleanRoomAssetNotebookArgs();
    ...
    private Output<List<GetCleanRoomAssetNotebookReviewArgs>> reviews;

    /**
     * @return (list of CleanRoomNotebookReview) - All existing approvals or rejections
     * 
     */
    public Output<List<GetCleanRoomAssetNotebookReviewArgs>> reviews() {
        return this.reviews;
    }
    ...
    private GetCleanRoomAssetNotebookArgs() {}

    private GetCleanRoomAssetNotebookArgs(GetCleanRoomAssetNotebookArgs $) {
        this.etag = $.etag;
    ...
    public static Builder builder(GetCleanRoomAssetNotebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetNotebookArgs();
        }

        public Builder(GetCleanRoomAssetNotebookArgs defaults) {
            $ = new GetCleanRoomAssetNotebookArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder reviews(Output<List<GetCleanRoomAssetNotebookReviewArgs>> reviews) {
            $.reviews = reviews;
            return this;
        }
         ...
         * 
         */
        public Builder reviews(List<GetCleanRoomAssetNotebookReviewArgs> reviews) {
         ...
         * 
         */
        public Builder reviews(GetCleanRoomAssetNotebookReviewArgs... reviews) {
        ...
        public GetCleanRoomAssetNotebookArgs build() {
            if ($.etag == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomAssetNotebookArgs", "etag");
            }
            if ($.notebookContent == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomAssetNotebookArgs", "notebookContent");
            }
            if ($.reviewState == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomAssetNotebookArgs", "reviewState");
            }
            if ($.reviews == null) {
                throw new MissingRequiredPropertyException("GetCleanRoomAssetNotebookArgs", "reviews");
            }
            return $;
        }
    }
