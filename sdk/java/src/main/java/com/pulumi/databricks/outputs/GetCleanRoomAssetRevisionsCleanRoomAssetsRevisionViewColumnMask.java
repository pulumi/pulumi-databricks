...
@CustomType
public final class GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionViewColumnMask {
    /**
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionViewColumnMask() {}
    /**
     * @return (string) - The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionViewColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionViewColumnMask defaults) {
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionViewColumnMask build() {
            final var _resultValue = new GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionViewColumnMask();
