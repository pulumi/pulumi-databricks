...
@CustomType
public final class GetAppAppGitRepository {
    ...
    private GetAppAppGitRepository() {}
    ...
    public static Builder builder(GetAppAppGitRepository defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(GetAppAppGitRepository defaults) {
        ...
        public Builder callerCredentialId(Integer callerCredentialId) {
            if (callerCredentialId == null) {
              throw new MissingRequiredPropertyException("GetAppAppGitRepository", "callerCredentialId");
            }
        ...
        public Builder provider(String provider) {
            if (provider == null) {
              throw new MissingRequiredPropertyException("GetAppAppGitRepository", "provider");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetAppAppGitRepository", "url");
            }
            this.url = url;
            return this;
        }
        public GetAppAppGitRepository build() {
            final var _resultValue = new GetAppAppGitRepository();
