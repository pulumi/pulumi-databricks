...
@CustomType
public final class ExternalLocationEffectiveFileEventQueueProvidedSqs {
    private @Nullable String managedResourceId;
    private @Nullable String queueUrl;

    private ExternalLocationEffectiveFileEventQueueProvidedSqs() {}
    ...
    public static Builder builder(ExternalLocationEffectiveFileEventQueueProvidedSqs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String queueUrl;
        public Builder() {}
        public Builder(ExternalLocationEffectiveFileEventQueueProvidedSqs defaults) {
        ...
        public ExternalLocationEffectiveFileEventQueueProvidedSqs build() {
            final var _resultValue = new ExternalLocationEffectiveFileEventQueueProvidedSqs();
