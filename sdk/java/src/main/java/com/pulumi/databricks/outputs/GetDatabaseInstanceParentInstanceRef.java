...
@CustomType
public final class GetDatabaseInstanceParentInstanceRef {
    /**
    ...
    public static final class Builder {
        ...
        public Builder lsn(String lsn) {
            if (lsn == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceParentInstanceRef", "lsn");
            }
            this.lsn = lsn;
            return this;
        }
        ...
        public GetDatabaseInstanceParentInstanceRef build() {
            final var _resultValue = new GetDatabaseInstanceParentInstanceRef();
