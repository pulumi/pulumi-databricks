...
public final class AccountSettingV2EffectiveRestrictWorkspaceAdminsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(AccountSettingV2EffectiveRestrictWorkspaceAdminsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountSettingV2EffectiveRestrictWorkspaceAdminsArgs();
        }
        ...
        public AccountSettingV2EffectiveRestrictWorkspaceAdminsArgs build() {
            if ($.status == null) {
                throw new MissingRequiredPropertyException("AccountSettingV2EffectiveRestrictWorkspaceAdminsArgs", "status");
            }
            return $;
        }
    }
