...
public final class MwsPrivateAccessSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return (Boolean, Optional, `false` by default on AWS, `true` by default on GCP) - If `true`, the databricks.MwsWorkspaces can be accessed over the databricks.MwsVpcEndpoint as well as over the public network. In such a case, you could also configure an databricks.IpAccessList for the workspace, to restrict the source networks that could be used to access it over the public network. If `false`, the workspace can be accessed only over VPC endpoints, and not over the public network.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param publicAccessEnabled (Boolean, Optional, `false` by default on AWS, `true` by default on GCP) - If `true`, the databricks.MwsWorkspaces can be accessed over the databricks.MwsVpcEndpoint as well as over the public network. In such a case, you could also configure an databricks.IpAccessList for the workspace, to restrict the source networks that could be used to access it over the public network. If `false`, the workspace can be accessed only over VPC endpoints, and not over the public network.
         * 
         * @return builder
         * 
         */
        ...
        public MwsPrivateAccessSettingsArgs build() {
            $.privateAccessSettingsName = Objects.requireNonNull($.privateAccessSettingsName, "expected parameter 'privateAccessSettingsName' to be non-null");
