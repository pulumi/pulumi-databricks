...
@CustomType
public final class ExternalLocationEffectiveFileEventQueueManagedSqs {
    private @Nullable String managedResourceId;
    private @Nullable String queueUrl;

    private ExternalLocationEffectiveFileEventQueueManagedSqs() {}
    ...
    public static Builder builder(ExternalLocationEffectiveFileEventQueueManagedSqs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String queueUrl;
        public Builder() {}
        public Builder(ExternalLocationEffectiveFileEventQueueManagedSqs defaults) {
        ...
        public ExternalLocationEffectiveFileEventQueueManagedSqs build() {
            final var _resultValue = new ExternalLocationEffectiveFileEventQueueManagedSqs();
