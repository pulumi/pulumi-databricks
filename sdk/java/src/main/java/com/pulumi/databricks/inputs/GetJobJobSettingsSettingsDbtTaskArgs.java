...
public final class GetJobJobSettingsSettingsDbtTaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsDbtTaskArgs Empty = new GetJobJobSettingsSettingsDbtTaskArgs();
    ...
    private GetJobJobSettingsSettingsDbtTaskArgs() {}

    private GetJobJobSettingsSettingsDbtTaskArgs(GetJobJobSettingsSettingsDbtTaskArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsDbtTaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsDbtTaskArgs();
        }

        public Builder(GetJobJobSettingsSettingsDbtTaskArgs defaults) {
            $ = new GetJobJobSettingsSettingsDbtTaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsDbtTaskArgs build() {
            if ($.commands == null) {
                throw new MissingRequiredPropertyException("GetJobJobSettingsSettingsDbtTaskArgs", "commands");
            }
            return $;
        }
    }
