...
public final class GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes extends com.pulumi.resources.InvokeArgs {

    public static final GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes Empty = new GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes();
    ...
    private GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes() {}

    private GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes(GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes();
        }

        public Builder(GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes defaults) {
            $ = new GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributes build() {
            return $;
        }
    }
