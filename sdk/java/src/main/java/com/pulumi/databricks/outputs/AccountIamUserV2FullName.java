...
@CustomType
public final class AccountIamUserV2FullName {
    private @Nullable String familyName;
    private @Nullable String givenName;

    private AccountIamUserV2FullName() {}
    ...
    public static Builder builder(AccountIamUserV2FullName defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String givenName;
        public Builder() {}
        public Builder(AccountIamUserV2FullName defaults) {
        ...
        public AccountIamUserV2FullName build() {
            final var _resultValue = new AccountIamUserV2FullName();
