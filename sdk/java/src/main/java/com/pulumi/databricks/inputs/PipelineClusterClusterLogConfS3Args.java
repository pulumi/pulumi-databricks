...
public final class PipelineClusterClusterLogConfS3Args extends com.pulumi.resources.ResourceArgs {

    public static final PipelineClusterClusterLogConfS3Args Empty = new PipelineClusterClusterLogConfS3Args();
    ...
    private PipelineClusterClusterLogConfS3Args() {}

    private PipelineClusterClusterLogConfS3Args(PipelineClusterClusterLogConfS3Args $) {
    ...
    public static Builder builder(PipelineClusterClusterLogConfS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineClusterClusterLogConfS3Args();
        }

        public Builder(PipelineClusterClusterLogConfS3Args defaults) {
            $ = new PipelineClusterClusterLogConfS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineClusterClusterLogConfS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("PipelineClusterClusterLogConfS3Args", "destination");
            }
            return $;
        }
    }
