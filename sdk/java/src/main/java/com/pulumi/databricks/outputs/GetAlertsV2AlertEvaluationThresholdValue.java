...
@CustomType
public final class GetAlertsV2AlertEvaluationThresholdValue {
    /**
     * @return (boolean)
     * 
     */
    ...
    private GetAlertsV2AlertEvaluationThresholdValue() {}
    /**
     * @return (boolean)
     * 
     */
    ...
    public static Builder builder(GetAlertsV2AlertEvaluationThresholdValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String stringValue;
        public Builder() {}
        public Builder(GetAlertsV2AlertEvaluationThresholdValue defaults) {
        ...
        public GetAlertsV2AlertEvaluationThresholdValue build() {
            final var _resultValue = new GetAlertsV2AlertEvaluationThresholdValue();
