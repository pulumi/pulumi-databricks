...
import com.pulumi.databricks.outputs.PostgresRoleSpecAttributes;
...
@CustomType
public final class PostgresRoleSpec {
    private @Nullable PostgresRoleSpecAttributes attributes;
    ...
    public Optional<PostgresRoleSpecAttributes> attributes() {
    ...
    public static Builder builder(PostgresRoleSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String postgresRole;
        public Builder() {}
        public Builder(PostgresRoleSpec defaults) {
        ...
        @CustomType.Setter
        public Builder attributes(@Nullable PostgresRoleSpecAttributes attributes) {
        ...
        public PostgresRoleSpec build() {
            final var _resultValue = new PostgresRoleSpec();
