...
public final class QueryParameterEnumValueMultiValuesOptions {
    ...
    public static Builder builder(QueryParameterEnumValueMultiValuesOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(QueryParameterEnumValueMultiValuesOptions defaults) {
        ...
        public QueryParameterEnumValueMultiValuesOptions build() {
            final var _resultValue = new QueryParameterEnumValueMultiValuesOptions();
