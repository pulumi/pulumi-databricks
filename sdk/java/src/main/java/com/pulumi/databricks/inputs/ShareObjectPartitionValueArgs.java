...
public final class ShareObjectPartitionValueArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ShareObjectPartitionValueArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ShareObjectPartitionValueArgs", "name");
            }
            if ($.op == null) {
                throw new MissingRequiredPropertyException("ShareObjectPartitionValueArgs", "op");
            }
            return $;
        }
    }
