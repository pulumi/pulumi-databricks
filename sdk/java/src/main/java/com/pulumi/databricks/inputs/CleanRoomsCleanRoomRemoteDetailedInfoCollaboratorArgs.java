...
public final class CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs extends com.pulumi.resources.ResourceArgs {

    public static final CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs Empty = new CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs();
    ...
    private CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs() {}

    private CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs(CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs $) {
    ...
    public static Builder builder(CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs();
        }

        public Builder(CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs defaults) {
            $ = new CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs build() {
            if ($.collaboratorAlias == null) {
                throw new MissingRequiredPropertyException("CleanRoomsCleanRoomRemoteDetailedInfoCollaboratorArgs", "collaboratorAlias");
            }
            return $;
        }
    }
