...
@CustomType
public final class AiSearchIndexDirectAccessIndexSpecEmbeddingVectorColumn {
    /**
    ...
    private AiSearchIndexDirectAccessIndexSpecEmbeddingVectorColumn() {}
    /**
     * @return Dimension of the embedding vector
     * 
     */
    ...
    public static Builder builder(AiSearchIndexDirectAccessIndexSpecEmbeddingVectorColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(AiSearchIndexDirectAccessIndexSpecEmbeddingVectorColumn defaults) {
        ...
        public AiSearchIndexDirectAccessIndexSpecEmbeddingVectorColumn build() {
            final var _resultValue = new AiSearchIndexDirectAccessIndexSpecEmbeddingVectorColumn();
