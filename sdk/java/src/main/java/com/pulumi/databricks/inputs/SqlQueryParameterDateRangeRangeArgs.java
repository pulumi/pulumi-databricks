...
public final class SqlQueryParameterDateRangeRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SqlQueryParameterDateRangeRangeArgs build() {
            if ($.end == null) {
                throw new MissingRequiredPropertyException("SqlQueryParameterDateRangeRangeArgs", "end");
            }
            if ($.start == null) {
                throw new MissingRequiredPropertyException("SqlQueryParameterDateRangeRangeArgs", "start");
            }
            return $;
        }
    }
