...
@CustomType
public final class AppDefaultGitSourceGitRepository {
    ...
    private AppDefaultGitSourceGitRepository() {}
    ...
    public static Builder builder(AppDefaultGitSourceGitRepository defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(AppDefaultGitSourceGitRepository defaults) {
        ...
        public Builder provider(String provider) {
            if (provider == null) {
              throw new MissingRequiredPropertyException("AppDefaultGitSourceGitRepository", "provider");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("AppDefaultGitSourceGitRepository", "url");
            }
            this.url = url;
            return this;
        }
        public AppDefaultGitSourceGitRepository build() {
            final var _resultValue = new AppDefaultGitSourceGitRepository();
