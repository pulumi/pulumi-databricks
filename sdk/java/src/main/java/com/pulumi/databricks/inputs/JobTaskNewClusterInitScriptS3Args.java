...
public final class JobTaskNewClusterInitScriptS3Args extends com.pulumi.resources.ResourceArgs {

    public static final JobTaskNewClusterInitScriptS3Args Empty = new JobTaskNewClusterInitScriptS3Args();
    ...
    private JobTaskNewClusterInitScriptS3Args() {}

    private JobTaskNewClusterInitScriptS3Args(JobTaskNewClusterInitScriptS3Args $) {
    ...
    public static Builder builder(JobTaskNewClusterInitScriptS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskNewClusterInitScriptS3Args();
        }

        public Builder(JobTaskNewClusterInitScriptS3Args defaults) {
            $ = new JobTaskNewClusterInitScriptS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskNewClusterInitScriptS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("JobTaskNewClusterInitScriptS3Args", "destination");
            }
            return $;
        }
    }
