...
import com.pulumi.databricks.inputs.GetTablesProviderConfigArgs;
...
public final class GetTablesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private @Nullable Output<GetTablesProviderConfigArgs> providerConfig;

    /**
     * @return Configure the provider for management through account provider. This block consists of the following fields:
     * 
     */
    public Optional<Output<GetTablesProviderConfigArgs>> providerConfig() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder providerConfig(@Nullable Output<GetTablesProviderConfigArgs> providerConfig) {
         ...
         * 
         */
        public Builder providerConfig(GetTablesProviderConfigArgs providerConfig) {
