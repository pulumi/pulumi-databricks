...
public class QualityMonitor extends com.pulumi.resources.CustomResource {
     ...
     */
    public QualityMonitor(String name, QualityMonitorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/qualityMonitor:QualityMonitor", name, args == null ? QualityMonitorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private QualityMonitor(String name, Output<String> id, @Nullable QualityMonitorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/qualityMonitor:QualityMonitor", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static QualityMonitor get(String name, Output<String> id, @Nullable QualityMonitorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
