...
@CustomType
public final class JobTaskForEachTaskTaskNewClusterAutoscale {
    ...
    public static Builder builder(JobTaskForEachTaskTaskNewClusterAutoscale defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minWorkers;
        public Builder() {}
        public Builder(JobTaskForEachTaskTaskNewClusterAutoscale defaults) {
        ...
        public JobTaskForEachTaskTaskNewClusterAutoscale build() {
            final var _resultValue = new JobTaskForEachTaskTaskNewClusterAutoscale();
