...
public final class AccountNetworkPolicyIngressPublicAccessAllowRuleDestinationWorkspaceApiArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(AccountNetworkPolicyIngressPublicAccessAllowRuleDestinationWorkspaceApiArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountNetworkPolicyIngressPublicAccessAllowRuleDestinationWorkspaceApiArgs();
        }
        ...
        public AccountNetworkPolicyIngressPublicAccessAllowRuleDestinationWorkspaceApiArgs build() {
            return $;
        }
    }
