...
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterAutoscale;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterAwsAttributes;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterAzureAttributes;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterClusterLogConf;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterClusterMountInfo;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterDockerImage;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributes;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterInitScript;
import com.pulumi.databricks.inputs.GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterWorkloadType;
...
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster extends com.pulumi.resources.InvokeArgs {

    public static final GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster Empty = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster();
    ...
    public Optional<List<GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterClusterMountInfo>> clusterMountInfos() {
    ...
    public Optional<List<GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterInitScript>> initScripts() {
    ...
    private GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster(GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster();
        }

        public Builder(GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster defaults) {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewCluster(Objects.requireNonNull(defaults));
        }
