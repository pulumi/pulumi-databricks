...
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs Empty = new GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs();
    ...
    private GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs() {}

    private GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs(GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs();
        }

        public Builder(GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs defaults) {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsTaskForEachTaskTaskPowerBiTaskPowerBiModelArgs build() {
            return $;
        }
    }
