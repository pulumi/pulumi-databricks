...
@CustomType
public final class GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionForeignTableColumnMask {
    /**
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionForeignTableColumnMask() {}
    /**
     * @return (string) - The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionForeignTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionForeignTableColumnMask defaults) {
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionForeignTableColumnMask build() {
            final var _resultValue = new GetCleanRoomAssetRevisionsCleanRoomAssetsRevisionForeignTableColumnMask();
