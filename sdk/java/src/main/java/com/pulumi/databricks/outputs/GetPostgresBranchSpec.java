...
@CustomType
public final class GetPostgresBranchSpec {
    /**
    ...
    public static Builder builder(GetPostgresBranchSpec defaults) {
    ...
    public static final class Builder {
        ...
        public GetPostgresBranchSpec build() {
            final var _resultValue = new GetPostgresBranchSpec();
