...
@CustomType
public final class JobNewClusterClusterLogConfS3 {
    ...
    private JobNewClusterClusterLogConfS3() {}
    ...
    public static Builder builder(JobNewClusterClusterLogConfS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(JobNewClusterClusterLogConfS3 defaults) {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobNewClusterClusterLogConfS3", "destination");
            }
        ...
        public JobNewClusterClusterLogConfS3 build() {
            final var _resultValue = new JobNewClusterClusterLogConfS3();
