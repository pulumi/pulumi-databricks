...
public final class JobNewCluster {
    ...
    private final @Nullable JobNewClusterAzureAttributes azureAttributes;
    private final @Nullable String clusterId;
    private final @Nullable JobNewClusterClusterLogConf clusterLogConf;
    ...
    private final @Nullable JobNewClusterDockerImage dockerImage;
    ...
    private final @Nullable JobNewClusterGcpAttributes gcpAttributes;
    private final @Nullable String idempotencyToken;
    private final @Nullable List<JobNewClusterInitScript> initScripts;
    ...
    private final @Nullable JobNewClusterWorkloadType workloadType;
    ...
    private JobNewCluster(
        ...
        @CustomType.Parameter("azureAttributes") @Nullable JobNewClusterAzureAttributes azureAttributes,
        @CustomType.Parameter("clusterId") @Nullable String clusterId,
        @CustomType.Parameter("clusterLogConf") @Nullable JobNewClusterClusterLogConf clusterLogConf,
        ...
        @CustomType.Parameter("dockerImage") @Nullable JobNewClusterDockerImage dockerImage,
        ...
        @CustomType.Parameter("gcpAttributes") @Nullable JobNewClusterGcpAttributes gcpAttributes,
        @CustomType.Parameter("idempotencyToken") @Nullable String idempotencyToken,
        @CustomType.Parameter("initScripts") @Nullable List<JobNewClusterInitScript> initScripts,
