...
@CustomType
public final class GetCleanRoomAssetsAssetForeignTableColumnMask {
    /**
    ...
    private GetCleanRoomAssetsAssetForeignTableColumnMask() {}
    /**
     * @return (string) - The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(GetCleanRoomAssetsAssetForeignTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(GetCleanRoomAssetsAssetForeignTableColumnMask defaults) {
        ...
        public GetCleanRoomAssetsAssetForeignTableColumnMask build() {
            final var _resultValue = new GetCleanRoomAssetsAssetForeignTableColumnMask();
