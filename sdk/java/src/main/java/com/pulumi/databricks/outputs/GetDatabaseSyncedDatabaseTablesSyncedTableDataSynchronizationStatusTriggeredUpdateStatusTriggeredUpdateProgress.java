...
@CustomType
public final class GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress {
    /**
    ...
    private GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress() {}
    /**
     * @return (number) - The estimated time remaining to complete this update in seconds
     * 
     */
    ...
    public static Builder builder(GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress defaults) {
    ...
    public static final class Builder {
        ...
        private Integer totalRowCount;
        public Builder() {}
        public Builder(GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress defaults) {
        ...
        public Builder estimatedCompletionTimeSeconds(Double estimatedCompletionTimeSeconds) {
            if (estimatedCompletionTimeSeconds == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress", "estimatedCompletionTimeSeconds");
            }
        ...
        public Builder latestVersionCurrentlyProcessing(Integer latestVersionCurrentlyProcessing) {
            if (latestVersionCurrentlyProcessing == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress", "latestVersionCurrentlyProcessing");
            }
        ...
        public Builder provisioningPhase(String provisioningPhase) {
            if (provisioningPhase == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress", "provisioningPhase");
            }
        ...
        public Builder syncProgressCompletion(Double syncProgressCompletion) {
            if (syncProgressCompletion == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress", "syncProgressCompletion");
            }
        ...
        public Builder syncedRowCount(Integer syncedRowCount) {
            if (syncedRowCount == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress", "syncedRowCount");
            }
        ...
        public Builder totalRowCount(Integer totalRowCount) {
            if (totalRowCount == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress", "totalRowCount");
            }
            this.totalRowCount = totalRowCount;
            return this;
        }
        public GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress build() {
            final var _resultValue = new GetDatabaseSyncedDatabaseTablesSyncedTableDataSynchronizationStatusTriggeredUpdateStatusTriggeredUpdateProgress();
