...
public final class GetJobJobSettingsSettingsNewClusterAzureAttributesArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsNewClusterAzureAttributesArgs Empty = new GetJobJobSettingsSettingsNewClusterAzureAttributesArgs();
    ...
    private GetJobJobSettingsSettingsNewClusterAzureAttributesArgs() {}

    private GetJobJobSettingsSettingsNewClusterAzureAttributesArgs(GetJobJobSettingsSettingsNewClusterAzureAttributesArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsNewClusterAzureAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsNewClusterAzureAttributesArgs();
        }

        public Builder(GetJobJobSettingsSettingsNewClusterAzureAttributesArgs defaults) {
            $ = new GetJobJobSettingsSettingsNewClusterAzureAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsNewClusterAzureAttributesArgs build() {
            return $;
        }
    }
