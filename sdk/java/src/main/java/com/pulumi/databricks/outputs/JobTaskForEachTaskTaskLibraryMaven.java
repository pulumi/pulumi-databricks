...
@CustomType
public final class JobTaskForEachTaskTaskLibraryMaven {
    private String coordinates;
    private @Nullable List<String> exclusions;
    private @Nullable String repo;

    private JobTaskForEachTaskTaskLibraryMaven() {}
    ...
    public static Builder builder(JobTaskForEachTaskTaskLibraryMaven defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(JobTaskForEachTaskTaskLibraryMaven defaults) {
        ...
        public Builder coordinates(String coordinates) {
            if (coordinates == null) {
              throw new MissingRequiredPropertyException("JobTaskForEachTaskTaskLibraryMaven", "coordinates");
            }
        ...
        public JobTaskForEachTaskTaskLibraryMaven build() {
            final var _resultValue = new JobTaskForEachTaskTaskLibraryMaven();
