...
@CustomType
public final class AlertV2EvaluationThresholdValue {
    private @Nullable Boolean boolValue;
    private @Nullable Double doubleValue;
    private @Nullable String stringValue;

    private AlertV2EvaluationThresholdValue() {}
    ...
    public static Builder builder(AlertV2EvaluationThresholdValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String stringValue;
        public Builder() {}
        public Builder(AlertV2EvaluationThresholdValue defaults) {
        ...
        public AlertV2EvaluationThresholdValue build() {
            final var _resultValue = new AlertV2EvaluationThresholdValue();
