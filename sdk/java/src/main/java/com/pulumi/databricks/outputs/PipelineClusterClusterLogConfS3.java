...
@CustomType
public final class PipelineClusterClusterLogConfS3 {
    ...
    private PipelineClusterClusterLogConfS3() {}
    ...
    public static Builder builder(PipelineClusterClusterLogConfS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(PipelineClusterClusterLogConfS3 defaults) {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("PipelineClusterClusterLogConfS3", "destination");
            }
        ...
        public PipelineClusterClusterLogConfS3 build() {
            final var _resultValue = new PipelineClusterClusterLogConfS3();
