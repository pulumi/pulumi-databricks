...
public final class GetFunctionsFunctionReturnParamsParameter extends com.pulumi.resources.InvokeArgs {

    public static final GetFunctionsFunctionReturnParamsParameter Empty = new GetFunctionsFunctionReturnParamsParameter();
    ...
    private GetFunctionsFunctionReturnParamsParameter(GetFunctionsFunctionReturnParamsParameter $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFunctionsFunctionReturnParamsParameter();
        }

        public Builder(GetFunctionsFunctionReturnParamsParameter defaults) {
            $ = new GetFunctionsFunctionReturnParamsParameter(Objects.requireNonNull(defaults));
        }
