...
@CustomType
public final class JobJobClusterNewClusterLibraryMaven {
    private String coordinates;
    private @Nullable List<String> exclusions;
    private @Nullable String repo;

    private JobJobClusterNewClusterLibraryMaven() {}
    ...
    public static Builder builder(JobJobClusterNewClusterLibraryMaven defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(JobJobClusterNewClusterLibraryMaven defaults) {
        ...
        public Builder coordinates(String coordinates) {
            if (coordinates == null) {
              throw new MissingRequiredPropertyException("JobJobClusterNewClusterLibraryMaven", "coordinates");
            }
        ...
        public JobJobClusterNewClusterLibraryMaven build() {
            final var _resultValue = new JobJobClusterNewClusterLibraryMaven();
