...
public final class GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs Empty = new GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs();
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs() {}

    private GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs(GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs $) {
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs();
        }

        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs defaults) {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMaskArgs build() {
            return $;
        }
    }
