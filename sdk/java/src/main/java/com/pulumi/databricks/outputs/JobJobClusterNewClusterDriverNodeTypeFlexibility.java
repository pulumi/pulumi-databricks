...
@CustomType
public final class JobJobClusterNewClusterDriverNodeTypeFlexibility {
    ...
    public static Builder builder(JobJobClusterNewClusterDriverNodeTypeFlexibility defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> alternateNodeTypeIds;
        public Builder() {}
        public Builder(JobJobClusterNewClusterDriverNodeTypeFlexibility defaults) {
        ...
        public JobJobClusterNewClusterDriverNodeTypeFlexibility build() {
            final var _resultValue = new JobJobClusterNewClusterDriverNodeTypeFlexibility();
