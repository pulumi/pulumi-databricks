...
public final class JobJobClusterNewClusterDockerImageBasicAuth {
    ...
    public static final class Builder {
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("JobJobClusterNewClusterDockerImageBasicAuth", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("JobJobClusterNewClusterDockerImageBasicAuth", "username");
            }
            this.username = username;
            return this;
        }
        public JobJobClusterNewClusterDockerImageBasicAuth build() {
            final var _resultValue = new JobJobClusterNewClusterDockerImageBasicAuth();
