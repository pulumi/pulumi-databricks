...
public final class JobNotebookTaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobNotebookTaskArgs Empty = new JobNotebookTaskArgs();
    ...
    public static Builder builder(JobNotebookTaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobNotebookTaskArgs();
        }

        public Builder(JobNotebookTaskArgs defaults) {
            $ = new JobNotebookTaskArgs(Objects.requireNonNull(defaults));
        }
