...
@CustomType
public final class AiGatewayModelProviderServiceConfigGeminiEnterpriseDirectApiKey {
    /**
    ...
    public static Builder builder(AiGatewayModelProviderServiceConfigGeminiEnterpriseDirectApiKey defaults) {
    ...
    public static final class Builder {
        private @Nullable String plaintext;
        public Builder() {}
        public Builder(AiGatewayModelProviderServiceConfigGeminiEnterpriseDirectApiKey defaults) {
        ...
        public AiGatewayModelProviderServiceConfigGeminiEnterpriseDirectApiKey build() {
            final var _resultValue = new AiGatewayModelProviderServiceConfigGeminiEnterpriseDirectApiKey();
