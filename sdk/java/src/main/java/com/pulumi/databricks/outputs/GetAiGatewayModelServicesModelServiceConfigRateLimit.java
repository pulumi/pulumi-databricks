...
@CustomType
public final class GetAiGatewayModelServicesModelServiceConfigRateLimit {
    /**
    ...
    private GetAiGatewayModelServicesModelServiceConfigRateLimit() {}
    /**
     * @return (string) - Scope key. Determines whether `principal` is required. Possible values are: `RATE_LIMIT_KEY_REQUEST_TAG`, `RATE_LIMIT_KEY_SERVICE`, `RATE_LIMIT_KEY_SERVICE_PRINCIPAL`, `RATE_LIMIT_KEY_USER`, `RATE_LIMIT_KEY_USER_DEFAULT`, `RATE_LIMIT_KEY_USER_GROUP`
     * 
     */
    ...
    public static Builder builder(GetAiGatewayModelServicesModelServiceConfigRateLimit defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer tokens;
        public Builder() {}
        public Builder(GetAiGatewayModelServicesModelServiceConfigRateLimit defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetAiGatewayModelServicesModelServiceConfigRateLimit", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder renewalPeriod(String renewalPeriod) {
            if (renewalPeriod == null) {
              throw new MissingRequiredPropertyException("GetAiGatewayModelServicesModelServiceConfigRateLimit", "renewalPeriod");
            }
        ...
        public GetAiGatewayModelServicesModelServiceConfigRateLimit build() {
            final var _resultValue = new GetAiGatewayModelServicesModelServiceConfigRateLimit();
