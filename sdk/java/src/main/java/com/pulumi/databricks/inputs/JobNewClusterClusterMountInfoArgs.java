    ...
    public static final class Builder {
        ...
        public JobNewClusterClusterMountInfoArgs build() {
            if ($.localMountDirPath == null) {
                throw new MissingRequiredPropertyException("JobNewClusterClusterMountInfoArgs", "localMountDirPath");
            }
            if ($.networkFilesystemInfo == null) {
                throw new MissingRequiredPropertyException("JobNewClusterClusterMountInfoArgs", "networkFilesystemInfo");
            }
            return $;
        }
    }
