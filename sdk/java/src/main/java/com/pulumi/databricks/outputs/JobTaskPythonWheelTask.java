...
public final class JobTaskPythonWheelTask {
    ...
    public static Builder builder(JobTaskPythonWheelTask defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JobTaskPythonWheelTask defaults) {
        ...
        }        public JobTaskPythonWheelTask build() {
            return new JobTaskPythonWheelTask(entryPoint, namedParameters, packageName, parameters);
        }
    }
}
