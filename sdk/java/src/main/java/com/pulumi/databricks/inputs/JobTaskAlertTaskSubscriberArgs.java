...
public final class JobTaskAlertTaskSubscriberArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTaskAlertTaskSubscriberArgs Empty = new JobTaskAlertTaskSubscriberArgs();
    ...
    private JobTaskAlertTaskSubscriberArgs() {}

    private JobTaskAlertTaskSubscriberArgs(JobTaskAlertTaskSubscriberArgs $) {
    ...
    public static Builder builder(JobTaskAlertTaskSubscriberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskAlertTaskSubscriberArgs();
        }

        public Builder(JobTaskAlertTaskSubscriberArgs defaults) {
            $ = new JobTaskAlertTaskSubscriberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskAlertTaskSubscriberArgs build() {
            return $;
        }
    }
