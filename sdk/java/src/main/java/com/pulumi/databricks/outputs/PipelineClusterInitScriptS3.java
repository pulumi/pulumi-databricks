...
@CustomType
public final class PipelineClusterInitScriptS3 {
    ...
    private PipelineClusterInitScriptS3() {}
    ...
    public static Builder builder(PipelineClusterInitScriptS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(PipelineClusterInitScriptS3 defaults) {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("PipelineClusterInitScriptS3", "destination");
            }
        ...
        public PipelineClusterInitScriptS3 build() {
            final var _resultValue = new PipelineClusterInitScriptS3();
