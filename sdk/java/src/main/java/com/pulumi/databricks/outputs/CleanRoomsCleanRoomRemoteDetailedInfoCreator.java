...
@CustomType
public final class CleanRoomsCleanRoomRemoteDetailedInfoCreator {
    /**
    ...
    private CleanRoomsCleanRoomRemoteDetailedInfoCreator() {}
    /**
     * @return Collaborator alias specified by the clean room creator. It is unique across all collaborators of this clean room, and used to derive
     * multiple values internally such as catalog alias and clean room name for single metastore clean rooms.
     * It should follow [UC securable naming requirements](https://docs.databricks.com/en/data-governance/unity-catalog/index.html#securable-object-naming-requirements)
    ...
    public static Builder builder(CleanRoomsCleanRoomRemoteDetailedInfoCreator defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String organizationName;
        public Builder() {}
        public Builder(CleanRoomsCleanRoomRemoteDetailedInfoCreator defaults) {
        ...
        public Builder collaboratorAlias(String collaboratorAlias) {
            if (collaboratorAlias == null) {
              throw new MissingRequiredPropertyException("CleanRoomsCleanRoomRemoteDetailedInfoCreator", "collaboratorAlias");
            }
        ...
        public CleanRoomsCleanRoomRemoteDetailedInfoCreator build() {
            final var _resultValue = new CleanRoomsCleanRoomRemoteDetailedInfoCreator();
