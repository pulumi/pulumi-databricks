...
@CustomType
public final class ClusterLibraryCran {
    ...
    public static Builder builder(ClusterLibraryCran defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repo;
        public Builder() {}
        public Builder(ClusterLibraryCran defaults) {
        ...
        public Builder package_(String package_) {
            if (package_ == null) {
              throw new MissingRequiredPropertyException("ClusterLibraryCran", "package_");
            }
