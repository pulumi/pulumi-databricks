...
public final class AccountNetworkPolicyIngressPrivateAccessAllowRuleOriginEndpoints {
    ...
    public static Builder builder(AccountNetworkPolicyIngressPrivateAccessAllowRuleOriginEndpoints defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> endpointIds;
        public Builder() {}
        public Builder(AccountNetworkPolicyIngressPrivateAccessAllowRuleOriginEndpoints defaults) {
        ...
        public AccountNetworkPolicyIngressPrivateAccessAllowRuleOriginEndpoints build() {
            final var _resultValue = new AccountNetworkPolicyIngressPrivateAccessAllowRuleOriginEndpoints();
