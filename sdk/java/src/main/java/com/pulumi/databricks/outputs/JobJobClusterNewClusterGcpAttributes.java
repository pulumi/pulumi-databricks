...
public final class JobJobClusterNewClusterGcpAttributes {
    ...
    public static Builder builder(JobJobClusterNewClusterGcpAttributes defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JobJobClusterNewClusterGcpAttributes defaults) {
        ...
        public Builder zoneId(@Nullable String zoneId) {
            this.zoneId = zoneId;
            return this;
        }        public JobJobClusterNewClusterGcpAttributes build() {
            return new JobJobClusterNewClusterGcpAttributes(availability, bootDiskSize, googleServiceAccount, usePreemptibleExecutors, zoneId);
        }
    }
}
