...
public class IpAccessList extends com.pulumi.resources.CustomResource {
     ...
     */
    public IpAccessList(String name, IpAccessListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/ipAccessList:IpAccessList", name, args == null ? IpAccessListArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IpAccessList(String name, Output<String> id, @Nullable IpAccessListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("databricks:index/ipAccessList:IpAccessList", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static IpAccessList get(String name, Output<String> id, @Nullable IpAccessListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
