...
@CustomType
public final class JobNewClusterWorkloadTypeClients {
    private @Nullable Boolean jobs;
    private @Nullable Boolean notebooks;

    private JobNewClusterWorkloadTypeClients() {}
    ...
    public static Builder builder(JobNewClusterWorkloadTypeClients defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean notebooks;
        public Builder() {}
        public Builder(JobNewClusterWorkloadTypeClients defaults) {
        ...
        public JobNewClusterWorkloadTypeClients build() {
            final var _resultValue = new JobNewClusterWorkloadTypeClients();
