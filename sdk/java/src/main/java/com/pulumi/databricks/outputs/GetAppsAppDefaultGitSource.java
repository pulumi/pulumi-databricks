...
import com.pulumi.databricks.outputs.GetAppsAppDefaultGitSourceGitRepository;
...
@CustomType
public final class GetAppsAppDefaultGitSource {
    /**
     ...
     * 
     */
    private GetAppsAppDefaultGitSourceGitRepository gitRepository;
    ...
    private GetAppsAppDefaultGitSource() {}
    /**
     * @return The resource path of the Lakebase Autoscaling branch (e.g. `projects/proj-abc123/branches/branch-xyz789`).
     * 
     */
     ...
     * 
     */
    public GetAppsAppDefaultGitSourceGitRepository gitRepository() {
    ...
    public static Builder builder(GetAppsAppDefaultGitSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tag;
        public Builder() {}
        public Builder(GetAppsAppDefaultGitSource defaults) {
        ...
        @CustomType.Setter
        public Builder gitRepository(GetAppsAppDefaultGitSourceGitRepository gitRepository) {
            if (gitRepository == null) {
              throw new MissingRequiredPropertyException("GetAppsAppDefaultGitSource", "gitRepository");
            }
        ...
        public Builder resolvedCommit(String resolvedCommit) {
            if (resolvedCommit == null) {
              throw new MissingRequiredPropertyException("GetAppsAppDefaultGitSource", "resolvedCommit");
            }
        ...
        public GetAppsAppDefaultGitSource build() {
            final var _resultValue = new GetAppsAppDefaultGitSource();
