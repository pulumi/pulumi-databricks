...
public final class PipelineIngestionDefinitionTableConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<PipelineIngestionDefinitionTableConfigurationQueryBasedConnectorConfigArgs> queryBasedConnectorConfig;

    public Optional<Output<PipelineIngestionDefinitionTableConfigurationQueryBasedConnectorConfigArgs>> queryBasedConnectorConfig() {
    ...
    private @Nullable Output<PipelineIngestionDefinitionTableConfigurationWorkdayReportParametersArgs> workdayReportParameters;

    public Optional<Output<PipelineIngestionDefinitionTableConfigurationWorkdayReportParametersArgs>> workdayReportParameters() {
    ...
    public static Builder builder(PipelineIngestionDefinitionTableConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineIngestionDefinitionTableConfigurationArgs();
        }
        ...
        public Builder queryBasedConnectorConfig(@Nullable Output<PipelineIngestionDefinitionTableConfigurationQueryBasedConnectorConfigArgs> queryBasedConnectorConfig) {
        ...
        public Builder workdayReportParameters(@Nullable Output<PipelineIngestionDefinitionTableConfigurationWorkdayReportParametersArgs> workdayReportParameters) {
            $.workdayReportParameters = workdayReportParameters;
            return this;
        }

        public Builder workdayReportParameters(PipelineIngestionDefinitionTableConfigurationWorkdayReportParametersArgs workdayReportParameters) {
