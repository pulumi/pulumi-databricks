...
import com.pulumi.databricks.inputs.GetViewsProviderConfig;
...
public final class GetViewsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetViewsPlainArgs build() {
            if ($.catalogName == null) {
                throw new MissingRequiredPropertyException("GetViewsPlainArgs", "catalogName");
            }
            if ($.schemaName == null) {
                throw new MissingRequiredPropertyException("GetViewsPlainArgs", "schemaName");
            }
            return $;
        }
    }
