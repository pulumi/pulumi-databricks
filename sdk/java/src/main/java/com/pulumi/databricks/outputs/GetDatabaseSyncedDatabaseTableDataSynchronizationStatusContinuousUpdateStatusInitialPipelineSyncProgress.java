...
@CustomType
public final class GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress {
    /**
    ...
    private GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress() {}
    /**
     * @return (number) - The estimated time remaining to complete this update in seconds
     * 
     */
    ...
    public static Builder builder(GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress defaults) {
    ...
    public static final class Builder {
        ...
        private Integer totalRowCount;
        public Builder() {}
        public Builder(GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress defaults) {
        ...
        public Builder estimatedCompletionTimeSeconds(Double estimatedCompletionTimeSeconds) {
            if (estimatedCompletionTimeSeconds == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress", "estimatedCompletionTimeSeconds");
            }
        ...
        public Builder latestVersionCurrentlyProcessing(Integer latestVersionCurrentlyProcessing) {
            if (latestVersionCurrentlyProcessing == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress", "latestVersionCurrentlyProcessing");
            }
        ...
        public Builder provisioningPhase(String provisioningPhase) {
            if (provisioningPhase == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress", "provisioningPhase");
            }
        ...
        public Builder syncProgressCompletion(Double syncProgressCompletion) {
            if (syncProgressCompletion == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress", "syncProgressCompletion");
            }
        ...
        public Builder syncedRowCount(Integer syncedRowCount) {
            if (syncedRowCount == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress", "syncedRowCount");
            }
        ...
        public Builder totalRowCount(Integer totalRowCount) {
            if (totalRowCount == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress", "totalRowCount");
            }
            this.totalRowCount = totalRowCount;
            return this;
        }
        public GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress build() {
            final var _resultValue = new GetDatabaseSyncedDatabaseTableDataSynchronizationStatusContinuousUpdateStatusInitialPipelineSyncProgress();
