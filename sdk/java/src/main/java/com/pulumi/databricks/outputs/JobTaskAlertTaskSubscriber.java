...
@CustomType
public final class JobTaskAlertTaskSubscriber {
    /**
    ...
    private JobTaskAlertTaskSubscriber() {}
    /**
     * @return A snapshot of the dashboard will be sent to the destination when the `destinationId` field is present.
     * 
     */
    ...
    public static Builder builder(JobTaskAlertTaskSubscriber defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userName;
        public Builder() {}
        public Builder(JobTaskAlertTaskSubscriber defaults) {
        ...
        public JobTaskAlertTaskSubscriber build() {
            final var _resultValue = new JobTaskAlertTaskSubscriber();
