...
@CustomType
public final class GetFeatureEngineeringFeatureTimeWindowLongRolling {
    /**
    ...
    private GetFeatureEngineeringFeatureTimeWindowLongRolling() {}
    /**
     * @return (string) - The delay applied to the end of the rolling window (must be non-negative).
     * For example, delay=1d shifts the window end 1 day before the evaluation time
     * 
    ...
    public static Builder builder(GetFeatureEngineeringFeatureTimeWindowLongRolling defaults) {
    ...
    public static final class Builder {
        ...
        private String windowDuration;
        public Builder() {}
        public Builder(GetFeatureEngineeringFeatureTimeWindowLongRolling defaults) {
        ...
        public Builder windowDuration(String windowDuration) {
            if (windowDuration == null) {
              throw new MissingRequiredPropertyException("GetFeatureEngineeringFeatureTimeWindowLongRolling", "windowDuration");
            }
            this.windowDuration = windowDuration;
            return this;
        }
        public GetFeatureEngineeringFeatureTimeWindowLongRolling build() {
            final var _resultValue = new GetFeatureEngineeringFeatureTimeWindowLongRolling();
