...
@CustomType
public final class GetPostgresEndpointsEndpointStatusSettings {
    /**
    ...
    private GetPostgresEndpointsEndpointStatusSettings() {}
    /**
     * @return (object) - A raw representation of Postgres settings
     * 
     */
    ...
    public static Builder builder(GetPostgresEndpointsEndpointStatusSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> pgbouncerSettings;
        public Builder() {}
        public Builder(GetPostgresEndpointsEndpointStatusSettings defaults) {
        ...
        public GetPostgresEndpointsEndpointStatusSettings build() {
            final var _resultValue = new GetPostgresEndpointsEndpointStatusSettings();
