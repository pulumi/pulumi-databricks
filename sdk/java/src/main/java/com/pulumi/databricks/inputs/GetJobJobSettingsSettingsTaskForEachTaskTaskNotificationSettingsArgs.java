...
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs Empty = new GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs();
    ...
    private GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs() {}

    private GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs(GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs();
        }

        public Builder(GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs defaults) {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsTaskForEachTaskTaskNotificationSettingsArgs build() {
            return $;
        }
    }
