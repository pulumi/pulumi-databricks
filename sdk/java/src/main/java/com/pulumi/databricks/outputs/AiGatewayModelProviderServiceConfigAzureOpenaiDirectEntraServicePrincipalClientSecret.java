...
@CustomType
public final class AiGatewayModelProviderServiceConfigAzureOpenaiDirectEntraServicePrincipalClientSecret {
    /**
    ...
    public static Builder builder(AiGatewayModelProviderServiceConfigAzureOpenaiDirectEntraServicePrincipalClientSecret defaults) {
