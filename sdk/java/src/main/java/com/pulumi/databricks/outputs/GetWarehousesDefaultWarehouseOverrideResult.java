...
public final class GetWarehousesDefaultWarehouseOverrideResult {
    ...
    public static Builder builder(GetWarehousesDefaultWarehouseOverrideResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWarehousesDefaultWarehouseOverrideResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder warehouseId(String warehouseId) {
            if (warehouseId == null) {
              throw new MissingRequiredPropertyException("GetWarehousesDefaultWarehouseOverrideResult", "warehouseId");
            }
