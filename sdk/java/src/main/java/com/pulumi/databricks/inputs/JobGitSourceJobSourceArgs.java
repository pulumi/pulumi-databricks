...
public final class JobGitSourceJobSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobGitSourceJobSourceArgs Empty = new JobGitSourceJobSourceArgs();
    ...
    private JobGitSourceJobSourceArgs() {}

    private JobGitSourceJobSourceArgs(JobGitSourceJobSourceArgs $) {
    ...
    public static Builder builder(JobGitSourceJobSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobGitSourceJobSourceArgs();
        }

        public Builder(JobGitSourceJobSourceArgs defaults) {
            $ = new JobGitSourceJobSourceArgs(Objects.requireNonNull(defaults));
        }
