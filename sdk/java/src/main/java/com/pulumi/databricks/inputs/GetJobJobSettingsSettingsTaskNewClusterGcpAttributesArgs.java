...
public final class GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs Empty = new GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs();
    ...
    private GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs() {}

    private GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs(GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs();
        }

        public Builder(GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs defaults) {
            $ = new GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsTaskNewClusterGcpAttributesArgs build() {
            return $;
        }
    }
