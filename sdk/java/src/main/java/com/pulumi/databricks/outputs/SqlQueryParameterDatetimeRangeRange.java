...
public final class SqlQueryParameterDatetimeRangeRange {
    ...
    public static final class Builder {
        ...
        public Builder end(String end) {
            if (end == null) {
              throw new MissingRequiredPropertyException("SqlQueryParameterDatetimeRangeRange", "end");
            }
            this.end = end;
            return this;
        }
        ...
        public Builder start(String start) {
            if (start == null) {
              throw new MissingRequiredPropertyException("SqlQueryParameterDatetimeRangeRange", "start");
            }
            this.start = start;
            return this;
        }
        public SqlQueryParameterDatetimeRangeRange build() {
            final var _resultValue = new SqlQueryParameterDatetimeRangeRange();
