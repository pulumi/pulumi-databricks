...
@CustomType
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterDockerImageBasicAuth {
    ...
    public static final class Builder {
        ...
        public GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterDockerImageBasicAuth build() {
            final var _resultValue = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterDockerImageBasicAuth();
