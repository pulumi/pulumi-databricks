...
public final class CleanRoomAssetArgs extends com.pulumi.resources.ResourceArgs {

    public static final CleanRoomAssetArgs Empty = new CleanRoomAssetArgs();
    ...
    private CleanRoomAssetArgs() {}

    private CleanRoomAssetArgs(CleanRoomAssetArgs $) {
    ...
    public static Builder builder(CleanRoomAssetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CleanRoomAssetArgs();
        }

        public Builder(CleanRoomAssetArgs defaults) {
            $ = new CleanRoomAssetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CleanRoomAssetArgs build() {
            if ($.assetType == null) {
                throw new MissingRequiredPropertyException("CleanRoomAssetArgs", "assetType");
            }
            return $;
        }
    }
