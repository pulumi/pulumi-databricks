...
public final class JobJobClusterNewClusterDockerImageBasicAuthArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public JobJobClusterNewClusterDockerImageBasicAuthArgs build() {
            if ($.password == null) {
                throw new MissingRequiredPropertyException("JobJobClusterNewClusterDockerImageBasicAuthArgs", "password");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("JobJobClusterNewClusterDockerImageBasicAuthArgs", "username");
            }
            return $;
        }
    }
