 ...
 *                 .resource_specs(List.of(                
 *                     Map.ofEntries(
 *                         Map.entry("name", "my-secret"),
 *                         Map.entry("description", "A secret needed by the app"),
 *                         Map.entry("secretSpec", Map.of("permission", "READ"))
 *                     ),
 *                     Map.ofEntries(
 *                         Map.entry("name", "warehouse"),
 *                         Map.entry("description", "Warehouse access"),
 *                         Map.entry("sqlWarehouseSpec", Map.of("permission", "CAN_USE"))
 *                     )))
 *                 .build())
 *             .build());
 * 
