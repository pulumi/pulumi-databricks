...
public final class JobJobClusterNewClusterInitScriptS3Args extends com.pulumi.resources.ResourceArgs {

    public static final JobJobClusterNewClusterInitScriptS3Args Empty = new JobJobClusterNewClusterInitScriptS3Args();
    ...
    private JobJobClusterNewClusterInitScriptS3Args() {}

    private JobJobClusterNewClusterInitScriptS3Args(JobJobClusterNewClusterInitScriptS3Args $) {
    ...
    public static Builder builder(JobJobClusterNewClusterInitScriptS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobJobClusterNewClusterInitScriptS3Args();
        }

        public Builder(JobJobClusterNewClusterInitScriptS3Args defaults) {
            $ = new JobJobClusterNewClusterInitScriptS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public JobJobClusterNewClusterInitScriptS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("JobJobClusterNewClusterInitScriptS3Args", "destination");
            }
            return $;
        }
    }
