...
public final class PipelineClusterInitScriptS3Args extends com.pulumi.resources.ResourceArgs {

    public static final PipelineClusterInitScriptS3Args Empty = new PipelineClusterInitScriptS3Args();
    ...
    private PipelineClusterInitScriptS3Args() {}

    private PipelineClusterInitScriptS3Args(PipelineClusterInitScriptS3Args $) {
    ...
    public static Builder builder(PipelineClusterInitScriptS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineClusterInitScriptS3Args();
        }

        public Builder(PipelineClusterInitScriptS3Args defaults) {
            $ = new PipelineClusterInitScriptS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineClusterInitScriptS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("PipelineClusterInitScriptS3Args", "destination");
            }
            return $;
        }
    }
