...
public final class VectorSearchEndpointProviderConfig {
    ...
    public static Builder builder(VectorSearchEndpointProviderConfig defaults) {
    ...
    public static final class Builder {
        ...
        public VectorSearchEndpointProviderConfig build() {
            final var _resultValue = new VectorSearchEndpointProviderConfig();
