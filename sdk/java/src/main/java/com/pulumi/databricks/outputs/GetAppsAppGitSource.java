...
import com.pulumi.databricks.outputs.GetAppsAppGitSourceGitRepository;
...
@CustomType
public final class GetAppsAppGitSource {
    /**
     ...
     * 
     */
    private GetAppsAppGitSourceGitRepository gitRepository;
     ...
     * 
     */
    public GetAppsAppGitSourceGitRepository gitRepository() {
    ...
    public static Builder builder(GetAppsAppGitSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tag;
        public Builder() {}
        public Builder(GetAppsAppGitSource defaults) {
        ...
        @CustomType.Setter
        public Builder gitRepository(GetAppsAppGitSourceGitRepository gitRepository) {
            if (gitRepository == null) {
              throw new MissingRequiredPropertyException("GetAppsAppGitSource", "gitRepository");
            }
        ...
        public Builder resolvedCommit(String resolvedCommit) {
            if (resolvedCommit == null) {
              throw new MissingRequiredPropertyException("GetAppsAppGitSource", "resolvedCommit");
            }
        ...
        public GetAppsAppGitSource build() {
            final var _resultValue = new GetAppsAppGitSource();
