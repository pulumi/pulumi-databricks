...
import com.pulumi.databricks.outputs.AppGitSourceGitRepository;
...
@CustomType
public final class AppGitSource {
    /**
     ...
     * 
     */
    private @Nullable AppGitSourceGitRepository gitRepository;
     ...
     * 
     */
    public Optional<AppGitSourceGitRepository> gitRepository() {
    ...
    public static Builder builder(AppGitSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tag;
        public Builder() {}
        public Builder(AppGitSource defaults) {
        ...
        @CustomType.Setter
        public Builder gitRepository(@Nullable AppGitSourceGitRepository gitRepository) {
        ...
        public AppGitSource build() {
            final var _resultValue = new AppGitSource();
