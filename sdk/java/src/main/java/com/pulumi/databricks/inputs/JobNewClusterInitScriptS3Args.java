...
public final class JobNewClusterInitScriptS3Args extends com.pulumi.resources.ResourceArgs {

    public static final JobNewClusterInitScriptS3Args Empty = new JobNewClusterInitScriptS3Args();
    ...
    private JobNewClusterInitScriptS3Args() {}

    private JobNewClusterInitScriptS3Args(JobNewClusterInitScriptS3Args $) {
    ...
    public static Builder builder(JobNewClusterInitScriptS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobNewClusterInitScriptS3Args();
        }

        public Builder(JobNewClusterInitScriptS3Args defaults) {
            $ = new JobNewClusterInitScriptS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public JobNewClusterInitScriptS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("JobNewClusterInitScriptS3Args", "destination");
            }
            return $;
        }
    }
