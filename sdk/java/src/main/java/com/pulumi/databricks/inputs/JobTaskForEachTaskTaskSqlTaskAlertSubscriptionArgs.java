...
public final class JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs() {}

    private JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs(JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs $) {
    ...
    public static Builder builder(JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs();
        }

        public Builder(JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs defaults) {
            $ = new JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskForEachTaskTaskSqlTaskAlertSubscriptionArgs build() {
            return $;
        }
    }
