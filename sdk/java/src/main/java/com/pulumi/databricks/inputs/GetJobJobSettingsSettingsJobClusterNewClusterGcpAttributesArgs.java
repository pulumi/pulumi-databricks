...
public final class GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs Empty = new GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs();
    ...
    private GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs() {}

    private GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs(GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs();
        }

        public Builder(GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs defaults) {
            $ = new GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsJobClusterNewClusterGcpAttributesArgs build() {
            return $;
        }
    }
