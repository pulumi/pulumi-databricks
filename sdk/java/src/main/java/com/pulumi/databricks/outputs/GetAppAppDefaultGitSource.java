...
import com.pulumi.databricks.outputs.GetAppAppDefaultGitSourceGitRepository;
...
@CustomType
public final class GetAppAppDefaultGitSource {
    /**
     ...
     * 
     */
    private GetAppAppDefaultGitSourceGitRepository gitRepository;
    ...
    private GetAppAppDefaultGitSource() {}
    /**
     * @return The resource path of the Lakebase Autoscaling branch (e.g. `projects/proj-abc123/branches/branch-xyz789`).
     * 
     */
     ...
     * 
     */
    public GetAppAppDefaultGitSourceGitRepository gitRepository() {
    ...
    public static Builder builder(GetAppAppDefaultGitSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tag;
        public Builder() {}
        public Builder(GetAppAppDefaultGitSource defaults) {
        ...
        @CustomType.Setter
        public Builder gitRepository(GetAppAppDefaultGitSourceGitRepository gitRepository) {
            if (gitRepository == null) {
              throw new MissingRequiredPropertyException("GetAppAppDefaultGitSource", "gitRepository");
            }
        ...
        public Builder resolvedCommit(String resolvedCommit) {
            if (resolvedCommit == null) {
              throw new MissingRequiredPropertyException("GetAppAppDefaultGitSource", "resolvedCommit");
            }
        ...
        public GetAppAppDefaultGitSource build() {
            final var _resultValue = new GetAppAppDefaultGitSource();
