...
public final class GetAiGatewayModelProviderServiceConfigAzureOpenaiDirectEntraServicePrincipalClientSecret {
    ...
    public static Builder builder(GetAiGatewayModelProviderServiceConfigAzureOpenaiDirectEntraServicePrincipalClientSecret defaults) {
    ...
    public static final class Builder {
        ...
        public Builder plaintext(String plaintext) {
            if (plaintext == null) {
              throw new MissingRequiredPropertyException("GetAiGatewayModelProviderServiceConfigAzureOpenaiDirectEntraServicePrincipalClientSecret", "plaintext");
            }
