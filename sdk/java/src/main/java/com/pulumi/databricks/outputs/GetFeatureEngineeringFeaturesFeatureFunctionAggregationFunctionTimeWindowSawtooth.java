...
public final class GetFeatureEngineeringFeaturesFeatureFunctionAggregationFunctionTimeWindowSawtooth {
    ...
    public static Builder builder(GetFeatureEngineeringFeaturesFeatureFunctionAggregationFunctionTimeWindowSawtooth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String windowDuration;
        public Builder() {}
        public Builder(GetFeatureEngineeringFeaturesFeatureFunctionAggregationFunctionTimeWindowSawtooth defaults) {
        ...
        public GetFeatureEngineeringFeaturesFeatureFunctionAggregationFunctionTimeWindowSawtooth build() {
            final var _resultValue = new GetFeatureEngineeringFeaturesFeatureFunctionAggregationFunctionTimeWindowSawtooth();
