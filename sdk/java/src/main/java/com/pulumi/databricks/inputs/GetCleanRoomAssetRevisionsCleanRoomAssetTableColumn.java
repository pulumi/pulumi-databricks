...
import com.pulumi.databricks.inputs.GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask;
...
public final class GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn Empty = new GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn();
     ...
     */
    @Import(name="mask")
    private @Nullable GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask mask;

    /**
     * @return (ColumnMask)
     * 
     */
    public Optional<GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask> mask() {
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn() {}

    private GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn(GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn $) {
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn();
        }

        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn defaults) {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder mask(@Nullable GetCleanRoomAssetRevisionsCleanRoomAssetTableColumnMask mask) {
            $.mask = mask;
            return this;
        }
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetTableColumn build() {
            return $;
        }
    }
