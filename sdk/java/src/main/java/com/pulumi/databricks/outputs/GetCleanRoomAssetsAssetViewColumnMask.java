...
@CustomType
public final class GetCleanRoomAssetsAssetViewColumnMask {
    /**
    ...
    private GetCleanRoomAssetsAssetViewColumnMask() {}
    /**
     * @return (string) - The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(GetCleanRoomAssetsAssetViewColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(GetCleanRoomAssetsAssetViewColumnMask defaults) {
        ...
        public GetCleanRoomAssetsAssetViewColumnMask build() {
            final var _resultValue = new GetCleanRoomAssetsAssetViewColumnMask();
