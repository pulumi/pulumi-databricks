...
@CustomType
public final class PostgresBranchSpec {
    /**
    ...
    public static Builder builder(PostgresBranchSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceBranchTime;
        public Builder() {}
        public Builder(PostgresBranchSpec defaults) {
        ...
        public PostgresBranchSpec build() {
            final var _resultValue = new PostgresBranchSpec();
