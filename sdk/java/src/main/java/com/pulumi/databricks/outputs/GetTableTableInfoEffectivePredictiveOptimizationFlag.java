...
@CustomType
public final class GetTableTableInfoEffectivePredictiveOptimizationFlag {
    ...
    public static final class Builder {
        ...
        public GetTableTableInfoEffectivePredictiveOptimizationFlag build() {
            final var _resultValue = new GetTableTableInfoEffectivePredictiveOptimizationFlag();
