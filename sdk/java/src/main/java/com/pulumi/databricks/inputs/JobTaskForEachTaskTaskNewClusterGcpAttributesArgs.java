...
public final class JobTaskForEachTaskTaskNewClusterGcpAttributesArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTaskForEachTaskTaskNewClusterGcpAttributesArgs Empty = new JobTaskForEachTaskTaskNewClusterGcpAttributesArgs();
    ...
    private JobTaskForEachTaskTaskNewClusterGcpAttributesArgs() {}
    ...
    public static Builder builder(JobTaskForEachTaskTaskNewClusterGcpAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskForEachTaskTaskNewClusterGcpAttributesArgs();
        }

        public Builder(JobTaskForEachTaskTaskNewClusterGcpAttributesArgs defaults) {
            $ = new JobTaskForEachTaskTaskNewClusterGcpAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskForEachTaskTaskNewClusterGcpAttributesArgs build() {
            return $;
        }
    }
