...
@CustomType
public final class JobTaskNewClusterInitScriptS3 {
    ...
    private JobTaskNewClusterInitScriptS3() {}
    ...
    public static Builder builder(JobTaskNewClusterInitScriptS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(JobTaskNewClusterInitScriptS3 defaults) {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobTaskNewClusterInitScriptS3", "destination");
            }
        ...
        public JobTaskNewClusterInitScriptS3 build() {
            final var _resultValue = new JobTaskNewClusterInitScriptS3();
