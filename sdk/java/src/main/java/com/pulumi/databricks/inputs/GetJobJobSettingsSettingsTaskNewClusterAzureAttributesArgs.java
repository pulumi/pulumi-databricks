...
public final class GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs Empty = new GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs();
    ...
    private GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs() {}

    private GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs(GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs();
        }

        public Builder(GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs defaults) {
            $ = new GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsTaskNewClusterAzureAttributesArgs build() {
            return $;
        }
    }
