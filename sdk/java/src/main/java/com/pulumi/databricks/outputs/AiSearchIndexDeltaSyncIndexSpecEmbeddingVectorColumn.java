...
@CustomType
public final class AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn {
    /**
    ...
    public static Builder builder(AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn defaults) {
        ...
        public AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn build() {
            final var _resultValue = new AiSearchIndexDeltaSyncIndexSpecEmbeddingVectorColumn();
