...
@CustomType
public final class AccountNetworkPolicyEgressNetworkAccessPolicyEnforcement {
    /**
    ...
    public static Builder builder(AccountNetworkPolicyEgressNetworkAccessPolicyEnforcement defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String enforcementMode;
        public Builder() {}
        public Builder(AccountNetworkPolicyEgressNetworkAccessPolicyEnforcement defaults) {
        ...
        public AccountNetworkPolicyEgressNetworkAccessPolicyEnforcement build() {
            final var _resultValue = new AccountNetworkPolicyEgressNetworkAccessPolicyEnforcement();
