...
public final class AppPendingDeploymentGitSourceGitRepository {
    ...
    public static Builder builder(AppPendingDeploymentGitSourceGitRepository defaults) {
    ...
    public static final class Builder {
        ...
        public Builder provider(String provider) {
            if (provider == null) {
              throw new MissingRequiredPropertyException("AppPendingDeploymentGitSourceGitRepository", "provider");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("AppPendingDeploymentGitSourceGitRepository", "url");
            }
            this.url = url;
            return this;
        }
