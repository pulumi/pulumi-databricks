...
@CustomType
public final class CleanRoomAssetViewColumnMask {
    /**
    ...
    private CleanRoomAssetViewColumnMask() {}
    /**
     * @return The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(CleanRoomAssetViewColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(CleanRoomAssetViewColumnMask defaults) {
        ...
        public CleanRoomAssetViewColumnMask build() {
            final var _resultValue = new CleanRoomAssetViewColumnMask();
