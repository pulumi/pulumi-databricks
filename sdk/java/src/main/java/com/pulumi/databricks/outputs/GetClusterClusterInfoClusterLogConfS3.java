...
public final class GetClusterClusterInfoClusterLogConfS3 {
    ...
    public static final class Builder {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("GetClusterClusterInfoClusterLogConfS3", "destination");
            }
        ...
        public GetClusterClusterInfoClusterLogConfS3 build() {
            final var _resultValue = new GetClusterClusterInfoClusterLogConfS3();
