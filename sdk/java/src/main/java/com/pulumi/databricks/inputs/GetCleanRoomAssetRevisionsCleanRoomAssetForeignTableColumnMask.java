...
public final class GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask Empty = new GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask();
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask() {}

    private GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask(GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask $) {
    ...
    public static Builder builder(GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask();
        }

        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask defaults) {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnMask build() {
            return $;
        }
    }
