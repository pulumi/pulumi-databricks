...
public final class GetCleanRoomAssetForeignTableColumnMask extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetForeignTableColumnMask Empty = new GetCleanRoomAssetForeignTableColumnMask();
    ...
    private GetCleanRoomAssetForeignTableColumnMask() {}

    private GetCleanRoomAssetForeignTableColumnMask(GetCleanRoomAssetForeignTableColumnMask $) {
    ...
    public static Builder builder(GetCleanRoomAssetForeignTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetForeignTableColumnMask();
        }

        public Builder(GetCleanRoomAssetForeignTableColumnMask defaults) {
            $ = new GetCleanRoomAssetForeignTableColumnMask(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetForeignTableColumnMask build() {
            return $;
        }
    }
