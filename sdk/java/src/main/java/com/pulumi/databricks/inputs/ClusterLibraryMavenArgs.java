...
public final class ClusterLibraryMavenArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterLibraryMavenArgs Empty = new ClusterLibraryMavenArgs();
    ...
    private ClusterLibraryMavenArgs() {}

    private ClusterLibraryMavenArgs(ClusterLibraryMavenArgs $) {
    ...
    public static Builder builder(ClusterLibraryMavenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterLibraryMavenArgs();
        }

        public Builder(ClusterLibraryMavenArgs defaults) {
            $ = new ClusterLibraryMavenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterLibraryMavenArgs build() {
            if ($.coordinates == null) {
                throw new MissingRequiredPropertyException("ClusterLibraryMavenArgs", "coordinates");
            }
            return $;
        }
    }
