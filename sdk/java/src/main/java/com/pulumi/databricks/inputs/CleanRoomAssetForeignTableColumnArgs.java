...
import com.pulumi.databricks.inputs.CleanRoomAssetForeignTableColumnMaskArgs;
...
public final class CleanRoomAssetForeignTableColumnArgs extends com.pulumi.resources.ResourceArgs {

    public static final CleanRoomAssetForeignTableColumnArgs Empty = new CleanRoomAssetForeignTableColumnArgs();
    ...
    @Import(name="mask")
    private @Nullable Output<CleanRoomAssetForeignTableColumnMaskArgs> mask;

    public Optional<Output<CleanRoomAssetForeignTableColumnMaskArgs>> mask() {
    ...
    /**
     * @return Whether field may be Null (default: true)
     * 
     */
    ...
    /**
     * @return Partition index for column
     * 
     */
    ...
    /**
     * @return Full data type specification, JSON-serialized
     * 
     */
    ...
    /**
     * @return . Possible values are: `ARRAY`, `BINARY`, `BOOLEAN`, `BYTE`, `CHAR`, `DATE`, `DECIMAL`, `DOUBLE`, `FLOAT`, `GEOGRAPHY`, `GEOMETRY`, `INT`, `INTERVAL`, `LONG`, `MAP`, `NULL`, `SHORT`, `STRING`, `STRUCT`, `TABLE_TYPE`, `TIMESTAMP`, `TIMESTAMP_NTZ`, `USER_DEFINED_TYPE`, `VARIANT`
     * 
     */
    ...
    /**
     * @return Digits of precision; required for DecimalTypes
     * 
     */
    ...
    /**
     * @return Digits to right of decimal; Required for DecimalTypes
     * 
     */
    ...
    /**
     * @return Full data type specification as SQL/catalogString text
     * 
     */
    ...
    private CleanRoomAssetForeignTableColumnArgs() {}

    private CleanRoomAssetForeignTableColumnArgs(CleanRoomAssetForeignTableColumnArgs $) {
    ...
    public static Builder builder(CleanRoomAssetForeignTableColumnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CleanRoomAssetForeignTableColumnArgs();
        }

        public Builder(CleanRoomAssetForeignTableColumnArgs defaults) {
            $ = new CleanRoomAssetForeignTableColumnArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder mask(@Nullable Output<CleanRoomAssetForeignTableColumnMaskArgs> mask) {
            $.mask = mask;
            return this;
        }

        public Builder mask(CleanRoomAssetForeignTableColumnMaskArgs mask) {
        ...
        /**
         * @param nullable Whether field may be Null (default: true)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param partitionIndex Partition index for column
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param typeJson Full data type specification, JSON-serialized
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param typeName . Possible values are: `ARRAY`, `BINARY`, `BOOLEAN`, `BYTE`, `CHAR`, `DATE`, `DECIMAL`, `DOUBLE`, `FLOAT`, `GEOGRAPHY`, `GEOMETRY`, `INT`, `INTERVAL`, `LONG`, `MAP`, `NULL`, `SHORT`, `STRING`, `STRUCT`, `TABLE_TYPE`, `TIMESTAMP`, `TIMESTAMP_NTZ`, `USER_DEFINED_TYPE`, `VARIANT`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param typePrecision Digits of precision; required for DecimalTypes
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param typeScale Digits to right of decimal; Required for DecimalTypes
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param typeText Full data type specification as SQL/catalogString text
         * 
         * @return builder
         * 
         */
        ...
        public CleanRoomAssetForeignTableColumnArgs build() {
            return $;
        }
    }
