...
public final class JobTaskLibraryMavenArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTaskLibraryMavenArgs Empty = new JobTaskLibraryMavenArgs();
    ...
    private JobTaskLibraryMavenArgs() {}

    private JobTaskLibraryMavenArgs(JobTaskLibraryMavenArgs $) {
    ...
    public static Builder builder(JobTaskLibraryMavenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTaskLibraryMavenArgs();
        }

        public Builder(JobTaskLibraryMavenArgs defaults) {
            $ = new JobTaskLibraryMavenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTaskLibraryMavenArgs build() {
            if ($.coordinates == null) {
                throw new MissingRequiredPropertyException("JobTaskLibraryMavenArgs", "coordinates");
            }
            return $;
        }
    }
