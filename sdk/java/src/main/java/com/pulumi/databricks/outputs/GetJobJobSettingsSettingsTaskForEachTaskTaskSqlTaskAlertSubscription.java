...
@CustomType
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskSqlTaskAlertSubscription {
    ...
    public static final class Builder {
        ...
        public GetJobJobSettingsSettingsTaskForEachTaskTaskSqlTaskAlertSubscription build() {
            final var _resultValue = new GetJobJobSettingsSettingsTaskForEachTaskTaskSqlTaskAlertSubscription();
