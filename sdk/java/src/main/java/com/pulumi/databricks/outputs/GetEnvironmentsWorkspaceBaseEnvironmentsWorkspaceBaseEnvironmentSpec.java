...
@CustomType
public final class GetEnvironmentsWorkspaceBaseEnvironmentsWorkspaceBaseEnvironmentSpec {
    /**
     * @return (list of string) - List of pip dependencies, as supported by the version of pip in this environment.
    ...
    /**
     * @return (string) - Environment version used by the environment.
    ...
    private GetEnvironmentsWorkspaceBaseEnvironmentsWorkspaceBaseEnvironmentSpec() {}
    /**
     * @return (list of string) - List of pip dependencies, as supported by the version of pip in this environment.
     * Each dependency is a valid pip requirements file line per https://pip.pypa.io/en/stable/reference/requirements-file-format/.
     * Allowed dependencies include a requirement specifier, an archive URL, a local project path (such as WSFS or UC Volumes in Databricks), or a VCS project URL
    ...
    public static Builder builder(GetEnvironmentsWorkspaceBaseEnvironmentsWorkspaceBaseEnvironmentSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String environmentVersion;
        public Builder() {}
        public Builder(GetEnvironmentsWorkspaceBaseEnvironmentsWorkspaceBaseEnvironmentSpec defaults) {
        ...
        public GetEnvironmentsWorkspaceBaseEnvironmentsWorkspaceBaseEnvironmentSpec build() {
            final var _resultValue = new GetEnvironmentsWorkspaceBaseEnvironmentsWorkspaceBaseEnvironmentSpec();
