...
public final class FeatureEngineeringFeatureFunctionAggregationFunctionTimeWindowRolling {
    ...
    public static Builder builder(FeatureEngineeringFeatureFunctionAggregationFunctionTimeWindowRolling defaults) {
    ...
    public static final class Builder {
        ...
        public FeatureEngineeringFeatureFunctionAggregationFunctionTimeWindowRolling build() {
            final var _resultValue = new FeatureEngineeringFeatureFunctionAggregationFunctionTimeWindowRolling();
