...
@CustomType
public final class GetAppSpaceResourceUcSecurable {
    /**
    ...
    private GetAppSpaceResourceUcSecurable() {}
    /**
     * @return (string) - Possible values are: `EXECUTE`, `MODIFY`, `READ_VOLUME`, `SELECT`, `USE_CONNECTION`, `WRITE_VOLUME`
     * 
     */
    ...
    public static Builder builder(GetAppSpaceResourceUcSecurable defaults) {
    ...
    public static final class Builder {
        ...
        private String securableType;
        public Builder() {}
        public Builder(GetAppSpaceResourceUcSecurable defaults) {
        ...
        public Builder permission(String permission) {
            if (permission == null) {
              throw new MissingRequiredPropertyException("GetAppSpaceResourceUcSecurable", "permission");
            }
        ...
        public Builder securableFullName(String securableFullName) {
            if (securableFullName == null) {
              throw new MissingRequiredPropertyException("GetAppSpaceResourceUcSecurable", "securableFullName");
            }
        ...
        public Builder securableKind(String securableKind) {
            if (securableKind == null) {
              throw new MissingRequiredPropertyException("GetAppSpaceResourceUcSecurable", "securableKind");
            }
        ...
        public Builder securableType(String securableType) {
            if (securableType == null) {
              throw new MissingRequiredPropertyException("GetAppSpaceResourceUcSecurable", "securableType");
            }
            this.securableType = securableType;
            return this;
        }
        public GetAppSpaceResourceUcSecurable build() {
            final var _resultValue = new GetAppSpaceResourceUcSecurable();
