...
@CustomType
public final class AlertV2EvaluationNotificationSubscription {
    ...
    public static Builder builder(AlertV2EvaluationNotificationSubscription defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userEmail;
        public Builder() {}
        public Builder(AlertV2EvaluationNotificationSubscription defaults) {
        ...
        public AlertV2EvaluationNotificationSubscription build() {
            final var _resultValue = new AlertV2EvaluationNotificationSubscription();
