...
public final class PolicyInfoGrant {
    ...
    public static Builder builder(PolicyInfoGrant defaults) {
    ...
    public static final class Builder {
        private List<String> privileges;
        public Builder() {}
        public Builder(PolicyInfoGrant defaults) {
        ...
        public Builder privileges(List<String> privileges) {
            if (privileges == null) {
              throw new MissingRequiredPropertyException("PolicyInfoGrant", "privileges");
            }
        ...
        public PolicyInfoGrant build() {
            final var _resultValue = new PolicyInfoGrant();
