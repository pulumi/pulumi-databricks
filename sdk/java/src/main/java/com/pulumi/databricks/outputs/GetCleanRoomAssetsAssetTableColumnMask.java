...
@CustomType
public final class GetCleanRoomAssetsAssetTableColumnMask {
    /**
    ...
    private GetCleanRoomAssetsAssetTableColumnMask() {}
    /**
     * @return (string) - The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(GetCleanRoomAssetsAssetTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(GetCleanRoomAssetsAssetTableColumnMask defaults) {
        ...
        public GetCleanRoomAssetsAssetTableColumnMask build() {
            final var _resultValue = new GetCleanRoomAssetsAssetTableColumnMask();
