...
public final class GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue Empty = new GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue();
    ...
    private GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue(GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue $) {
        this.name = $.name;
        this.op = $.op;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue();
        }

        public Builder(GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue defaults) {
            $ = new GetCleanRoomAssetRevisionsCleanRoomAssetTableLocalDetailsPartitionValue(Objects.requireNonNull(defaults));
        }
