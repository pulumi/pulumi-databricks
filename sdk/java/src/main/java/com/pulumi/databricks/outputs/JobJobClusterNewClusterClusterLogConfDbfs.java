...
public final class JobJobClusterNewClusterClusterLogConfDbfs {
    ...
    public static final class Builder {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobJobClusterNewClusterClusterLogConfDbfs", "destination");
            }
            this.destination = destination;
            return this;
        }
        public JobJobClusterNewClusterClusterLogConfDbfs build() {
            final var _resultValue = new JobJobClusterNewClusterClusterLogConfDbfs();
