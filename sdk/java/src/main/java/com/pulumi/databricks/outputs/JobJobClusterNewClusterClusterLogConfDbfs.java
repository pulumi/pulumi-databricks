...
public final class JobJobClusterNewClusterClusterLogConfDbfs {
    ...
    private JobJobClusterNewClusterClusterLogConfDbfs(@CustomType.Parameter("destination") String destination) {
    ...
    public static final class Builder {
        ...
        public Builder destination(String destination) {
            ...
            return new JobJobClusterNewClusterClusterLogConfDbfs(destination);
        }
    }
}
