...
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs Empty = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs();
    ...
    private GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs() {}

    private GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs(GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs();
        }

        public Builder(GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs defaults) {
            $ = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterGcpAttributesArgs build() {
            return $;
        }
    }
