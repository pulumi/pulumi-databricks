...
@CustomType
public final class GetAlertsV2AlertEvaluationNotificationSubscription {
    /**
     * @return (string)
     * 
     */
    ...
    private GetAlertsV2AlertEvaluationNotificationSubscription() {}
    /**
     * @return (string)
     * 
     */
    ...
    public static Builder builder(GetAlertsV2AlertEvaluationNotificationSubscription defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userEmail;
        public Builder() {}
        public Builder(GetAlertsV2AlertEvaluationNotificationSubscription defaults) {
        ...
        public GetAlertsV2AlertEvaluationNotificationSubscription build() {
            final var _resultValue = new GetAlertsV2AlertEvaluationNotificationSubscription();
