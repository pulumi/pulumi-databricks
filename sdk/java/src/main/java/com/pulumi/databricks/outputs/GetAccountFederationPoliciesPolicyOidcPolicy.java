...
@CustomType
public final class GetAccountFederationPoliciesPolicyOidcPolicy {
    /**
    ...
    private GetAccountFederationPoliciesPolicyOidcPolicy() {}
    /**
     * @return (list of string) - The allowed token audiences, as specified in the &#39;aud&#39; claim of federated tokens.
     * The audience identifier is intended to represent the recipient of the token.
     * Can be any non-empty string value. As long as the audience in the token matches
    ...
    public static Builder builder(GetAccountFederationPoliciesPolicyOidcPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subjectClaim;
        public Builder() {}
        public Builder(GetAccountFederationPoliciesPolicyOidcPolicy defaults) {
        ...
        public GetAccountFederationPoliciesPolicyOidcPolicy build() {
            final var _resultValue = new GetAccountFederationPoliciesPolicyOidcPolicy();
