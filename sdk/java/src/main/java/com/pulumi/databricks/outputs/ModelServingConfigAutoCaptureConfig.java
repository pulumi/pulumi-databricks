...
public final class ModelServingConfigAutoCaptureConfig {
    ...
    public static Builder builder(ModelServingConfigAutoCaptureConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tableNamePrefix;
        public Builder() {}
        public Builder(ModelServingConfigAutoCaptureConfig defaults) {
        ...
        public ModelServingConfigAutoCaptureConfig build() {
            final var _resultValue = new ModelServingConfigAutoCaptureConfig();
