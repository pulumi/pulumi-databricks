...
@CustomType
public final class GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterInitScriptFile {
    ...
    public static final class Builder {
        ...
        public GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterInitScriptFile build() {
            final var _resultValue = new GetJobJobSettingsSettingsTaskForEachTaskTaskNewClusterInitScriptFile();
