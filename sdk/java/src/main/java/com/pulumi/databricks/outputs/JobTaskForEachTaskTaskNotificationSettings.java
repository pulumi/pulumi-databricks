...
public final class JobTaskForEachTaskTaskNotificationSettings {
    ...
    public static Builder builder(JobTaskForEachTaskTaskNotificationSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean noAlertForSkippedRuns;
        public Builder() {}
        public Builder(JobTaskForEachTaskTaskNotificationSettings defaults) {
        ...
        public JobTaskForEachTaskTaskNotificationSettings build() {
            final var _resultValue = new JobTaskForEachTaskTaskNotificationSettings();
