...
public final class JobJobClusterNewClusterInitScriptS3 {
    ...
    public static final class Builder {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("JobJobClusterNewClusterInitScriptS3", "destination");
            }
        ...
        public JobJobClusterNewClusterInitScriptS3 build() {
            final var _resultValue = new JobJobClusterNewClusterInitScriptS3();
