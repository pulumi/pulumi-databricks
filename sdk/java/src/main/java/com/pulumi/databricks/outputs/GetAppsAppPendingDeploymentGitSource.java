...
import com.pulumi.databricks.outputs.GetAppsAppPendingDeploymentGitSourceGitRepository;
...
public final class GetAppsAppPendingDeploymentGitSource {
    ...
    public static Builder builder(GetAppsAppPendingDeploymentGitSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tag;
        public Builder() {}
        public Builder(GetAppsAppPendingDeploymentGitSource defaults) {
        ...
        @CustomType.Setter
        public Builder gitRepository(GetAppsAppPendingDeploymentGitSourceGitRepository gitRepository) {
            if (gitRepository == null) {
              throw new MissingRequiredPropertyException("GetAppsAppPendingDeploymentGitSource", "gitRepository");
            }
        ...
        public Builder resolvedCommit(String resolvedCommit) {
            if (resolvedCommit == null) {
              throw new MissingRequiredPropertyException("GetAppsAppPendingDeploymentGitSource", "resolvedCommit");
            }
        ...
        public GetAppsAppPendingDeploymentGitSource build() {
            final var _resultValue = new GetAppsAppPendingDeploymentGitSource();
