...
public final class GetFunctionsFunctionInputParamsParameterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFunctionsFunctionInputParamsParameterArgs Empty = new GetFunctionsFunctionInputParamsParameterArgs();
    ...
    private GetFunctionsFunctionInputParamsParameterArgs() {}
    ...
    public static Builder builder(GetFunctionsFunctionInputParamsParameterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFunctionsFunctionInputParamsParameterArgs();
        }

        public Builder(GetFunctionsFunctionInputParamsParameterArgs defaults) {
            $ = new GetFunctionsFunctionInputParamsParameterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFunctionsFunctionInputParamsParameterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionInputParamsParameterArgs", "name");
            }
            if ($.position == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionInputParamsParameterArgs", "position");
            }
            if ($.typeName == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionInputParamsParameterArgs", "typeName");
            }
            if ($.typeText == null) {
                throw new MissingRequiredPropertyException("GetFunctionsFunctionInputParamsParameterArgs", "typeText");
            }
            return $;
        }
    }
