...
@CustomType
public final class CleanRoomAssetForeignTableColumnMask {
    /**
    ...
    private CleanRoomAssetForeignTableColumnMask() {}
    /**
     * @return The full name of the column mask SQL UDF
     * 
     */
    ...
    public static Builder builder(CleanRoomAssetForeignTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usingColumnNames;
        public Builder() {}
        public Builder(CleanRoomAssetForeignTableColumnMask defaults) {
        ...
        public CleanRoomAssetForeignTableColumnMask build() {
            final var _resultValue = new CleanRoomAssetForeignTableColumnMask();
