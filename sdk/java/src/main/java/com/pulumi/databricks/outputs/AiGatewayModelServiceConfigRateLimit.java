...
@CustomType
public final class AiGatewayModelServiceConfigRateLimit {
    /**
    ...
    private AiGatewayModelServiceConfigRateLimit() {}
    /**
     * @return Scope key. Determines whether `principal` is required. Possible values are: `RATE_LIMIT_KEY_REQUEST_TAG`, `RATE_LIMIT_KEY_SERVICE`, `RATE_LIMIT_KEY_SERVICE_PRINCIPAL`, `RATE_LIMIT_KEY_USER`, `RATE_LIMIT_KEY_USER_DEFAULT`, `RATE_LIMIT_KEY_USER_GROUP`
     * 
     */
    ...
    public static Builder builder(AiGatewayModelServiceConfigRateLimit defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer tokens;
        public Builder() {}
        public Builder(AiGatewayModelServiceConfigRateLimit defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("AiGatewayModelServiceConfigRateLimit", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder renewalPeriod(String renewalPeriod) {
            if (renewalPeriod == null) {
              throw new MissingRequiredPropertyException("AiGatewayModelServiceConfigRateLimit", "renewalPeriod");
            }
        ...
        public AiGatewayModelServiceConfigRateLimit build() {
            final var _resultValue = new AiGatewayModelServiceConfigRateLimit();
