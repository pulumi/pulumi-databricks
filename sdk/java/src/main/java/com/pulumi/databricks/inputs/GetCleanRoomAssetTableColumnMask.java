...
public final class GetCleanRoomAssetTableColumnMask extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetTableColumnMask Empty = new GetCleanRoomAssetTableColumnMask();
    ...
    private GetCleanRoomAssetTableColumnMask() {}

    private GetCleanRoomAssetTableColumnMask(GetCleanRoomAssetTableColumnMask $) {
    ...
    public static Builder builder(GetCleanRoomAssetTableColumnMask defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetTableColumnMask();
        }

        public Builder(GetCleanRoomAssetTableColumnMask defaults) {
            $ = new GetCleanRoomAssetTableColumnMask(Objects.requireNonNull(defaults));
        }
        ...
        public GetCleanRoomAssetTableColumnMask build() {
            return $;
        }
    }
