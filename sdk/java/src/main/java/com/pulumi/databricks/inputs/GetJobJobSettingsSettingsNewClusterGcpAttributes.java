...
public final class GetJobJobSettingsSettingsNewClusterGcpAttributes extends com.pulumi.resources.InvokeArgs {

    public static final GetJobJobSettingsSettingsNewClusterGcpAttributes Empty = new GetJobJobSettingsSettingsNewClusterGcpAttributes();
    ...
    private GetJobJobSettingsSettingsNewClusterGcpAttributes() {}

    private GetJobJobSettingsSettingsNewClusterGcpAttributes(GetJobJobSettingsSettingsNewClusterGcpAttributes $) {
    ...
    public static Builder builder(GetJobJobSettingsSettingsNewClusterGcpAttributes defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobJobSettingsSettingsNewClusterGcpAttributes();
        }

        public Builder(GetJobJobSettingsSettingsNewClusterGcpAttributes defaults) {
            $ = new GetJobJobSettingsSettingsNewClusterGcpAttributes(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobJobSettingsSettingsNewClusterGcpAttributes build() {
            return $;
        }
    }
