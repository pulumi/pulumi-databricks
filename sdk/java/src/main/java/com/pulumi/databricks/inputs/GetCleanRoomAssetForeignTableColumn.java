...
import com.pulumi.databricks.inputs.GetCleanRoomAssetForeignTableColumnMask;
...
public final class GetCleanRoomAssetForeignTableColumn extends com.pulumi.resources.InvokeArgs {

    public static final GetCleanRoomAssetForeignTableColumn Empty = new GetCleanRoomAssetForeignTableColumn();
     ...
     */
    @Import(name="mask")
    private @Nullable GetCleanRoomAssetForeignTableColumnMask mask;

    /**
     * @return (ColumnMask)
     * 
     */
    public Optional<GetCleanRoomAssetForeignTableColumnMask> mask() {
    ...
    private GetCleanRoomAssetForeignTableColumn() {}

    private GetCleanRoomAssetForeignTableColumn(GetCleanRoomAssetForeignTableColumn $) {
    ...
    public static Builder builder(GetCleanRoomAssetForeignTableColumn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCleanRoomAssetForeignTableColumn();
        }

        public Builder(GetCleanRoomAssetForeignTableColumn defaults) {
            $ = new GetCleanRoomAssetForeignTableColumn(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder mask(@Nullable GetCleanRoomAssetForeignTableColumnMask mask) {
            $.mask = mask;
            return this;
        }
        ...
        public GetCleanRoomAssetForeignTableColumn build() {
            return $;
        }
    }
