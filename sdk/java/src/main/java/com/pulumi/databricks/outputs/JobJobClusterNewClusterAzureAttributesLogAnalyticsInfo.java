...
@CustomType
public final class JobJobClusterNewClusterAzureAttributesLogAnalyticsInfo {
    ...
    public static Builder builder(JobJobClusterNewClusterAzureAttributesLogAnalyticsInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String logAnalyticsWorkspaceId;
        public Builder() {}
        public Builder(JobJobClusterNewClusterAzureAttributesLogAnalyticsInfo defaults) {
        ...
        public JobJobClusterNewClusterAzureAttributesLogAnalyticsInfo build() {
            final var _resultValue = new JobJobClusterNewClusterAzureAttributesLogAnalyticsInfo();
