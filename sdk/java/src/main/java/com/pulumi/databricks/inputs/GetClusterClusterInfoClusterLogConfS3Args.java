...
public final class GetClusterClusterInfoClusterLogConfS3Args extends com.pulumi.resources.ResourceArgs {

    public static final GetClusterClusterInfoClusterLogConfS3Args Empty = new GetClusterClusterInfoClusterLogConfS3Args();
    ...
    private GetClusterClusterInfoClusterLogConfS3Args() {}

    private GetClusterClusterInfoClusterLogConfS3Args(GetClusterClusterInfoClusterLogConfS3Args $) {
    ...
    public static Builder builder(GetClusterClusterInfoClusterLogConfS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClusterClusterInfoClusterLogConfS3Args();
        }

        public Builder(GetClusterClusterInfoClusterLogConfS3Args defaults) {
            $ = new GetClusterClusterInfoClusterLogConfS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public GetClusterClusterInfoClusterLogConfS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("GetClusterClusterInfoClusterLogConfS3Args", "destination");
            }
            return $;
        }
    }
