...
@CustomType
public final class FeatureEngineeringKafkaConfigIngestionConfigBackfillSourceDeltaTableSource {
    /**
    ...
    public static Builder builder(FeatureEngineeringKafkaConfigIngestionConfigBackfillSourceDeltaTableSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String transformationSql;
        public Builder() {}
        public Builder(FeatureEngineeringKafkaConfigIngestionConfigBackfillSourceDeltaTableSource defaults) {
        ...
        public Builder fullName(String fullName) {
            if (fullName == null) {
              throw new MissingRequiredPropertyException("FeatureEngineeringKafkaConfigIngestionConfigBackfillSourceDeltaTableSource", "fullName");
            }
        ...
        public FeatureEngineeringKafkaConfigIngestionConfigBackfillSourceDeltaTableSource build() {
            final var _resultValue = new FeatureEngineeringKafkaConfigIngestionConfigBackfillSourceDeltaTableSource();
