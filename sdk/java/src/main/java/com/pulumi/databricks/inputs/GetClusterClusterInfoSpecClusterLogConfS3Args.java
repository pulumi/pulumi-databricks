...
public final class GetClusterClusterInfoSpecClusterLogConfS3Args extends com.pulumi.resources.ResourceArgs {

    public static final GetClusterClusterInfoSpecClusterLogConfS3Args Empty = new GetClusterClusterInfoSpecClusterLogConfS3Args();
    ...
    private GetClusterClusterInfoSpecClusterLogConfS3Args() {}

    private GetClusterClusterInfoSpecClusterLogConfS3Args(GetClusterClusterInfoSpecClusterLogConfS3Args $) {
    ...
    public static Builder builder(GetClusterClusterInfoSpecClusterLogConfS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClusterClusterInfoSpecClusterLogConfS3Args();
        }

        public Builder(GetClusterClusterInfoSpecClusterLogConfS3Args defaults) {
            $ = new GetClusterClusterInfoSpecClusterLogConfS3Args(Objects.requireNonNull(defaults));
        }
        ...
        public GetClusterClusterInfoSpecClusterLogConfS3Args build() {
            if ($.destination == null) {
                throw new MissingRequiredPropertyException("GetClusterClusterInfoSpecClusterLogConfS3Args", "destination");
            }
            return $;
        }
    }
